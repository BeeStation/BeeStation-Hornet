...
export const GenPop = (props) => {
  ...
  return (
    <Window resizable width={625} height={540}>
      <Window.Content scrollable minHeight="100%">
        <Flex direction="column" height="100%">
          <Section
            ...
            <Button icon="forward" onClick={() => setTime(clamp(time + 600, 0, 36000))} />
          ...
          <Flex.Item grow>
            <Section title="Prison Management:" height="100%">
