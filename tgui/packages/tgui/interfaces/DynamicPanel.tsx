        ...
        <Flex direction="row">
          <Flex.Item grow>
            <Section fill title="Variables">
              <LabeledList.Item
                label="Set Upper Divergence Range"
              ...
              <LabeledList.Item
                label="Set Lower Divergence Range"
                verticalAlign="middle"
              >
                <NumberInput
