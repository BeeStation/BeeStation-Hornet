...
export const zone_select: Feature<string> = {
  ...
  category: 'GAMEPLAY',
  description: 'When set to simplified, the bodyzone system will be replaced with a grouped system where you can target legs, arms or body/head. This is useful if you do not have a numpad or want an easier to use system.',
