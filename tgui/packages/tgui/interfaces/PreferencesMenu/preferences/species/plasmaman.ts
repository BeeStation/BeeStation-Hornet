...
const Plasmaman: Species = {
  description:
    "Found on the Icemoon of Freyja, plasmamen consist of colonial \
  ...
  features: {
    good: [
      ...
      },
      {
        ...
        description:
          "Plasmamen's helmets provide them shielding from the \
    ...
    bad: [
      ...
      },
      {
        ...
        name: 'An Apple a Day',
        description:
          'Plasmamen take specialized medical knowledge to be \
