...
const Ethereal: Species = {
  description:
    'Coming from the planet of Sprout, the theocratic ethereals are \
    ...
    neutral: [
      {
        ...
        description:
          'Ethereals have liquid electricity instead of blood. \
      ...
      },
      {
        ...
        name: 'Crystal Core',
        description:
          'The hearts of ethereals will protect them in a cystal when \
