    ...
    <Section
      title={
        <GasSearchBar
          ...
          onChange={(keyword) =>
            setActiveGasId(gasInfo.find((gas) => gas.name.toLowerCase().startsWith(keyword.toLowerCase()))?.id || '')
          }
    ...
    <Section
      title={
        <GasSearchBar
          ...
          onChange={(keyword) =>
            setActiveReactionId(
              reactionInfo.find((reaction) => reaction.name.toLowerCase().startsWith(keyword.toLowerCase()))?.id || ''
            )
          }
