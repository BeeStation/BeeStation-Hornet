...
// players will not have the same setting on different codebase
// as long as this key isn't the same to the key from other codebases
// Currently, TG doesn't have this, so making it blank will let
// all players on Beestation codebase use TG setting (which is very default)
// Key as blank means:
//     PREF_ADDITION_KEY = '';
...
/* <comments for coders>
   ...
   Things you might need to know:
      ...
      but if that happens, Backend methods should have additional parameter
      which determines if it should refer a key to the backend
      For example:
      --------------------------------------
   ...
   Which additional effect will be broght?:
      ...
      This is why I explained why the additional modification (ignore_config) might be
      needed in the future.
      Currently, other minor stuff (i.e. TGUI windows geometry) is
      only affected by this, so there won't be any unwanted effect of the change.
*/
