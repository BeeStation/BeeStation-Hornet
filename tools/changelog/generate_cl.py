...
-----------------------------------
GIT_NAME: Username of the github account to be used as the commited
GIT_EMAIL: Email associated with the above
GITHUB_REPOSITORY: Github action variable representing the active repo
GITHUB_TOKEN: A snowflake token generated by the action, this will allow the action to push the changes
GITHUB_SHA: The SHA associated with the commit that triggered the action
"""
import os
import io
import re
