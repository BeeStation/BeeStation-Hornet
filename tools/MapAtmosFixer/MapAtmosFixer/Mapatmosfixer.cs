				...
				case Objtype.Pipe:
					switch (iconstate)
					{
						...
						case "intact-c-f":
							...
							return;
						case "intact-p":
							path = "/obj/machinery/atmospherics/pipe/simple/amethyst/visible";
							return;
						case "intact-p-f":
							path = "/obj/machinery/atmospherics/pipe/simple/amethyst/hidden";
							return;
					}
					return;
				case Objtype.Manifold:
					switch (iconstate)
					{
						...
						case "manifold-g-f":
							...
							return;
						case "manifold-p":
							path = "/obj/machinery/atmospherics/pipe/manifold/amethyst/visible";
							return;
						case "manifold-p-f":
							path = "/obj/machinery/atmospherics/pipe/manifold/amethyst/hidden";
							return;
					}
					return;
			}
