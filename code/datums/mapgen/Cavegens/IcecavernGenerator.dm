/datum/map_generator/cave_generator/iceland
	...
	weighted_mob_spawn_list = list(/mob/living/simple_animal/hostile/poison/giant_spider/hunter/ice = 1, /mob/living/simple_animal/hostile/poison/giant_spider/ice = 0.5)
