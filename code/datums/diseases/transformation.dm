...
/datum/disease/transformation/felinid
	...
	cures = list(/datum/reagent/consumable/cocoa, /datum/reagent/consumable/cocoa/hot_cocoa, /datum/reagent/toxin/catbgon) //kills all the tiny cats that infected your organism
	cure_chance = 25
	stage_prob = 3
