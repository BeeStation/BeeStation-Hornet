...
/datum/disease/rhumba_beat/stage_act()
	...
	switch(stage)
		...
		if(5)
			...
			if(prob(50))
				explosion(affected_mob, devastation_range = -1, light_impact_range = 2, flame_range = 2, flash_range = 3, adminlog = FALSE, magic = TRUE) // This is equivalent to a lvl 1 fireball
		else
			return
