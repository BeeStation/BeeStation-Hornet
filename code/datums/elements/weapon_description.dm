...
/datum/element/weapon_description/proc/build_label_text(obj/item/source)
	...
	if(!source.override_notes)
		...
		if(source.armour_penetration > 0 || source.block_level > 0)
			readout += "This item has proven itself <span class='warning'>[weapon_tag_convert(source.armour_penetration)]</span> of piercing armor and <span class='warning'>[weapon_tag_convert(source.block_level)]</span> of blocking attacks."
	// Custom manual notes
