...
/datum/status_effect/bioware/ligaments/reinforced/bioware_gained()
	owner.add_traits(list(TRAIT_NODISMEMBER, TRAIT_EASYLIMBDISABLE), TRAIT_STATUS_EFFECT(id))

/datum/status_effect/bioware/ligaments/reinforced/bioware_lost()
	owner.remove_traits(list(TRAIT_NODISMEMBER, TRAIT_EASYLIMBDISABLE), TRAIT_STATUS_EFFECT(id))
