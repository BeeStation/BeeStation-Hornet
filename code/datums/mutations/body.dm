...
/datum/mutation/human/clumsy/on_acquiring(mob/living/carbon/owner)
	if(..())
		return
	ADD_TRAIT(owner, TRAIT_CLUMSY, GENETIC_MUTATION)

/datum/mutation/human/clumsy/on_losing(mob/living/carbon/owner)
	if(..())
		return
...
/datum/mutation/human/deaf/on_losing(mob/living/carbon/owner)
	if(..())
		return
...
/datum/mutation/human/insulated/on_acquiring(mob/living/carbon/owner)
	if(..())
		return
	ADD_TRAIT(owner, TRAIT_SHOCKIMMUNE, "genetics")

/datum/mutation/human/insulated/on_losing(mob/living/carbon/owner)
	if(..())
		return
