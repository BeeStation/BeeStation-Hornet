...
/datum/mutation/human/honorbound/proc/is_honorable(mob/living/carbon/human/honorbound_human, mob/living/target_creature)
	...
	if(target_creature.IsSleeping() || target_creature.IsUnconscious() || target_creature.restrained())
...
/datum/mutation/human/honorbound/proc/bullet_guilt(datum/source, obj/item/projectile/proj)
	SIGNAL_HANDLER
