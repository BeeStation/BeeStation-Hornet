...
/datum/map_template/shuttle/emergency/luxury
	suffix = "luxury"
	name = "Luxury Shuttle"
	description = "A luxurious golden shuttle complete with an indoor swimming pool. Each crewmember wishing to board must bring 500 kromer, payable in cash and mineral coin."
	extra_desc = "This shuttle costs 500 kromer to board."
