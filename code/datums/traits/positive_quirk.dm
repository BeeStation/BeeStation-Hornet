...
/datum/quirk/multilingual/proc/set_up_language()
	...
	if(quirk_holder.assigned_role == JOB_NAME_CURATOR)
		return
	var/obj/item/organ/internal/tongue/T = quirk_target.get_organ_slot(ORGAN_SLOT_TONGUE)
...
/datum/quirk/night_vision/on_spawn()
	...
	var/obj/item/organ/internal/eyes/eyes = H.get_organ_by_type(/obj/item/organ/internal/eyes)
