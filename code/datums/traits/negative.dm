...
/datum/quirk/brainproblems/post_add()
	to_chat(quirk_holder, span_boldnotice("There is a bottle of mannitol [where]. You're going to need it."))
...
/datum/quirk/alcoholic/post_add()
	to_chat(quirk_holder, span_boldnotice("There is a small bottle of [drink_instance] [where_drink]. You only have a single bottle, might have to find some more..."))
