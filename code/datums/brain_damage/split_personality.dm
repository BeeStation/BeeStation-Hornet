...
/datum/brain_trauma/severe/split_personality/proc/get_ghost()
	...
	if(owner.stat == DEAD || !owner.mind)
		qdel(src)
		return
	var/list/mob/dead/observer/candidates = pollCandidatesForMob("Do you want to play as [owner]'s split personality?", ROLE_KEY_PAI, null, null, 75, stranger_backseat, POLL_IGNORE_SPLITPERSONALITY)
