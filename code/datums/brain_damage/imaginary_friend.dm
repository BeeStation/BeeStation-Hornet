...
/mob/camera/imaginary_friend/proc/owner_speech(speaker, speech_args)
	...
	if(!(src in listening))
		...
		to_chat(src, span_gamesay("<span class='name'>[speaker]</span> <span class='message'>[say_quote(speech_args[SPEECH_MESSAGE])]</span>"))
...
/mob/camera/imaginary_friend/proc/friend_talk(message)
	...
	var/rendered = span_gamesay("<span class='name'>[name]</span> <span class='message'>[say_quote(message)]</span>")
	var/dead_rendered = span_gamesay("<span class='name'>[name] (Imaginary friend of [owner])</span> <span class='message'>[say_quote(message)]</span>")
