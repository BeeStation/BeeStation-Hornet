...
/datum/brain_trauma/special/imaginary_friend/proc/get_ghost()
	...
	if(owner.stat == DEAD || !owner.mind)
		qdel(src)
		return
	var/list/mob/dead/observer/candidates = pollCandidatesForMob("Do you want to play as [owner]'s imaginary friend?", ROLE_KEY_IMAGINARY_FRIEND, null, null, 75, friend, POLL_IGNORE_IMAGINARYFRIEND)
