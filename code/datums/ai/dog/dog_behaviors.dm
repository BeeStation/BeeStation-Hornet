...
/datum/ai_behavior/basic_melee_attack/dog/perform(delta_time, datum/ai_controller/controller, target_key, targeting_strategy_key, hiding_location_key)
	...
	// Give Ian some teeth
	var/old_melee = living_pawn.melee_damage
	living_pawn.melee_damage = max(7.5, old_melee)

	. = ..() // Bite time

	living_pawn.melee_damage = old_melee
