...
/datum/ai_behavior/monkey_equip/pickpocket/proc/attempt_pickpocket(datum/ai_controller/controller)
	...
	victim.visible_message(span_warning("[living_pawn] starts trying to take [target] from [controller.current_movement_target]!"), span_danger("[living_pawn] tries to take [target]!"))
