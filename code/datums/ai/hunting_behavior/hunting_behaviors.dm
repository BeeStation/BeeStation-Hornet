/datum/ai_planning_subtree/find_and_hunt_target
	var/list/hunt_targets = list(/obj/effect/decal/cleanable/food) //Bee Edit: We don't have ants yet July 2023, sorry. Also hi!!!
...
/datum/ai_behavior/hunt_target/finish_action(datum/ai_controller/controller, succeeded, hunting_target_key, hunting_cooldown_key)
	. = ..()
	if(succeeded)
		controller.blackboard[hunting_cooldown_key] = world.time + SUCCESSFUL_HUNT_COOLDOWN
