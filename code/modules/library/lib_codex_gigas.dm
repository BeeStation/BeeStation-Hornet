			...
			if (3 to 8)	//tragic
				switch(rand(1,4))
					if (1)
						...
						to_chat(heretic, "<span class='warning'>Dead eyes and drooling mouths.</span>")
					if (2)
						heretic.adjustOrganLoss(ORGAN_SLOT_EYES,10)
						to_chat(heretic, "<span class='warning'>Melted eyes and boiled blood.</span>")
					if (3)
					...
					if (4)
						...
						to_chat(heretic, "<span class='warning'>Decay and rot.</span>")
			else			//devastating
				switch(rand(1,6))
					if (1)
