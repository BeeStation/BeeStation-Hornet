...
/datum/cargo_list/livestock
	...
	entries = list(
		...
		list("path" = /obj/item/dog_bone, "cost" = 100, "max_supply" = 5, "small_item" = TRUE),
		list("path" = /obj/item/toy/cattoy, "cost" = 50, "max_supply" = 5, "small_item" = TRUE),
		list("path" = /obj/item/clothing/neck/petcollar, "cost" = 50, "max_supply" = 10, "small_item" = TRUE),
		list("path" = /obj/item/pet_carrier, "cost" = 250, "max_supply" = 3),
		list("path" = /obj/item/storage/box/monkeycubes, "cost" = 800, "max_supply" = 3, "small_item" = TRUE),
