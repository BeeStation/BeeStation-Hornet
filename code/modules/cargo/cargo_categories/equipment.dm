...
/datum/cargo_list/tools_hand
	...
	entries = list(
		...
		list("path" = /obj/item/screwdriver, "cost" = 10, "max_supply" = 8),
		list("path" = /obj/item/wrench, "cost" = 10, "max_supply" = 8),
		list("path" = /obj/item/weldingtool, "cost" = 40, "max_supply" = 6),
		list("path" = /obj/item/crowbar, "cost" = 15, "max_supply" = 8),
		list("path" = /obj/item/wirecutters, "cost" = 10, "max_supply" = 8),
		list("path" = /obj/item/multitool, "cost" = 275, "max_supply" = 4),
		...
		list("path" = /obj/item/flashlight/seclite, "cost" = 30, "max_supply" = 6),
		...
		list("path" = /obj/item/clothing/ears/earmuffs, "cost" = 35, "max_supply" = 4),
		list("path" = /obj/item/clothing/suit/hazardvest, "cost" = 50, "max_supply" = 6),
		list("path" = /obj/item/extinguisher, "cost" = 60, "max_supply" = 8),
		list("path" = /obj/item/extinguisher/mini, "cost" = 35, "max_supply" = 8),
		// -- Toolboxes --
		list("path" = /obj/item/storage/toolbox/emergency, "cost" = 75, "max_supply" = 6),
...
/datum/cargo_list/tools_engineering
	...
	entries = list(
		// -- Belts & bags --
		list("path" = /obj/item/storage/belt/utility, "cost" = 150, "max_supply" = 4),
		list("path" = /obj/item/storage/bag/construction, "cost" = 200, "max_supply" = 4),
		list("path" = /obj/item/storage/box/emptysandbags, "cost" = 75, "max_supply" = 6),
		// -- Personal protective equipment --
		list("path" = /obj/item/clothing/head/utility/welding, "cost" = 150, "max_supply" = 4),
		list("path" = /obj/item/clothing/glasses/meson/engine, "cost" = 350, "max_supply" = 3),
		...
		list("path" = /obj/item/rcd_ammo, "cost" = 250, "max_supply" = 6),
		list("path" = /obj/item/rcd_ammo/large, "cost" = 750, "max_supply" = 3),
		list("path" = /obj/item/electronics/apc, "cost" = 250, "max_supply" = 6),
		// -- Atmospherics & signage --
		list("path" = /obj/item/pipe_dispenser, "cost" = 500, "max_supply" = 2),
		list("path" = /obj/item/airlock_painter, "cost" = 75, "max_supply" = 4),
		list("path" = /obj/item/airlock_painter/decal, "cost" = 100, "max_supply" = 3),
		...
		list("path" = /obj/item/forcefield_projector, "cost" = 750, "max_supply" = 2),
	)
...
/datum/cargo_list/tools_janitor
	...
	entries = list(
		// -- Cleaning supplies --
		list("path" = /obj/item/mop, "cost" = 25, "max_supply" = 4),
		list("path" = /obj/item/reagent_containers/cup/bucket, "cost" = 15, "max_supply" = 6),
		list("path" = /obj/item/pushbroom, "cost" = 25, "max_supply" = 4),
		list("path" = /obj/item/storage/bag/trash, "cost" = 20, "max_supply" = 6),
		list("path" = /obj/item/reagent_containers/spray/cleaner, "cost" = 60, "max_supply" = 5),
		list("path" = /obj/item/reagent_containers/cup/rag, "cost" = 10, "max_supply" = 6),
		list("path" = /obj/item/soap/nanotrasen, "cost" = 15, "max_supply" = 6),
		list("path" = /obj/item/clothing/suit/caution, "cost" = 10, "max_supply" = 6),
		list("path" = /obj/item/grenade/chem_grenade/cleaner, "cost" = 200, "max_supply" = 6),
		// -- Tools & equipment --
		list("path" = /obj/item/lightreplacer, "cost" = 150, "max_supply" = 3),
		...
		list("path" = /obj/item/storage/box/lights/mixed, "cost" = 75, "max_supply" = 8),
		list("path" = /obj/item/storage/box/lights/bulbs, "cost" = 60, "max_supply" = 8),
		list("path" = /obj/item/storage/box/lights/tubes, "cost" = 60, "max_supply" = 8),
		// -- Large equipment --
		list("path" = /obj/structure/janitorialcart, "cost" = 500, "max_supply" = 2, "small_item" = FALSE, "crate_type" = /obj/structure/closet/crate/large),
...
/datum/cargo_list/tools_hydro
	...
	entries = list(
		...
		list("path" = /obj/item/hatchet, "cost" = 25, "max_supply" = 4),
		list("path" = /obj/item/cultivator, "cost" = 15, "max_supply" = 4),
		list("path" = /obj/item/plant_analyzer, "cost" = 50, "max_supply" = 4),
		list("path" = /obj/item/clothing/gloves/botanic_leather, "cost" = 150, "max_supply" = 4),
		// -- Plant care sprays --
		list("path" = /obj/item/reagent_containers/spray/plantbgone, "cost" = 60, "max_supply" = 6),
		// -- Specialist equipment --
		list("path" = /obj/item/storage/box/disks_plantgene, "cost" = 300, "max_supply" = 3),
		// -- Large equipment --
...
/datum/cargo_list/tools_forensics
	...
	entries = list(
		...
		list("path" = /obj/item/detective_scanner, "cost" = 500, "max_supply" = 2),
		list("path" = /obj/item/camera/detective, "cost" = 350, "max_supply" = 2),
		list("path" = /obj/item/taperecorder, "cost" = 100, "max_supply" = 3),
		list("path" = /obj/item/storage/box/evidence, "cost" = 75, "max_supply" = 4),
		list("path" = /obj/item/toy/crayon/white, "cost" = 5, "max_supply" = 6),
		// -- General-access scanners --
		list("path" = /obj/item/geiger_counter, "cost" = 75, "max_supply" = 4, "access_budget" = FALSE),
		list("path" = /obj/item/export_scanner, "cost" = 75, "max_supply" = 3, "access_budget" = FALSE),
		list("path" = /obj/item/binoculars, "cost" = 100, "max_supply" = 3, "access_budget" = FALSE),
	)
...
/datum/cargo_list/tools_cargo
	...
	entries = list(
		...
		list("path" = /obj/item/dest_tagger, "cost" = 25, "max_supply" = 3),
		list("path" = /obj/item/stack/package_wrap, "cost" = 20, "max_supply" = 6),
		list("path" = /obj/item/megaphone, "cost" = 150, "max_supply" = 2),
		// -- Mining --
...
/datum/cargo_list/equipment_eva
	...
	entries = list(
		...
		list("path" = /obj/item/tank/internals/oxygen, "cost" = 150, "max_supply" = 4),
		list("path" = /obj/item/tank/internals/emergency_oxygen/engi, "cost" = 75, "max_supply" = 6),
		// -- Jetpacks --
