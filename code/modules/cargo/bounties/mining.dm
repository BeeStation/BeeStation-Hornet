/datum/bounty/item/mining/goliath_steaks
	...
	required_count = 3
	wanted_types = list(
		/obj/item/food/meat/steak/goliath = TRUE,
	)
...
/datum/bounty/item/mining/goliath_boat
	...
	reward = 10000
	wanted_types = list(
		/obj/vehicle/ridden/lavaboat = TRUE,
	)
...
/datum/bounty/item/mining/bone_bow
	...
	reward = 10000
	wanted_types = list(
		/obj/item/gun/ballistic/bow/ashen = TRUE,
	)
...
/datum/bounty/item/mining/bone_armor
	...
	reward = 5000
	wanted_types = list(
		/obj/item/clothing/suit/armor/bone = TRUE,
	)
...
/datum/bounty/item/mining/skull_helmet
	...
	reward = 4000
	wanted_types = list(
		/obj/item/clothing/head/helmet/skull = TRUE,
	)
...
/datum/bounty/item/mining/bone_talisman
	...
	required_count = 3
	wanted_types = list(
		/obj/item/clothing/accessory/talisman = TRUE,
	)
...
/datum/bounty/item/mining/bone_dagger
	...
	required_count = 3
	wanted_types = list(
		/obj/item/knife/combat/bone = TRUE,
	)
...
/datum/bounty/item/mining/polypore_mushroom
	...
	wanted_types = list(
		/obj/item/reagent_containers/cup/bowl/mushroom_bowl = TRUE,
	)
...
/datum/bounty/item/mining/inocybe_mushroom
	...
	required_count = 3
	wanted_types = list(
		/obj/item/food/grown/ash_flora/mushroom_cap = TRUE,
	)
...
/datum/bounty/item/mining/porcini_mushroom
	...
	required_count = 3
	wanted_types = list(
		/obj/item/food/grown/ash_flora/mushroom_leaf = TRUE,
	)
