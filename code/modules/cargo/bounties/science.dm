/datum/bounty/item/science/boh
	...
	reward = 10000
	wanted_types = list(
		/obj/item/storage/backpack/holding = TRUE,
	)
...
/datum/bounty/item/science/tboh
	...
	reward = 10000
	wanted_types = list(
		/obj/item/storage/bag/trash/bluespace = TRUE,
	)
...
/datum/bounty/item/science/bluespace_syringe
	...
	reward = 10000
	wanted_types = list(
		/obj/item/reagent_containers/syringe/bluespace = TRUE,
	)
...
/datum/bounty/item/science/bluespace_capsule
	...
	reward = 10000
	wanted_types = list(
		/obj/item/bluespace_capsule = TRUE,
	)
...
/datum/bounty/item/science/nightvision_goggles
	...
	reward = 10000
	wanted_types = list(
		/obj/item/clothing/glasses/night = TRUE,
		/obj/item/clothing/glasses/meson/night = TRUE,
		/obj/item/clothing/glasses/hud/health/night = TRUE,
		/obj/item/clothing/glasses/hud/security/night = TRUE,
		/obj/item/clothing/glasses/hud/diagnostic/night = TRUE,
	)
...
/datum/bounty/item/science/experimental_welding_tool
	...
	required_count = 3
	wanted_types = list(
		/obj/item/weldingtool/experimental = TRUE,
	)
...
/datum/bounty/item/science/cryostasis_beaker
	...
	reward = 10000
	wanted_types = list(
		/obj/item/reagent_containers/cup/beaker/noreact = TRUE,
	)
...
/datum/bounty/item/science/diamond_drill
	...
	reward = 15000
	wanted_types = list(
		/obj/item/pickaxe/drill/diamonddrill = TRUE,
		/obj/item/mecha_parts/mecha_equipment/drill/diamonddrill = TRUE,
	)
...
/datum/bounty/item/science/advanced_egun
	...
	reward = 10000
	wanted_types = list(
		/obj/item/gun/energy/e_gun/nuclear = TRUE,
	)
