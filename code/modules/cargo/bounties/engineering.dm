...
/datum/bounty/item/engineering/energy_ball
	...
	reward = CARGO_CRATE_VALUE * 375 //requires 14k credits of purchases, not to mention cooperation with engineering/heads of staff to set up inside the cramped shuttle
