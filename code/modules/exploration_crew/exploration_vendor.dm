/obj/machinery/vendor/exploration
	...
	prize_list = list(
		//Equipment
			new /datum/data/vendor_equipment("Explorer's Webbing", /obj/item/storage/belt/mining, 2000, "Equipment"),
			new /datum/data/vendor_equipment("Expanded E. Oxygen Tank", /obj/item/tank/internals/emergency_oxygen/engi, 1000, "Equipment"),
			new /datum/data/vendor_equipment("Survival Knife", /obj/item/knife/combat/survival, 1000, "Equipment"),
		//Consumables
			new /datum/data/vendor_equipment("1 Marker Beacon", /obj/item/stack/marker_beacon, 50, "Consumables"),
			new /datum/data/vendor_equipment("10 Marker Beacons", /obj/item/stack/marker_beacon/ten, 300, "Consumables"),
			new /datum/data/vendor_equipment("30 Marker Beacons", /obj/item/stack/marker_beacon/thirty, 500, "Consumables"),
			new /datum/data/vendor_equipment("Survival Medipen", /obj/item/reagent_containers/hypospray/medipen/survival, 2000, "Consumables"),
			new /datum/data/vendor_equipment("Brute Healing Kit", /obj/item/storage/firstaid/brute, 3000, "Consumables"),
			new /datum/data/vendor_equipment("Burn Healing Kit", /obj/item/storage/firstaid/fire, 3000, "Consumables"),
			new /datum/data/vendor_equipment("Advanced Healing Kit", /obj/item/storage/firstaid/advanced, 5000, "Consumables"),
		//Weapons & Tools
			new /datum/data/vendor_equipment("Breaching Charge", /obj/item/grenade/exploration, 1000, "Weapons & Tools"),
			new /datum/data/vendor_equipment(".38 Prospector Ammo box", /obj/item/ammo_box/c38/exploration, 1000, "Weapons & Tools"),
			new /datum/data/vendor_equipment("Charge Detonator", /obj/item/exploration_detonator, 10000, "Weapons & Tools"),
			new /datum/data/vendor_equipment("Multi-Purpose Energy Gun", /obj/item/gun/energy/e_gun/mini/exploration, 20000, "Weapons & Tools"),
		//Novelty
			new /datum/data/vendor_equipment("Pizza", /obj/item/pizzabox/margherita, 200, "Novelty"),
			new /datum/data/vendor_equipment("Whiskey", /obj/item/reagent_containers/cup/glass/bottle/whiskey, 1000, "Novelty"),
			new /datum/data/vendor_equipment("Absinthe", /obj/item/reagent_containers/cup/glass/bottle/absinthe/premium, 1000, "Novelty"),
			new /datum/data/vendor_equipment("Cigar", /obj/item/clothing/mask/cigarette/cigar/havana, 1500, "Novelty"),
			new /datum/data/vendor_equipment("Soap", /obj/item/soap/nanotrasen, 2000, "Novelty"),
			new /datum/data/vendor_equipment("Laser Pointer", /obj/item/laser_pointer, 3000, "Novelty"),
			new /datum/data/vendor_equipment("Toy Alien", /obj/item/clothing/mask/facehugger/toy, 3000, "Novelty"),
	)

/obj/machinery/vendor/exploration/ui_static_data(mob/user)
	. = list()
