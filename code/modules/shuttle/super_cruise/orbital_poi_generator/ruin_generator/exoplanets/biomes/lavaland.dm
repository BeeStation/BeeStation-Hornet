/datum/exoplanet_biome/lavaland
	...
	plains_decoration = list(/mob/living/simple_animal/hostile/asteroid/goldgrub = 1, /mob/living/simple_animal/hostile/asteroid/goliath = 5, /mob/living/simple_animal/hostile/asteroid/basilisk = 4, /mob/living/simple_animal/hostile/asteroid/hivelord = 3, /obj/structure/flora/ash/leaf_shroom = 20, /obj/structure/flora/ash/cap_shroom = 20, /obj/structure/flora/ash/stem_shroom = 20 , /obj/structure/flora/ash/cacti = 10, /obj/structure/flora/ash/tall_shroom = 20, /obj/structure/flora/ash/seraka = 20)
