...
/obj/docking_port/mobile/supply/proc/buy()
	...
	for(var/datum/supply_order/SO in SSshuttle.shoppinglist)
		...
		if(SO.paying_account) //Someone paid out of pocket
			...
			D = SSeconomy.get_dep_account(ACCOUNT_CAR_ID)
		if(D)
		...
		if(SO.paying_account)
			...
			var/datum/bank_account/department/cargo = SSeconomy.get_dep_account(ACCOUNT_CAR_ID)
	...
	var/datum/bank_account/cargo_budget = SSeconomy.get_dep_account(ACCOUNT_CAR_ID)
