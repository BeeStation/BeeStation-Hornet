...
/obj/machinery/ntnet_relay/Initialize(mapload)
	...
	if(SSnetworks.station_network)
		...
		SSnetworks.add_log("DIAGNOSTICS // New quantum relay activated. Current amount of linked relays: [SSnetworks.relays.len]")
	. = ..()

/obj/machinery/ntnet_relay/Destroy()
	if(SSnetworks.station_network)
		SSnetworks.relays.Remove(src)
		SSnetworks.add_log("DIAGNOSTICS // Quantum relay connection severed. Current amount of linked relays: [SSnetworks.relays.len]")
		NTNet = null
