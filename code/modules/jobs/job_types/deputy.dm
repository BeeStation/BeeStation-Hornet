...
/datum/job/deputy
	...
	access = list(ACCESS_SEC_DOORS, ACCESS_COURT, ACCESS_WEAPONS, ACCESS_DEPUTY, ACCESS_SEC_RECORDS)
	minimal_access = list(ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_COURT, ACCESS_WEAPONS, ACCESS_DEPUTY, ACCESS_SEC_RECORDS)
