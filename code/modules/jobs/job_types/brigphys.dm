/datum/job/brig_phys
	...
	access = list(ACCESS_BRIGPHYS, ACCESS_BRIG, ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_COURT, ACCESS_MAINT_TUNNELS, ACCESS_MORGUE, ACCESS_WEAPONS, ACCESS_FORENSICS_LOCKERS, ACCESS_MEDICAL, ACCESS_KEYCARD_AUTH)
	minimal_access = list(ACCESS_SECURITY, ACCESS_BRIG, ACCESS_BRIGPHYS, ACCESS_SEC_DOORS, ACCESS_BRIG, ACCESS_COURT, ACCESS_MAINT_TUNNELS, ACCESS_MORGUE, ACCESS_WEAPONS, ACCESS_FORENSICS_LOCKERS, ACCESS_MEDICAL, ACCESS_KEYCARD_AUTH)
