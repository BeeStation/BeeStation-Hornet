/datum/job/brig_physician
	...
	base_access = list(ACCESS_BRIGPHYS, ACCESS_SEC_DOORS, ACCESS_COURT,  ACCESS_MECH_MEDICAL, ACCESS_MAINT_TUNNELS)
	extra_access = list(ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_SURGERY)
