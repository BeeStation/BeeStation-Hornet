...
/datum/outfit/job/security_officer
	...
	backpack_contents = list(
		/obj/item/ammo_box/magazine/x200law = 2,
		/obj/item/ammo_casing/taser = 1,
		)

	implants = list(/obj/item/implant/mindshield)

	chameleon_extras = list(/obj/item/gun/ballistic/automatic/pistol/security, /obj/item/clothing/glasses/hud/security/sunglasses, /obj/item/clothing/head/helmet)
