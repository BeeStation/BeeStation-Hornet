...
/datum/outfit/job/security
	...
	suit_store = /obj/item/gun/energy/energypistol
	...
	chameleon_extras = list(/obj/item/gun/energy/energypistol, /obj/item/clothing/glasses/hud/security/sunglasses, /obj/item/clothing/head/helmet)
