...
/proc/get_all_accesses()
	return list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_SEC_RECORDS, ACCESS_BRIG, ACCESS_BRIGPHYS, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_COURT,
	            ...
	            ACCESS_EXTERNAL_AIRLOCKS, ACCESS_BRIDGE, ACCESS_CHANGE_IDS, ACCESS_AI_UPLOAD,
	            ...
	            ACCESS_HYDROPONICS, ACCESS_LIBRARY, ACCESS_CAA, ACCESS_VIROLOGY, ACCESS_CMO, ACCESS_QM, ACCESS_EXPLORATION, ACCESS_SURGERY,
...
/proc/get_region_accesses(code)
	switch(code)
		...
		if(1) //station general
			return list(ACCESS_KITCHEN,ACCESS_BAR, ACCESS_HYDROPONICS, ACCESS_JANITOR, ACCESS_CHAPEL_OFFICE, ACCESS_CREMATORIUM, ACCESS_LIBRARY, ACCESS_THEATRE, ACCESS_CAA)
		if(2) //security
		...
		if(7) //command
			return list(ACCESS_HEADS, ACCESS_RC_ANNOUNCE, ACCESS_KEYCARD_AUTH, ACCESS_BRIDGE, ACCESS_CHANGE_IDS, ACCESS_AI_UPLOAD, ACCESS_TELEPORTER, ACCESS_EVA, ACCESS_GATEWAY, ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_HOP, ACCESS_CAPTAIN, ACCESS_VAULT)
...
/proc/get_access_desc(A)
	switch(A)
		...
		if(ACCESS_LIBRARY)
			return "Library"
		if(ACCESS_CAA)
			return "Corporate Affairs Office"
		if(ACCESS_ROBOTICS)
			return "Robotics"
		if(ACCESS_VIROLOGY)
			return "Virology"
...
/proc/get_all_jobs()
	return list(JOB_NAME_CAPTAIN,
				...
				JOB_NAME_CHAPLAIN, JOB_NAME_CAA, JOB_NAME_CLOWN, JOB_NAME_MIME, JOB_NAME_BARBER, JOB_NAME_STAGEMAGICIAN,
				// Cargo
