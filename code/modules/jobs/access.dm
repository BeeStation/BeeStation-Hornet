...
/proc/get_all_jobs()
	return list(JOB_KEY_CAPTAIN,
				// Service
				JOB_KEY_ASSISTANT, JOB_KEY_HEADOFPERSONNEL, JOB_KEY_BARTENDER, JOB_KEY_COOK, JOB_KEY_BOTANIST, JOB_KEY_JANITOR, JOB_KEY_CURATOR,
				JOB_KEY_CHAPLAIN, JOB_KEY_LAWYER, JOB_KEY_CLOWN, JOB_KEY_MIME, JOB_KEY_BARBER, JOB_KEY_STAGEMAGICIAN,
				// Cargo
				JOB_KEY_QUARTERMASTER, JOB_KEY_CARGOTECHNICIAN,JOB_KEY_SHAFTMINER,
				// R&D
				JOB_KEY_RESEARCHDIRECTOR, JOB_KEY_SCIENTIST, JOB_KEY_ROBOTICIST, JOB_KEY_EXPLORATIONCREW,
				// Engineering
				JOB_KEY_CHIEFENGINEER, JOB_KEY_STATIONENGINEER, JOB_KEY_ATMOSPHERICTECHNICIAN,
				// Medical
				JOB_KEY_CHIEFMEDICALOFFICER, JOB_KEY_MEDICALDOCTOR, JOB_KEY_CHEMIST, JOB_KEY_GENETICIST, JOB_KEY_VIROLOGIST, JOB_KEY_PARAMEDIC, JOB_KEY_PSYCHIATRIST,
				// Security
