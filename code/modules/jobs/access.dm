...
/proc/get_all_accesses()
	return list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_SEC_RECORDS, ACCESS_BRIG, ACCESS_BRIGPHYS, ACCESS_ARMORY, ACCESS_FORENSICS_LOCKERS, ACCESS_COURT,
	            ...
	            ACCESS_HYDROPONICS, ACCESS_LIBRARY, ACCESS_IAA, ACCESS_VIROLOGY, ACCESS_CMO, ACCESS_QM, ACCESS_EXPLORATION, ACCESS_SURGERY,
...
/proc/get_access_desc(A)
	switch(A)
		...
		if(ACCESS_LIBRARY)
			return "Library"
		if(ACCESS_IAA)
			return "Internal Affairs Office"
		if(ACCESS_ROBOTICS)
			return "Robotics"
		if(ACCESS_VIROLOGY)
			return "Virology"
...
/proc/get_all_jobs()
	return list("Captain",
				...
				"Chaplain", "Internal Affairs Agent", "Lawyer", "Clown", "Mime", "Barber", "Stage Magician",
				// Cargo
