...
/datum/error_viewer/error_entry/show_to(user, datum/error_viewer/back_to, linear)
	...
	if (usr_ref)
		html += "<br><b>usr</b>: <a href='byond://?[HREF_TYPE(var_edit)][HREF_PARAM(var_edit::Vars, usr_ref)][HrefToken()]'>VV</a>"
		...
		if (istype(usr_loc))
			html += "<br><b>usr.loc</b>: <a href='byond://?[HREF_TYPE(var_edit)][HREF_PARAM(var_edit::Vars, REF(usr_loc))][HrefToken()]'>VV</a>"
