...
/obj/item/reagent_containers/food/snacks/meat/slab
	...
	bitesize = 3
	list_reagents = list(/datum/reagent/consumable/nutriment = 3, /datum/reagent/consumable/cooking_oil = 2, /datum/reagent/carbon = 1) //Meat has fats that a food processor can process into cooking oil
