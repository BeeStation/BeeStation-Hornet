...
/obj/item/reagent_containers/food/snacks/burger/chicken
	...
	desc = "A delicious chicken sandwich. Considering how processed this is, the taste holds up pretty well."
	icon_state = "chickenburger"
	tastes = list("bun" = 2, "chicken" = 4, "A smiling white-mustached man's deep accent" = 1)
