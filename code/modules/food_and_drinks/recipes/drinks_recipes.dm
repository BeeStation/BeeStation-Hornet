...
/datum/chemical_reaction/vodka_cola
	...
	results = list(/datum/reagent/consumable/ethanol/vodka_cola = 3)
	required_reagents = list(/datum/reagent/consumable/ethanol/vodka = 2, /datum/reagent/consumable/space_cola = 1)
