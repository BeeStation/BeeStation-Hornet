...
/obj/item/gun/energy/e_gun/hos
	...
	desc = "This is an expensive, modern recreation of an antique laser gun. This gun has an electric taser firing mode."
	...
	fire_rate = 3
	full_auto = TRUE
	ammo_type = list(/obj/item/ammo_casing/energy/electrode/hos, /obj/item/ammo_casing/energy/disabler)
	ammo_x_offset = 4
