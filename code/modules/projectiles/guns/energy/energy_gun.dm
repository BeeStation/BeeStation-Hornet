...
/obj/item/gun/energy/e_gun/mini/heads
	desc = "A small, pistol-sized energy gun with a built-in flashlight and the ability to recharge itself in 60 seconds. It has two settings: disable and kill. These weapons are standard issue for leadership within Nanotrasen."
