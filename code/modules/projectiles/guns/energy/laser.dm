...
/obj/item/gun/energy/laser/captain
	...
	force = 10
	ammo_x_offset = 3
	cell_type = /obj/item/stock_parts/cell{charge = 700; maxcharge = 700} //This retain's the guns original capacity of 14 shots. Also just like before it will actually feel like 15 because at least one shot will recharge when discharging a full magazine
	selfcharge = 1
