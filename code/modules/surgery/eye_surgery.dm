...
/datum/surgery/eye_surgery/can_start(mob/user, mob/living/carbon/target, target_zone)
...
/datum/surgery_step/fix_eyes/preop(mob/user, mob/living/carbon/target, obj/item/tool, datum/surgery/surgery)
...
/datum/surgery_step/fix_eyes/success(mob/user, mob/living/carbon/target, obj/item/tool, datum/surgery/surgery)
	var/obj/item/organ/eyes/E = target.get_organ_slot(ORGAN_SLOT_EYES)
