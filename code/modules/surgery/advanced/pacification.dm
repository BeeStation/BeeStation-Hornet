...
/datum/surgery_step/pacify/preop(mob/user, mob/living/carbon/target, obj/item/tool, datum/surgery/surgery)
...
/datum/surgery_step/pacify/success(mob/user, mob/living/carbon/target, obj/item/tool, datum/surgery/surgery)
...
/datum/surgery_step/pacify/failure(mob/user, mob/living/carbon/target, obj/item/tool, datum/surgery/surgery)
