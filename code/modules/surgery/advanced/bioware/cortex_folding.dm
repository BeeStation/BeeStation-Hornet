...
/datum/surgery_step/fold_cortex/preop(mob/user, mob/living/carbon/target, obj/item/tool, datum/surgery/surgery)
	display_results(
		user,
		target,
		"<span class='notice'>You start folding [target]'s outer cerebral cortex into a fractal pattern.</span>",
...
/datum/surgery_step/fold_cortex/success(mob/user, mob/living/carbon/target, obj/item/tool, datum/surgery/surgery, default_display_results = FALSE)
	display_results(
		user,
		target,
		"<span class='notice'>You fold [target]'s outer cerebral cortex into a fractal pattern!</span>",
