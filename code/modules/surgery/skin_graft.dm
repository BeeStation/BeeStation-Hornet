...
/datum/surgery_step/clamp_bleeders/skin_graft/preop(mob/user, mob/living/carbon/target, obj/item/tool, datum/surgery/surgery)
...
/datum/surgery_step/clamp_bleeders/skin_graft/success(mob/user, mob/living/carbon/target, obj/item/tool, datum/surgery/skin_graft/surgery)
