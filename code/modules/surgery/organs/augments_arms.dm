...
/obj/item/organ/cyberimp/arm/gun/emp_act(severity)
	...
	if(prob(30/severity) && owner && !(organ_flags & ORGAN_FAILING))
		Retract()
		owner.visible_message(span_danger("A loud bang comes from [owner]\'s [slot == ORGAN_SLOT_RIGHT_ARM_AUG ? "right" : "left"] arm!"))
		playsound(get_turf(owner), 'sound/weapons/flashbang.ogg', 100, 1)
		to_chat(owner, span_userdanger("You feel an explosion erupt inside your [slot == ORGAN_SLOT_RIGHT_ARM_AUG ? "right" : "left"] arm as your implant breaks!"))
