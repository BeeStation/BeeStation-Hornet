...
/obj/item/organ/external/Remove(mob/living/carbon/organ_owner, special, pref_load)
	. = ..()
...
/obj/item/organ/external/antennae/Remove(mob/living/carbon/organ_owner, special, pref_load)
	. = ..()
