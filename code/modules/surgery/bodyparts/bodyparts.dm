...
/obj/item/bodypart/proc/update_limb(dropping_limb, is_creating = FALSE)
	SHOULD_CALL_PARENT(TRUE)
	...
	if (!dropping_limb && owner && IS_ORGANIC_LIMB(src))
		variable_color = GET_TRAIT_VALUE(owner, TRAIT_OVERRIDE_SKIN_COLOUR)
	else
		variable_color = null
