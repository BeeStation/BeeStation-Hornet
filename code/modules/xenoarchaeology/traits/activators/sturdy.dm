...
/datum/xenoartifact_trait/activator/sturdy/hungry/trigger_artifact(atom/target, type, force)
	...
	if(isliving(M) && !bite_timer)
		...
		var/zone = pick(BODY_ZONE_CHEST, BODY_ZONE_PRECISE_L_HAND, BODY_ZONE_PRECISE_R_HAND, BODY_ZONE_L_LEG, BODY_ZONE_R_LEG)
		M.deal_damage(15, SHARP_III, BRUTE, zone = zone)
