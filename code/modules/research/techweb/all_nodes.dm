...
/datum/techweb_node/basic_circuitry
	...
	design_ids = list("integrated_circuit", "circuit_multitool", "comp_arithmetic", "comp_bitwise", "comp_clock", "comp_combiner", "comp_comparison", "comp_delay",
		...
		"comp_random", "comp_round", "comp_select_query", "comp_species", "comp_textcase","comp_speech", "comp_concat", "comp_concat_list", "comp_speech", "comp_self", "comp_soundemitter", "comp_radio", "comp_tostring",
