...
/datum/techweb_node/odysseus
	...
	prereq_ids = list("base")
	design_ids = list("odysseus_chassis",
		"odysseus_torso",
		"odysseus_head",
		"odysseus_left_arm",
...
/datum/techweb_node/durand
	...
	prereq_ids = list("adv_mecha",
		"adv_weaponry")
	design_ids = list("durand_chassis",
		"durand_torso",
		"durand_head",
		"durand_left_arm",
		"durand_right_arm",
...
/datum/techweb_node/phazon
	...
	design_ids = list("phazon_chassis",
		"phazon_torso",
		"phazon_head",
		"phazon_left_arm",
		"phazon_right_arm",
...
/datum/techweb_node/mech_modules
	...
	prereq_ids = list("adv_mecha",
		"bluespace_power")
	design_ids = list("mech_energy_relay",
		"mech_ccw_armor",
		"mech_proj_armor",
...
/datum/techweb_node/nanite_base
	...
	design_ids = list("nanite_disk",
		...
		"nanite_cloud_control",\
						"relay_nanites",
		"monitoring_nanites",
		"research_nanites" ,"researchplus_nanites",
		"access_nanites",
		"repairing_nanites",
...
/datum/techweb_node/nanite_smart
	...
	prereq_ids = list("nanite_base",
		"robotics")
	design_ids = list("purging_nanites",
		"metabolic_nanites",
		"stealth_nanites",
		"memleak_nanites",
...
/datum/techweb_node/nanite_mesh
	...
	prereq_ids = list("nanite_base",
		"engineering")
	design_ids = list("hardening_nanites",
...
/datum/techweb_node/nanite_bio
	...
	prereq_ids = list("nanite_base",
		"biotech")
	design_ids = list("regenerative_nanites",
		"bloodheal_nanites",
		"coagulating_nanites",
		"poison_nanites",
		"flesheating_nanites",\
...
/datum/techweb_node/nanite_neural
	...
	design_ids = list("nervous_nanites",
		"brainheal_nanites",
		"paralyzing_nanites",
		"stun_nanites",
		"selfscan_nanites",
...
/datum/techweb_node/nanite_synaptic
	...
	prereq_ids = list("nanite_neural",
		"neural_programming")
	design_ids = list("mindshield_nanites",
		"pacifying_nanites",
		"blinding_nanites",
		"sleep_nanites",
		"mute_nanites",
...
/datum/techweb_node/nanite_harmonic
	...
	prereq_ids = list("nanite_bio",
		"nanite_smart",
		"nanite_mesh")
	design_ids = list("fakedeath_nanites",
		"aggressive_nanites",
		"defib_nanites",
...
/datum/techweb_node/nanite_combat
	...
	prereq_ids = list("nanite_harmonic",
		"syndicate_basic")
	design_ids = list("explosive_nanites",
		"pyro_nanites",
		"meltdown_nanites",
		"viral_nanites",
...
/datum/techweb_node/syndicate_basic
	...
	design_ids = list("decloner",
		...
		"donksofttoyvendor",
		"donksoft_refill",
		"advanced_camera" , "arcade_amputation")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 10000)
	export_price = 5000
	hidden = TRUE
...
/datum/techweb_node/sticky_advanced
	...
	design_ids = list("super_sticky_tape",
		"pointy_tape")
