...
/datum/techweb_node/practical_bluespace
	...
	design_ids = list("bs_rped","minerbag_holding", "gigabeacon", "bluespacebeaker", "bluespacesyringe", "bluespacebodybag", "phasic_scanning", "roastingstick", "ore_silo", "antivirus3")
	research_costs = list(TECHWEB_POINT_TYPE_GENERIC = 5000)
	export_price = 5000
