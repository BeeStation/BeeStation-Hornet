...
/datum/techweb_node/basic_circuitry
	...
	design_ids = list("integrated_circuit", "circuit_multitool", "comp_arithmetic", "comp_clock", "comp_combiner", "comp_comparison", "comp_delay",
		"comp_direction", "comp_get_column", "comp_gps", "comp_health", "comp_hear", "comp_index", "comp_index_table", "comp_write", "comp_length", "comp_light", "comp_logic", "comp_list_constructor", "comp_mmi", "comp_multiplexer", "comp_not", "comp_ram",
