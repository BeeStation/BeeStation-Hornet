...
/datum/design/board/aicore
	...
	category = list(RND_CATEGORY_AI + RND_SUBCATEGORY_AI_CORE)
...
/datum/design/board/safeguard_module
	...
	category = list(RND_CATEGORY_AI + RND_SUBCATEGORY_AI_LAW_MANIPULATION)
	departmental_flags = DEPARTMENTAL_FLAG_SCIENCE
...
/datum/design/board/asimov_module
	...
	category = list(RND_CATEGORY_AI + RND_SUBCATEGORY_AI_CORE_MODULES)
	departmental_flags = DEPARTMENTAL_FLAG_SCIENCE
...
/datum/design/board/tyrant_module
	...
	category = list(RND_CATEGORY_AI + RND_SUBCATEGORY_AI_DANGEROUS_MODULES)
	departmental_flags = DEPARTMENTAL_FLAG_SCIENCE
