...
/datum/design/pocketfireextinguisher
	...
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 50, MAT_GLASS = 40)
...
/datum/design/weldingtool
	...
	id = "welding_tool"
	build_type = AUTOLATHE | PROTOLATHE
	materials = list(MAT_IRON = 70, MAT_GLASS = 20)
...
/datum/design/welding_helmet
	...
	id = "welding_helmet"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 1750, MAT_GLASS = 400)
...
/datum/design/cable_coil
	...
	id = "cable_coil"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 10, MAT_GLASS = 5)
...
/datum/design/camera
	...
	id = "camera"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 50, MAT_GLASS = 100)
...
/datum/design/camera_film
	...
	id = "camera_film"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 10, MAT_GLASS = 10)
...
/datum/design/pipe_painter
	...
	id = "pipe_painter"
	build_type = AUTOLATHE | PROTOLATHE
	materials = list(MAT_IRON = 5000, MAT_GLASS = 2000)
...
/datum/design/rglass
	...
	materials = list(MAT_IRON = 1000, MAT_GLASS = MINERAL_MATERIAL_AMOUNT)
...
/datum/design/healthanalyzer
	...
	id = "healthanalyzer"
	build_type = AUTOLATHE | PROTOLATHE
	materials = list(MAT_IRON = 500, MAT_GLASS = 50)
...
/datum/design/pillbottle
	...
	id = "pillbottle"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 20, MAT_GLASS = 100)
...
/datum/design/recorder
	...
	id = "recorder"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 60, MAT_GLASS = 30)
...
/datum/design/signaler
	...
	id = "signaler"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 400, MAT_GLASS = 120)
...
/datum/design/bounced_radio
	...
	id = "bounced_radio"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 75, MAT_GLASS = 25)
...
/datum/design/camera_assembly
	...
	id = "camera_assembly"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 400, MAT_GLASS = 250)
...
/datum/design/newscaster_frame
	...
	id = "newscaster_frame"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 14000, MAT_GLASS = 8000)
...
/datum/design/rpd
	...
	id = "rpd"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 75000, MAT_GLASS = 37500)
...
/datum/design/electropack
	...
	id = "electropack"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 10000, MAT_GLASS = 2500)
...
/datum/design/large_welding_tool
	...
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 70, MAT_GLASS = 60)
...
/datum/design/riot_dart
	...
	id = "riot_dart"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 1000) //Discount for making individually - no box = less metal!
...
/datum/design/riot_darts
	...
	id = "riot_darts"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 50000) //Comes with 40 darts
...
/datum/design/desttagger
	...
	id = "desttagger"
	build_type = AUTOLATHE | PROTOLATHE
	materials = list(MAT_IRON = 250, MAT_GLASS = 125)
...
/datum/design/handlabeler
	...
	id = "handlabel"
	build_type = AUTOLATHE | PROTOLATHE
	materials = list(MAT_IRON = 150, MAT_GLASS = 125)
...
/datum/design/geiger
	...
	id = "geigercounter"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 150, MAT_GLASS = 150)
...
/datum/design/conveyor_switch
	...
	id = "conveyor_switch"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 450, MAT_GLASS = 190)
...
/datum/design/slime_scanner
	...
	id = "slime_scanner"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 300, MAT_GLASS = 200)
...
/datum/design/pet_carrier
	...
	id = "pet_carrier"
	build_type = AUTOLATHE
	materials = list(MAT_IRON = 7500, MAT_GLASS = 100)
...
/datum/design/packageWrap
	...
	id = "packagewrap"
	build_type = AUTOLATHE | PROTOLATHE
	materials = list(MAT_IRON = 200, MAT_GLASS = 200)
