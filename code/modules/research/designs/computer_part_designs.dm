...
/datum/design/disk/normal
	...
	materials = list(MAT_IRON = 400, MAT_GLASS = 100, MAT_COPPER = 150)
...
/datum/design/disk/advanced
	...
	id = "hdd_advanced"
	build_type = PROTOLATHE
	materials = list(MAT_IRON = 800, MAT_GLASS = 200, MAT_COPPER = 300)
...
/datum/design/disk/super
	...
	id = "hdd_super"
	build_type = PROTOLATHE
	materials = list(MAT_IRON = 1600, MAT_GLASS = 400, MAT_COPPER = 600)
...
/datum/design/disk/cluster
	...
	id = "hdd_cluster"
	build_type = PROTOLATHE
	materials = list(MAT_IRON = 3200, MAT_GLASS = 800, MAT_COPPER = 1000)
...
/datum/design/disk/small
	...
	id = "ssd_small"
	build_type = PROTOLATHE
	materials = list(MAT_IRON = 800, MAT_GLASS = 200, MAT_COPPER = 200)
...
/datum/design/netcard/basic
	...
	materials = list(MAT_IRON = 250, MAT_GLASS = 100, MAT_COPPER = 10)
...
/datum/design/netcard/advanced
	...
	id = "netcard_advanced"
	build_type = IMPRINTER
	materials = list(MAT_IRON = 500, MAT_GLASS = 200, MAT_COPPER = 200)
...
/datum/design/netcard/wired
	...
	id = "netcard_wired"
	build_type = IMPRINTER
	materials = list(MAT_IRON = 2500, MAT_GLASS = 400, MAT_COPPER = 400)
...
/datum/design/portabledrive/basic
	...
	id = "portadrive_basic"
	build_type = IMPRINTER
	materials = list(MAT_GLASS = 800, MAT_COPPER = 200)
...
/datum/design/portabledrive/advanced
	...
	build_type = IMPRINTER
	materials = list(MAT_GLASS = 1600, MAT_COPPER = 300)
...
/datum/design/portabledrive/super
	...
	id = "portadrive_super"
	build_type = IMPRINTER
	materials = list(MAT_GLASS = 3200, MAT_COPPER = 400)
...
/datum/design/cardslot
	...
	id = "cardslot"
	build_type = PROTOLATHE
	materials = list(MAT_IRON = 600, MAT_COPPER = 100)
...
/datum/design/cpu
	...
	id = "cpu_normal"
	build_type = IMPRINTER
	materials = list(MAT_GLASS = 200, MAT_COPPER = 1600)
...
/datum/design/cpu/small
	...
	id = "cpu_small"
	build_type = IMPRINTER
	materials = list(MAT_GLASS = 100, MAT_COPPER = 800)
...
/datum/design/cpu/photonic
	...
	id = "pcpu_normal"
	build_type = IMPRINTER
	materials = list(MAT_GLASS= 6400, MAT_GOLD = 2000, MAT_COPPER = 800)
...
/datum/design/cpu/photonic/small
	...
	id = "pcpu_small"
	build_type = IMPRINTER
	materials = list(MAT_GLASS = 3200, MAT_GOLD = 1000, MAT_COPPER = 400)
