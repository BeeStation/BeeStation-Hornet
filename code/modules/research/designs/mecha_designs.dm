...
/datum/design/mech_scattershot
	...
	category = list(RND_CATEGORY_WEAPONS + RND_SUBCATEGORY_WEAPONS_EXOSUIT)
...
/datum/design/mech_disabler
	...
	materials = list(/datum/material/iron=10000)
	construction_time = 100
	category = list(RND_CATEGORY_EXOSUIT_EQUIPMENT + RND_SUBCATEGORY_MECHFAB_EQUIPMENT_WEAPONS)
...
/datum/design/mech_thrusters
	...
	construction_time = 100
	category = list(RND_CATEGORY_EXOSUIT_EQUIPMENT + RND_SUBCATEGORY_MECHFAB_EQUIPMENT_MODULES)
...
/datum/design/mech_sleeper
	...
	construction_time = 100
	category = list(RND_CATEGORY_EXOSUIT_EQUIPMENT + RND_SUBCATEGORY_MECHFAB_EQUIPMENT_MEDICAL)
