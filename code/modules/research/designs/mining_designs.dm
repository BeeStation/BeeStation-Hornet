...
/datum/design/drill_diamond
	...
	id = "drill_diamond"
	build_type = PROTOLATHE
	materials = list(MAT_IRON = 6000, MAT_GLASS = 1000, MAT_DIAMOND = 2000) //Yes, a whole diamond is needed.
...
/datum/design/plasmacutter
	...
	id = "plasmacutter"
	build_type = PROTOLATHE
	materials = list(MAT_IRON = 1500, MAT_GLASS = 500, MAT_PLASMA = 400)
...
/datum/design/plasmacutter_adv
	...
	id = "plasmacutter_adv"
	build_type = PROTOLATHE
	materials = list(MAT_IRON = 3000, MAT_GLASS = 1000, MAT_PLASMA = 2000, MAT_GOLD = 500)
...
/datum/design/jackhammer
	...
	id = "jackhammer"
	build_type = PROTOLATHE
	materials = list(MAT_IRON = 6000, MAT_GLASS = 2000, MAT_SILVER = 2000, MAT_DIAMOND = 6000)
...
/datum/design/superresonator
	...
	id = "superresonator"
	build_type = PROTOLATHE
	materials = list(MAT_IRON = 4000, MAT_GLASS = 1500, MAT_SILVER = 1000, MAT_URANIUM = 1000)
...
/datum/design/trigger_guard_mod
	...
	id = "triggermod"
	build_type = PROTOLATHE
	materials = list(MAT_IRON = 2000, MAT_GLASS = 1500, MAT_GOLD = 1500, MAT_URANIUM = 1000)
...
/datum/design/hyperaccelerator
	...
	id = "hypermod"
	build_type = PROTOLATHE | MECHFAB
	materials = list(MAT_IRON = 8000, MAT_GLASS = 1500, MAT_SILVER = 2000, MAT_GOLD = 2000, MAT_DIAMOND = 2000)
