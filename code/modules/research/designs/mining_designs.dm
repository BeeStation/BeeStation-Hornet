...
/datum/design/cargo_express
	...
	category = list(RND_CATEGORY_MINING_DESIGNS + RND_SUBCATEGORY_MINING_SUPPLY)
...
/datum/design/drill
	...
	category = list(RND_CATEGORY_MINING_DESIGNS + RND_SUBCATEGORY_MINING_TOOLS)
	departmental_flags = DEPARTMENTAL_FLAG_CARGO
...
/datum/design/trigger_guard_mod
	...
	category = list(RND_CATEGORY_MINING_DESIGNS + RND_SUBCATEGORY_MINING_KA_MODS)
	departmental_flags = DEPARTMENTAL_FLAG_CARGO
...
/datum/design/damage_mod
	...
	category = list(RND_CATEGORY_MINING_DESIGNS + RND_SUBCATEGORY_MINING_KA_MODS, RND_CATEGORY_CYBORG_UPGRADE_MODULES + RND_SUBCATEGORY_MECHFAB_CYBORG_MODULES_MINING)
	departmental_flags = DEPARTMENTAL_FLAG_CARGO
