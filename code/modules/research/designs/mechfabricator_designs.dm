...
/datum/design/ripley_torso
	...
	materials = list(MAT_IRON=20000, MAT_GLASS=7500)
	construction_time = 200
...
/datum/design/odysseus_head
	...
	materials = list(MAT_IRON=6000,MAT_GLASS=10000)
	construction_time = 100
	category = list("Odysseus")
...
/datum/design/gygax_torso
	...
	materials = list(MAT_IRON=20000,MAT_GLASS=10000,MAT_DIAMOND=2000)
...
/datum/design/gygax_left_arm
	...
	materials = list(MAT_IRON=15000, MAT_DIAMOND=1000)
	construction_time = 200
	category = list("Gygax")
...
/datum/design/gygax_left_leg
	...
	materials = list(MAT_IRON=15000, MAT_DIAMOND=2000)
	construction_time = 200
	category = list("Gygax")
...
/datum/design/gygax_armor
	...
	materials = list(MAT_IRON=15000,MAT_DIAMOND=10000,MAT_TITANIUM=10000)
...
/datum/design/durand_torso
	...
	materials = list(MAT_IRON=25000,MAT_GLASS=10000,MAT_SILVER=10000)
	construction_time = 300
	category = list("Durand")
...
/datum/design/durand_head
	...
	materials = list(MAT_IRON=10000,MAT_GLASS=15000,MAT_SILVER=2000)
	construction_time = 200
	category = list("Durand")
...
/datum/design/durand_left_arm
	...
	materials = list(MAT_IRON=10000,MAT_SILVER=4000)
	construction_time = 200
	category = list("Durand")
...
/datum/design/durand_left_leg
	...
	materials = list(MAT_IRON=15000,MAT_SILVER=4000)
	construction_time = 200
	category = list("Durand")
...
/datum/design/durand_armor
	...
	materials = list(MAT_IRON=30000,MAT_URANIUM=25000,MAT_TITANIUM=20000)
	construction_time = 600
	category = list("Durand")
...
/datum/design/honk_torso
	...
	materials = list(MAT_IRON=20000,MAT_GLASS=10000,MAT_BANANIUM=10000)
	construction_time = 300
	category = list("H.O.N.K")
...
/datum/design/honk_head
	...
	materials = list(MAT_IRON=10000,MAT_GLASS=5000,MAT_BANANIUM=5000)
	construction_time = 200
	category = list("H.O.N.K")
...
/datum/design/honk_left_arm
	...
	materials = list(MAT_IRON=15000,MAT_BANANIUM=5000)
	construction_time = 200
	category = list("H.O.N.K")
...
/datum/design/honk_left_leg
	...
	materials = list(MAT_IRON=20000,MAT_BANANIUM=5000)
	construction_time = 200
	category = list("H.O.N.K")
...
/datum/design/phazon_torso
	...
	materials = list(MAT_IRON=35000,MAT_GLASS=10000,MAT_PLASMA=20000)
	construction_time = 300
	category = list("Phazon")
...
/datum/design/phazon_armor
	...
	materials = list(MAT_IRON=25000,MAT_PLASMA=20000,MAT_TITANIUM=20000)
	construction_time = 300
	category = list("Phazon")
...
/datum/design/mech_generator
	...
	materials = list(MAT_IRON=10000,MAT_GLASS=1000,MAT_SILVER=2000,MAT_PLASMA=5000)
	construction_time = 100
	category = list("Exosuit Equipment")
...
/datum/design/mech_honker
	...
	materials = list(MAT_IRON=20000,MAT_BANANIUM=10000)
	construction_time = 500
	category = list("Exosuit Equipment")
...
/datum/design/mech_punching_glove
	...
	materials = list(MAT_IRON=20000,MAT_BANANIUM=7500)
...
/datum/design/borg_upgrade_thrusters
	...
	materials = list(MAT_IRON = 10000, MAT_GLASS = 6000, MAT_PLASMA = 5000, MAT_URANIUM = 6000)
	construction_time = 120
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_upgrade_disablercooler
	...
	materials = list(MAT_IRON = 20000 , MAT_GLASS = 6000, MAT_GOLD = 2000, MAT_DIAMOND = 2000)
	construction_time = 120
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_upgrade_diamonddrill
	...
	materials = list(MAT_IRON=10000, MAT_GLASS = 6000, MAT_DIAMOND = 2000)
	construction_time = 80
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_upgrade_holding
	...
	materials = list(MAT_IRON = 10000, MAT_GOLD = 2000, MAT_URANIUM = 1000)
...
/datum/design/borg_upgrade_lavaproof
	...
	materials = list(MAT_IRON = 10000, MAT_PLASMA = 4000, MAT_TITANIUM = 5000)
	construction_time = 120
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_syndicate_module
	...
	materials = list(MAT_IRON = 15000, MAT_GLASS = 15000, MAT_DIAMOND = 10000)
	construction_time = 120
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_transform_clown
	...
	materials = list(MAT_IRON = 15000, MAT_GLASS = 15000, MAT_BANANIUM = 1000)
	construction_time = 120
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_upgrade_selfrepair
	...
	materials = list(MAT_IRON = 15000, MAT_GLASS = 15000)
	construction_time = 80
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_upgrade_expandedsynthesiser
	...
	materials = list(MAT_IRON = 15000, MAT_GLASS = 15000, MAT_PLASMA = 8000, MAT_URANIUM = 8000)
	construction_time = 80
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_upgrade_piercinghypospray
	...
	materials = list(MAT_IRON = 15000, MAT_GLASS = 15000, MAT_TITANIUM = 5000, MAT_DIAMOND = 3000)
	construction_time = 80
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_upgrade_defibrillator
	...
	materials = list(MAT_IRON = 8000, MAT_GLASS = 5000, MAT_SILVER = 4000, MAT_GOLD = 3000)
	construction_time = 80
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_upgrade_surgicalprocessor
	...
	materials = list(MAT_IRON = 5000, MAT_GLASS = 4000, MAT_SILVER = 4000)
	construction_time = 40
	category = list("Cyborg Upgrade Modules")
...
/datum/design/borg_upgrade_expand
	...
	materials = list(MAT_IRON = 200000, MAT_TITANIUM = 5000)
	construction_time = 120
	category = list("Cyborg Upgrade Modules")
...
/datum/design/boris_ai_controller
	...
	materials = list(MAT_IRON = 1200, MAT_GLASS = 1500, MAT_GOLD = 200)
	construction_time = 50
	category = list("Misc")
...
/datum/design/mecha_tracking_ai_control
	...
	materials = list(MAT_IRON = 1000, MAT_GLASS = 500, MAT_SILVER = 200)
	construction_time = 50
	category = list("Misc")
