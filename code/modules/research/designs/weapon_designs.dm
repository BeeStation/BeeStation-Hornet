...
/datum/design/large_grenade
	...
	category = list("Weapons")
	departmental_flags = DEPARTMENTAL_FLAG_ARMORY | DEPARTMENTAL_FLAG_MEDICAL
...
/datum/design/mag_oldsmg/rubber
	...
	category = list("Ammo")
	departmental_flags = DEPARTMENTAL_FLAG_SECURITY | DEPARTMENTAL_FLAG_SECURITY
...
/datum/design/techshell
	...
	category = list("Ammo")
	departmental_flags = DEPARTMENTAL_FLAG_ARMORY | DEPARTMENTAL_FLAG_SCIENCE
