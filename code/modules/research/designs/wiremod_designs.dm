...
/datum/design/component/abs
	...
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_MATH_COMPONENTS)
...
/datum/design/component/bitflag
	...
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_MATH_COMPONENTS, RND_CATEGORY_LOGIC_COMPONENTS)

/datum/design/component/clock
	name = "Clock Component"
	id = "comp_clock"
	build_path = /obj/item/circuit_component/clock
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_TIME_COMPONENTS)

/datum/design/component/comparison
	name = "Comparison Component"
	id = "comp_comparison"
	build_path = /obj/item/circuit_component/compare/comparison
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_LOGIC_COMPONENTS)
...
/datum/design/component/index
	...
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_LIST_COMPONENTS)
...
/datum/design/component/length
	...
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_LIST_COMPONENTS, RND_CATEGORY_STRING_COMPONENTS)

/datum/design/component/trim
	name = "String Trim Component"
	id = "comp_trim"
	build_path = /obj/item/circuit_component/trim
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_STRING_COMPONENTS)

/datum/design/component/light
	name = "Light Component"
	id = "comp_light"
	build_path = /obj/item/circuit_component/light
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_OUTPUT_COMPONENTS)
...
/datum/design/component/species
	...
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_LOGIC_COMPONENTS, RND_CATEGORY_INPUT_COMPONENTS)
...
/datum/design/component/tostring
	...
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_STRING_COMPONENTS, RND_CATEGORY_CONVERSION_COMPONENTS)
...
/datum/design/component/hear
	...
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_INPUT_COMPONENTS)
...
/datum/design/component/self
	...
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_REFERENCE_COMPONENTS)
...
/datum/design/component/gate/toggle
	...
	id = "comp_gate_toggle"
	build_path = /obj/item/circuit_component/gate/toggle
	category = list(RND_CATEGORY_CIRCUITRY, RND_CATEGORY_GATE_COMPONENTS)
