...
/datum/design/board/onehuman_module
	...
	id = "onehuman_module"
	materials = list(MAT_GLASS = 1000, MAT_DIAMOND = 6000, MAT_COPPER = 300)
...
/datum/design/board/freeform_module
	...
	id = "freeform_module"
	materials = list(MAT_GLASS = 1000, MAT_GOLD = 10000, MAT_COPPER = 300)//Custom inputs should be more expensive to get
...
/datum/design/board/purge_module
	...
	id = "purge_module"
	materials = list(MAT_GLASS = 1000, MAT_DIAMOND = 2000, MAT_COPPER = 300)
...
/datum/design/board/freeformcore_module
	...
	materials = list(MAT_GLASS = 1000, MAT_DIAMOND = 10000, MAT_COPPER = 300)//Ditto
