...
/obj/item/slimepotion/slime/sentience/attack(mob/living/M, mob/user)
	...
	var/list/candidates = pollCandidatesForMob("Do you want to play as [SM.name]? (Sentience Potion)", BAN_ROLE_SENTIENCE, null, 50, SM, POLL_IGNORE_SENTIENCE_POTION) // see poll_ignore.dm
