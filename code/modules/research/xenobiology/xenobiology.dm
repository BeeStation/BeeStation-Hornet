...
/obj/item/slimepotion/slime/sentience/attack(mob/living/M, mob/user)
	...
	var/list/candidates = pollCandidatesForMob("Do you want to play as [SM.name]? (Sentience Potion)", ROLE_KEY_SENTIENT, null, ROLE_KEY_SENTIENT, 50, SM, POLL_IGNORE_SENTIENCE_POTION) // see poll_ignore.dm
...
/obj/item/slimepotion/transference/afterattack(mob/living/M, mob/user)
	...
	if(SM.sentience_type != animal_type)
		...
		return ..()
	var/jb = is_banned_from(user.ckey, BANCHECK_BEHAVIOR_MIND_TRANSFER)
