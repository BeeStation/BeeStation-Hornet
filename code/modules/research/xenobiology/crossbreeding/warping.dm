...
/obj/effect/warped_rune/blackspace/do_effect(mob/user)
	for(var/mob/living/carbon/human/host in rune_turf)
		...
		var/list/candidates = pollCandidatesForMob("Do you want to replace the soul of [host.name]?", BAN_ROLE_SENTIENCE, null, null, 50, host, POLL_IGNORE_SHADE)//todo: fix desc
