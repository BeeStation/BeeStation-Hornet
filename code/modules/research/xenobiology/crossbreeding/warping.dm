...
/obj/effect/warped_rune/blackspace/do_effect(mob/user)
	for(var/mob/living/carbon/human/host in rune_turf)
		...
		var/list/candidates = pollCandidatesForMob("Do you want to replace the soul of [host.name]?", ROLE_KEY_SENTIENT, null, ROLE_KEY_SENTIENT, 50, host, POLL_IGNORE_BLODCULT_OVERALL)//todo: fix desc
