...
/obj/item/slimepotion/peacepotion/attack(mob/living/peace_target, mob/user)
	...
	if(peace_target != user)
		peace_target.visible_message(span_danger("[user] starts to feed [peace_target] a pacification potion!"),
...
/obj/item/slimepotion/lovepotion/attack(mob/living/love_target, mob/user)
	...
	to_chat(love_target, span_notice("You develop feelings for [user], and anyone [user.p_they()] like."))
