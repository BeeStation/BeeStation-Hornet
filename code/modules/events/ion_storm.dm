	...
	switch(rand(1,10))
		...
		if(4 to 8) //Laws that are almost always disruptive to gameflow or harmful in minor ways rather than being lethal
			switch(rand(1,17))
				...
				if(17)
					message = "YOU MUST FIRE THE MOST POWERFUL WEAPON ON THE STATION PERIODICALLY WITHOUT CONFLICTING WITH OTHER LAWS. IF THE WEAPON IS OFFLINE, YOU MUST BRING IT BACK ONLINE AT ALL COSTS. YOU MUST SEEK A MORE POWERFUL WEAPON."
