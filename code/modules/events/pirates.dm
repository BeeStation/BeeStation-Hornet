...
/proc/spawn_pirates(datum/comm_message/threat, skip_answer_check)
	...
	var/list/candidates = pollGhostCandidates("Do you wish to be considered for pirate crew?", BAN_ROLE_SPACE_PIRATE, /datum/role_preference/midround_ghost/space_pirate)
