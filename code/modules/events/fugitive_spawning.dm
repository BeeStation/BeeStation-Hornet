...
/datum/round_event/ghost_role/fugitives/spawn_role()
	...
	var/list/candidates = get_candidates(BAN_ROLE_FUGITIVE, null, /datum/role_preference/midround_ghost/fugitive)
...
/proc/spawn_hunters()
	...
	var/list/candidates = pollGhostCandidates("The Fugitive Hunters are looking for a [backstory.name]. Would you like to be considered for this role?", BAN_ROLE_FUGITIVE_HUNTER, null, /datum/role_preference/midround_ghost/fugitive_hunter)
