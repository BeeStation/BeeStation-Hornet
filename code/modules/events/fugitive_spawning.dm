...
/proc/announce_fugitive_spawns(datum/map_template/shuttle/ship, list/candidates, datum/fugitive_type/hunter/backstory, datum/mapGenerator/mapGenerator, turf/T)	var/list/spawners = list()
