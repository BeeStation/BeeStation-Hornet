/datum/round_event_control/spawn_special_antagonist
	...
	var/protected_jobs = list(JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_DETECTIVE, JOB_HEAD_OF_SECURITY, JOB_HEAD_OF_PERSONNEL, JOB_CHIEF_MEDICAL_OFFICER, JOB_CHIEF_ENGINEER, JOB_RESEARCH_DIRECTOR, JOB_CAPTAIN)
