...
/datum/round_event/wizard/deprevolt/start()
	...
	switch(tidecolor)
		...
		if("white")
			jobs_to_revolt = list(JOB_NAME_CHIEFMEDICALOFFICER, JOB_NAME_MEDICALDOCTOR, JOB_NAME_SURGEON, JOB_NAME_CHEMIST, JOB_NAME_GENETICIST, JOB_NAME_PARAMEDIC)
			nation_name = pick("Mede", "Healtha", "Recova", "Chemi", "Geneti", "Psych", "Surgi")
		if("yellow")
