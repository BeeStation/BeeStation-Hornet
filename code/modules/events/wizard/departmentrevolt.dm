/datum/round_event_control/wizard/deprevolt //stationwide!
	...
	var/datum/department_group/picked_department
...
/datum/round_event_control/wizard/deprevolt/admin_setup(mob/admin)
	...
	var/list/pickable_departments = subtypesof(/datum/department_group)
	for(var/datum/department_group/dep as anything in pickable_departments)
