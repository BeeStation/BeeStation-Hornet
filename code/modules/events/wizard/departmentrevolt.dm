...
/datum/round_event/wizard/deprevolt/start()
	...
	switch(tidecolor)
		...
		if("yellow")
			jobs_to_revolt = list(JOB_NAME_CHIEFENGINEER, JOB_NAME_TATIONENGINEER, JOB_NAME_ATMOSPHERICTECHNICIAN)
		...
		if("brown")
			jobs_to_revolt = list(JOB_NAME_QUARTERMASTER, JOB_NAME_CARGOTECHNICIAN, JOB_SHAFT_MINER)
