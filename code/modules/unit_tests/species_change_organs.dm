...
/datum/unit_test/species_change_organs/Run()
	...
	var/obj/item/organ/appendix/existing_appendix = dummy.getorganslot(ORGAN_SLOT_APPENDIX)
	...
	var/obj/item/organ/appendix/lizard_appendix = dummy.getorganslot(ORGAN_SLOT_APPENDIX)
