...
/datum/unit_test/mind_swap_spell/Run()
	...
	var/mob/living/carbon/human/consistent/swapper = allocate(/mob/living/carbon/human/consistent)
	var/mob/living/carbon/human/consistent/to_swap = allocate(/mob/living/carbon/human/consistent)
