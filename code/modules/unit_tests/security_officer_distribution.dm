...
/datum/unit_test/security_officer_roundstart_distribution/proc/test_with_mock_players()
	var/mob/dead/new_player/authenticated/officer_a = create_officer("a")
	var/mob/dead/new_player/authenticated/officer_b = create_officer("b")
	var/mob/dead/new_player/authenticated/officer_c = create_officer("c")
	var/mob/dead/new_player/authenticated/officer_d = create_officer("d")
