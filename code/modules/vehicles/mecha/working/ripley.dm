...
/obj/vehicle/sealed/mecha/working/ripley/mob_exit(mob/M, silent, forced, randomstep)
	..()
	update_icon()
...
/obj/vehicle/sealed/mecha/working/ripley/update_icon()
	..()
...
/obj/vehicle/sealed/mecha/working/ripley/firefighter
	desc = "II. This model is refitted with a pressurized cabin and additional hazard protection."
