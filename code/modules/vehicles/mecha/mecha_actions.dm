...
/datum/action/vehicle/sealed/mecha/mech_toggle_cabin_seal/on_activate(trigger_flags)
...
/datum/action/vehicle/sealed/mecha/mech_overclock/on_activate(trigger_flags, forced_state = null)
	if(!owner || !chassis || !(owner in chassis.occupants))
		return
