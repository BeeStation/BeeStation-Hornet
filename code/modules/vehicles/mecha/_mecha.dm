...
/**
  ...
  *
  * Clicks are either translated into mech_melee_attack (see mech_melee_attack.dm)
...
/obj/vehicle/sealed/mecha
	...
	var/phasing = FALSE
	///Power we use every time we phase through something
...
/obj/vehicle/seated/mecha/on_emag(mob/user)
	..()
...
//why the fuck is this in mecha why just why
