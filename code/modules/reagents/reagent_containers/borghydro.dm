...
/obj/item/reagent_containers/borghypo/attack(mob/living/carbon/M, mob/user)
	...
	if(!istype(M))
		return
	if(R.total_volume && M.can_inject(user, 1, user.zone_selected,bypass_protection) && do_mob(user, M, 0.5 SECONDS))
...
/obj/item/reagent_containers/borghypo/borgshaker/hacked
	...
	reagent_ids = list(/datum/reagent/consumable/ethanol/fernet, /datum/reagent/consumable/ethanol/bastion_bourbon, /datum/reagent/toxin/zombiepowder, /datum/reagent/smoke_powder/ez, /datum/reagent/smoke_powder_activator)
...
/obj/item/reagent_containers/borghypo/peace/hacked
	...
	icon_state = "borghypo_s"
	reagent_ids = list(/datum/reagent/peaceborg/inabizine,/datum/reagent/peaceborg/tire,/datum/reagent/pax/peaceborg,/datum/reagent/toxin/staminatoxin,/datum/reagent/toxin/sulfonal,/datum/reagent/toxin/sodium_thiopental,/datum/reagent/toxin/fentanyl)
	accepts_reagent_upgrades = FALSE
