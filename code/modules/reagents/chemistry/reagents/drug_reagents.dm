...
/datum/reagent/drug/krokodil/addiction_act_stage4(mob/living/carbon/human/M)
	...
	if(ishumanbasic(M))) // probably not the best way to do it but until we get a krokodil_addict variant for every race only humans/felinds should be transformed
		...
		to_chat(M, "<span class='userdanger'>Your skin peels and tears!</span>")
		M.adjustBruteLoss(10*REM, 0) // repeats 5 times and then you get over it
