...
/datum/reagent/drug/methamphetamine/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
	if(DT_PROB(2.5, delta_time))
		to_chat(M, span_notice(pick("You feel hyper.", "You feel like you need to go faster.", "You feel like you can run the world.")))
...
/datum/reagent/drug/bath_salts/on_mob_life(mob/living/carbon/M, delta_time, times_fired)
	if(DT_PROB(2.5, delta_time))
		to_chat(M, span_notice(pick("You feel amped up.", "You feel ready.", "You feel like you can push it to the limit.")))
