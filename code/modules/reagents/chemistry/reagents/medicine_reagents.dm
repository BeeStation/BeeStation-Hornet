...
/datum/reagent/medicine/probital
	name = "Probital"
...
/datum/reagent/medicine/probital/on_mob_life(mob/living/carbon/M)
	M.adjustBruteLoss(-1.5*REM, 0.) // heals 3 brute & 0.5 burn if taken with food. compared to 2.5 brute from bicard + nutriment
	..()
	. = 1

/datum/reagent/medicine/probital/overdose_process(mob/living/M)
	M.adjustBruteLoss(3*REM, 0)
	..()
	. = 1

/datum/reagent/medicine/probital/on_transfer(atom/A, method=INGEST, trans_volume)
	if(method != INGEST || !iscarbon(A))
		return

	A.reagents.remove_reagent(/datum/reagent/medicine/probital, trans_volume * 0.05)
...
/datum/reagent/medicine/hercuri
	name = "Hercuri"
...
/datum/reagent/medicine/hercuri/on_mob_life(mob/living/carbon/M)
	M.adjustFireLoss(-2*REM, 0.)
	M.adjust_bodytemperature(-20 * TEMPERATURE_DAMAGE_COEFFICIENT, BODYTEMP_NORMAL)
	..()
	. = 1

/datum/reagent/medicine/hercuri/reaction_mob(mob/living/carbon/M, method=VAPOR, reac_volume)
	if(method != VAPOR)
		return
...
/datum/reagent/medicine/hercuri/overdose_process(mob/living/carbon/M)
	M.adjustFireLoss(3*REM, 0.)
	M.adjust_bodytemperature(-35 * TEMPERATURE_DAMAGE_COEFFICIENT, 50)
	..()

/datum/reagent/medicine/syriniver
	name = "Syriniver"
...
/datum/reagent/medicine/syriniver/on_transfer(atom/A, method=INJECT, trans_volume)
...
/datum/reagent/medicine/syriniver/on_mob_life(mob/living/carbon/M)
...
/datum/reagent/medicine/syriniver/overdose_process(mob/living/carbon/M)
	M.adjustLiverLoss(1.5)
	M.adjust_disgust(3)
	M.reagents.add_reagent(/datum/reagent/medicine/musiver, 0.225 * REM)
	..()
	. = 1
...
/datum/reagent/medicine/musiver/on_mob_life(mob/living/carbon/M)
...
/datum/reagent/medicine/musiver/overdose_start(mob/living/carbon/M)
	U = new()
	M.gain_trauma(U, TRAUMA_RESILIENCE_ABSOLUTE)
	..()

/datum/reagent/medicine/musiver/on_mob_delete(mob/living/carbon/M)
	if(U)
		QDEL_NULL(U)
	return ..()

/datum/reagent/medicine/musiver/overdose_process(mob/living/carbon/M)
	M.adjustLiverLoss(1.5)
	M.adjust_disgust(3)
	..()
	. = 1
