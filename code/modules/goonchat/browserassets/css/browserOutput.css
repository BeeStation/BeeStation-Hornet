...
/* ADD HERE FOR BOLD */
.bold, .name, .prefix, .ooc, .dooc, .looc, .adminooc, .admin, .medal, .yell {font-weight: bold;}
...
.dooc					{color: #d543e9;	font-weight: bold;}
.looc 					{color: #ffde5c;	font-weight: bold;}
.adminobserverooc		{color: #0099cc;	font-weight: bold;}
.adminooc				{color: #3d5bc3;	font-weight: bold;}

.adminsay   			{color: #b6c653}
.admin					{color: #243fa3;	font-weight: bold;}

.mentorfrom 			{color: #d34bd8;}
.mentorto				{color: #4bd84b;}
.mentorhelp				{color: #8f66ff;}

.name					{					font-weight: bold;}

.say					{}
.deadsay				{color: #b866ff}
...
.medradio				{color: #33ccff;}
.engradio				{color: #f37746;}
.suppradio				{color: #b88646;}
.servradio				{color: #4e7a1f}
...
.ratvar					{color: #BE8700; font-size: 48px; font-weight: bold; font-style: italic; animation: ratvarcolor 5000ms infinite;}
.alloy					{color: #42474D;}
