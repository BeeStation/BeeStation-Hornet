...
/datum/uplink_item/role_restricted/ancient_jumpsuit
	...
	cost = 20
	restricted_roles = list(JOB_KEY_ASSISTANT)
	surplus = 1
...
/datum/uplink_item/role_restricted/pie_cannon
	...
	cost = 11
	item = /obj/item/pneumatic_cannon/pie/selfcharge
	restricted_roles = list(JOB_KEY_CLOWN)
...
/datum/uplink_item/role_restricted/blastcannon
	...
	restricted_roles = list(JOB_KEY_RESEARCHDIRECTOR, JOB_KEY_SCIENTIST)
...
/datum/uplink_item/role_restricted/crushmagboots
	...
	restricted_roles = list(JOB_KEY_CHIEFENGINEER, JOB_KEY_STATIONENGINEER, JOB_KEY_ATMOSPHERICTECHNICIAN)
...
/datum/uplink_item/role_restricted/gorillacubes
	...
	cost = 6
	restricted_roles = list(JOB_KEY_GENETICIST, JOB_KEY_CHIEFMEDICALOFFICER)
...
/datum/uplink_item/role_restricted/rad_laser
	...
	restricted_roles = list(JOB_KEY_MEDICALDOCTOR, JOB_KEY_CHIEFMEDICALOFFICER, JOB_KEY_ROBOTICIST, JOB_KEY_PARAMEDIC, JOB_KEY_BRIGPHYSICIAN)
	cost = 3
...
/datum/uplink_item/role_restricted/syndicate_mmi
	...
	restricted_roles = list(JOB_KEY_ROBOTICIST, JOB_KEY_RESEARCHDIRECTOR)
	cost = 2
...
/datum/uplink_item/role_restricted/upgrade_wand
	...
	restricted_roles = list(JOB_KEY_STAGEMAGICIAN)
	cost = 5
...
/datum/uplink_item/role_restricted/spider_injector
	...
	cost = 10
	restricted_roles = list(JOB_KEY_RESEARCHDIRECTOR, JOB_KEY_SCIENTIST, JOB_KEY_ROBOTICIST)
...
/datum/uplink_item/role_restricted/superior_honkrender
	...
	cost = 8
	restricted = TRUE
	restricted_roles = list(JOB_KEY_CLOWN, JOB_KEY_CHAPLAIN)
...
/datum/uplink_item/role_restricted/haunted_magic_eightball
	...
	cost = 2
	restricted_roles = list(JOB_KEY_CURATOR)
...
/datum/uplink_item/role_restricted/voodoo
	...
	cost = 12
	restricted_roles = list(JOB_KEY_CURATOR, JOB_KEY_STAGEMAGICIAN)
...
/datum/uplink_item/role_restricted/his_grace
	...
	cost = 20
	restricted_roles = list(JOB_KEY_CHAPLAIN)
	murderbone_type = TRUE
	surplus = 0
...
/datum/uplink_item/role_restricted/spanish_flu
	...
	cost = 14
	restricted_roles = list(JOB_KEY_CHAPLAIN, JOB_KEY_VIROLOGIST)
...
/datum/uplink_item/role_restricted/retrovirus
	...
	cost = 14
	restricted_roles = list(JOB_KEY_VIROLOGIST, JOB_KEY_GENETICIST)
...
/datum/uplink_item/role_restricted/random_disease
	...
	cost = 5
	restricted_roles = list(JOB_KEY_VIROLOGIST)
	surplus = 20
...
/datum/uplink_item/role_restricted/explosive_hot_potato
	...
	cost = 3
	surplus = 0
	restricted_roles = list(JOB_KEY_COOK, JOB_KEY_BOTANIST, JOB_KEY_CLOWN, JOB_KEY_MIME)
...
/datum/uplink_item/role_restricted/echainsaw
	...
	cost = 10
	player_minimum = 25
	restricted_roles = list(JOB_KEY_BOTANIST, JOB_KEY_COOK, JOB_KEY_BARTENDER)
...
/datum/uplink_item/role_restricted/holocarp
	...
	player_minimum = 25
	restricted = TRUE
	restricted_roles = list(JOB_KEY_COOK, JOB_KEY_CHAPLAIN)
...
/datum/uplink_item/role_restricted/ez_clean_bundle
	...
	cost = 6
	surplus = 20
	restricted_roles = list(JOB_KEY_JANITOR)
...
/datum/uplink_item/role_restricted/mimery
	...
	restricted_roles = list(JOB_KEY_MIME)
	surplus = 0
...
/datum/uplink_item/role_restricted/pressure_mod
	...
	restricted_roles = list(JOB_KEY_SHAFTMINER)
...
/datum/uplink_item/role_restricted/esaw_arm
	...
	restricted_roles = list(JOB_KEY_MEDICALDOCTOR, JOB_KEY_CHIEFMEDICALOFFICER, JOB_KEY_PARAMEDIC, JOB_KEY_BRIGPHYSICIAN)
...
/datum/uplink_item/role_restricted/chemical_gun
	...
	cost = 12
	restricted_roles = list(JOB_KEY_CHEMIST, JOB_KEY_CHIEFMEDICALOFFICER)
