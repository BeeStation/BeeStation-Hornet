...
/datum/uplink_item/role_restricted/gorillacubes
	...
	cost = 6
	restricted_roles = list(JOB_GENETICIST, JOB_CHIEF_MEDICAL_OFFICER)
...
/datum/uplink_item/role_restricted/rad_laser
	...
	restricted_roles = list(JOB_MEDICAL_DOCTOR, JOB_CHIEF_MEDICAL_OFFICER, JOB_ROBOTICIST, JOB_PARAMEDIC, JOB_BRIGPHYSICIAN)
	cost = 3
...
/datum/uplink_item/role_restricted/upgrade_wand
	...
	restricted_roles = list(JOB_STAGE_MAGICIAN)
	cost = 5
...
/datum/uplink_item/role_restricted/superior_honkrender
	...
	cost = 8
	restricted = TRUE
	restricted_roles = list(JOB_CLOWN, JOB_CHAPLAIN)
...
/datum/uplink_item/role_restricted/voodoo
	...
	cost = 12
	restricted_roles = list(JOB_CURATOR, JOB_STAGE_MAGICIAN)
...
/datum/uplink_item/role_restricted/spanish_flu
	...
	cost = 14
	restricted_roles = list(JOB_CHAPLAIN, JOB_VIROLOGIST)
...
/datum/uplink_item/role_restricted/retrovirus
	...
	cost = 14
	restricted_roles = list(JOB_VIROLOGIST, JOB_GENETICIST)
...
/datum/uplink_item/role_restricted/echainsaw
	...
	cost = 10
	player_minimum = 25
	restricted_roles = list(JOB_BOTANIST, JOB_COOK, JOB_BARTENDER)
...
/datum/uplink_item/role_restricted/holocarp
	...
	player_minimum = 25
	restricted = TRUE
	restricted_roles = list(JOB_COOK, JOB_CHAPLAIN)
...
/datum/uplink_item/role_restricted/esaw_arm
	...
	restricted_roles = list(JOB_MEDICAL_DOCTOR, JOB_CHIEF_MEDICAL_OFFICER, JOB_PARAMEDIC, JOB_BRIGPHYSICIAN)
