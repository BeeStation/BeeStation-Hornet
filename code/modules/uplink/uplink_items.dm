...
/datum/uplink_item/bundles_TC/OldWar
	name = "The Old War bundle."
	desc = "That doesn't mean The Syndicate is low on budget. For those who is tired of modern weaponry and prefers really old guns: \
			Contains one of five possible kits of equipment that was used by units in one of the wars in the past. Each kit is unique \
			to each other."
	item = /obj/item/storage/box/syndicate/OldWar
	cost = 30
	include_modes = list(/datum/game_mode/nuclear)
