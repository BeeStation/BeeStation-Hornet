...
/datum/uplink_item/explosives/syndicate_bomb
	name = "Syndicate Bomb"
	desc = "The Syndicate bomb is a fearsome device capable of massive destruction. The timer is adjustable, but the \
			payload requires 10 minutes before it reaches full strength, though the explosion will still be large regardless. \
			It can be bolted to the floor with a wrench to prevent movement. The bomb is bulky and cannot be moved; \
			upon ordering this item, a smaller beacon will be \
			transported to you that will teleport the actual bomb to it upon activation. Note that this bomb can \
			be defused, and some crew may attempt to do so. \
