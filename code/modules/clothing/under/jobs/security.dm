...
/obj/item/clothing/under/rank/security
	...
	armor = list(MELEE = 10,  BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 10, RAD = 0, FIRE = 30, ACID = 30, STAMINA = 10, WOUND = 10)
	strip_delay = 50
...
/obj/item/clothing/under/rank/security/officer
	...
	item_state = "r_suit"
	armor = list(MELEE = 10,  BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, RAD = 0, FIRE = 30, ACID = 30, STAMINA = 10, BLEED = 10, WOUND = 10)
...
/obj/item/clothing/under/rank/security/head_of_security
	...
	icon_state = "rhos"
	item_state = "r_suit"
	armor = list(MELEE = 10,  BULLET = 0, LASER = 0, ENERGY = 0, BOMB = 0, BIO = 0, RAD = 0, FIRE = 50, ACID = 50, STAMINA = 10, BLEED = 10, WOUND = 10)
	strip_delay = 60
	alt_covers_chest = TRUE
	sensor_mode = SENSOR_COORDS
	random_sensor = FALSE
