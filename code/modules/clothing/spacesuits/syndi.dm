...
/obj/item/clothing/head/helmet/space/syndicate/contract
	...
	desc = "A specialised black and gold helmet that's more compact than its standard Pizza Hut counterpart. Can be ultra-compressed into even the tightest of spaces."
	slowdown = 0.55
...
/obj/item/clothing/suit/space/syndicate/contract
	...
	desc = "A specialised black and gold space suit that's quicker, and more compact than its standard Pizza Hut counterpart. Can be ultra-compressed into even the tightest of spaces."
	slowdown = 0.55
	w_class = WEIGHT_CLASS_SMALL
