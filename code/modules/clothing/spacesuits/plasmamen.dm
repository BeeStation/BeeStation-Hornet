...
/obj/item/clothing/suit/space/eva/leanman
	name = "EVA lean envirosuit"
	desc = "A special lean containment suit designed to be space-worthy, as well as worn over other clothing. Like its smaller counterpart, it can automatically extinguish the wearer in a crisis, and holds twice as many charges."
	...
	icon_state = "leanman_suit"
	item_state = "leanman_suit"
	var/next_extinguish = 0
	var/extinguish_cooldown = 100
	var/extinguishes_left = 10


/obj/item/clothing/suit/space/eva/leanman/examine(mob/user)
	. = ..()
	. += "<span class='notice'>There [extinguishes_left == 1 ? "is" : "are"] [extinguishes_left] extinguisher charge\s left in this suit.</span>"


/obj/item/clothing/suit/space/eva/leanman/proc/Extinguish(mob/living/carbon/human/H)
	if(!istype(H))
		return
...
/obj/item/clothing/head/helmet/space/leanman
	...
	actions_types = list(/datum/action/item_action/toggle_helmet_light, /datum/action/item_action/toggle_welding_screen/leanman)
	visor_vars_to_toggle = VISOR_FLASHPROTECT | VISOR_TINT
	flags_inv = HIDEMASK|HIDEEARS|HIDEEYES|HIDEFACE|HIDEHAIR|HIDEFACIALHAIR
	flags_cover = HEADCOVERSMOUTH|HEADCOVERSEYES
	visor_flags_inv = HIDEEYES|HIDEFACE|HIDEFACIALHAIR

/obj/item/clothing/head/helmet/space/leanman/Initialize(mapload)
	. = ..()
	visor_toggling()
	remove_verb(/obj/item/clothing/head/helmet/space/leanman/verb/unattach_hat)

/obj/item/clothing/head/helmet/space/leanman/Destroy()
	if (attached_hat)
...
/obj/item/clothing/head/helmet/space/leanman/AltClick(mob/user)
	if(user.canUseTopic(src, BE_CLOSE))
		toggle_welding_screen(user)

/obj/item/clothing/head/helmet/space/leanman/examine(mob/user)
	. = ..()
	if(attached_hat)
...
/obj/item/clothing/head/helmet/space/leanman/proc/toggle_welding_screen(mob/living/user)
...
/obj/item/clothing/head/helmet/space/leanman/update_icon()
	cut_overlays()
	if(!up)
		add_overlay(visor_icon)
	..()

/obj/item/clothing/head/helmet/space/leanman/attackby(obj/item/item, mob/living/user)
	. = ..()
	if(istype(item, /obj/item/toy/crayon))
		if(smile)
			...
			if(do_after(user, 25, target = src))
				...
				update_icon()
		return
	if(istype(item, /obj/item/clothing/head) && !istype(item, /obj/item/clothing/head/helmet/space/leanman)) // i know someone is gonna do it after i thought about it
		...
		hat.forceMove(src)
		update_icon()
		add_verb(/obj/item/clothing/head/helmet/space/leanman/verb/unattach_hat)

/obj/item/clothing/head/helmet/space/leanman/worn_overlays(mutable_appearance/standing, isinhands)
	. = ..()
	if(!isinhands)
		if(smile)
...
/obj/item/clothing/head/helmet/space/leanman/verb/unattach_hat()
	set name = "Remove Hat"
	set category = "Object"
	set src in usr
...
/obj/item/clothing/head/helmet/space/leanman/ComponentInitialize()
	. = ..()
...
/obj/item/clothing/head/helmet/space/leanman/proc/wipe_that_smile_off_your_face()
	SIGNAL_HANDLER
...
/obj/item/clothing/head/helmet/space/leanman/attack_self(mob/user)
	helmet_on = !helmet_on
...
/obj/item/clothing/head/helmet/space/leanman/security
	name = "security envirosuit helmet"
	desc = "A leanman containment helmet designed for security officers, protecting them from burning alive, along-side other undesirables."
...
/obj/item/clothing/head/helmet/space/leanman/security/warden
	name = "warden's envirosuit helmet"
	desc = "A leanman containment helmet designed for the warden, a pair of white stripes being added to differentiate them from other members of security."
	icon_state = "warden_envirohelm"
	item_state = "warden_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/medical
	name = "medical's envirosuit helmet"
	desc = "An envirohelmet designed for leanman medical doctors, having two stripes down it's length to denote as much"
	icon_state = "doctor_envirohelm"
	item_state = "doctor_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/genetics
	name = "geneticist's envirosuit helmet"
	desc = "A leanman envirohelmet designed for geneticists."
	icon_state = "geneticist_envirohelm"
	item_state = "geneticist_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/viro
...
/obj/item/clothing/head/helmet/space/leanman/chemist
	name = "chemistry envirosuit helmet"
	desc = "A leanman envirosuit designed for chemists, two orange stripes going down it's face."
	icon_state = "chemist_envirohelm"
	item_state = "chemist_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/emt
	name = "paramedic envirosuit helmet"
	desc = "An envirosuit helmet only for the bravest medical leanman."
	icon_state = "emt_envirohelm"
	item_state = "emt_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/security/secmed
...
/obj/item/clothing/head/helmet/space/leanman/science
	name = "science envirosuit helmet"
	desc = "A leanman envirohelmet designed for scientists."
	icon_state = "scientist_envirohelm"
	item_state = "scientist_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/robotics
	name = "robotics envirosuit helmet"
	desc = "A leanman envirohelmet designed for roboticists."
	icon_state = "roboticist_envirohelm"
	item_state = "roboticist_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/engineering
	name = "engineering envirosuit helmet"
	desc = "A space-worthy helmet specially designed for engineer leanmen, the usual purple stripes being replaced by engineering's orange."
	icon_state = "engineer_envirohelm"
	item_state = "engineer_envirohelm"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 100, "rad" = 10, "fire" = 100, "acid" = 75, "stamina" = 0)

/obj/item/clothing/head/helmet/space/leanman/engineering/atmospherics
	name = "atmospherics envirosuit helmet"
	desc = "A space-worthy helmet specially designed for atmos technician leanmen, the usual purple stripes being replaced by engineering's blue."
	icon_state = "atmos_envirohelm"
	item_state = "atmos_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/cargo
	name = "cargo envirosuit helmet"
	desc = "An leanman envirohelmet designed for cargo techs and quartermasters."
	icon_state = "cargo_envirohelm"
	item_state = "cargo_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/mining
	name = "mining envirosuit helmet"
	desc = "A khaki helmet given to leanmen miners operating on lavaland."
	icon_state = "explorer_envirohelm"
	item_state = "explorer_envirohelm"
	visor_icon = "explorer_envisor"

/obj/item/clothing/head/helmet/space/leanman/chaplain
	name = "chaplain's envirosuit helmet"
	desc = "An envirohelmet specially designed for only the most pious of leanmen."
	icon_state = "chap_envirohelm"
	item_state = "chap_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/white
	name = "white envirosuit helmet"
	desc = "A generic white envirohelm."
	icon_state = "white_envirohelm"
	item_state = "white_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/hat
...
/obj/item/clothing/head/helmet/space/leanman/gold
...
/obj/item/clothing/head/helmet/space/leanman/curator
	name = "curator's envirosuit helmet"
	desc = "A slight modification on a tradiational voidsuit helmet, this helmet was Nano-Trasen's first solution to the *logistical problems* that come with employing leanmen. Despite their limitations, these helmets still see use by historian and old-styled leanmen alike."
	icon_state = "prototype_envirohelm"
	item_state = "prototype_envirohelm"
	actions_types = list(/datum/action/item_action/toggle_welding_screen/leanman)
	smile_state = "prototype_smile"
	visor_icon = "prototype_envisor"

/obj/item/clothing/head/helmet/space/leanman/botany
...
/obj/item/clothing/head/helmet/space/leanman/janitor
...
/obj/item/clothing/head/helmet/space/leanman/exploration
	name = "exploration envirosuit helmet"
	desc = "A leanman envirohelmet designed for the exploration crew, decked out in their iconic garish turquiose."
	icon_state = "exploration_envirohelm"
	item_state = "exploration_envirohelm"
	visor_icon = "explorer_envisor"

//mime and clown
/obj/item/clothing/head/helmet/space/leanman/mime
...
/obj/item/clothing/head/helmet/space/leanman/honk
...
//command helms
/obj/item/clothing/head/helmet/space/leanman/command
...
/obj/item/clothing/head/helmet/space/leanman/engineering/ce
	name = "chief engineer's envirohelmet"
	desc = "An envirohelmet designed for the Chief Engineer. It reeks of Poly and lean."
	icon_state = "ce_envirohelm"
	item_state = "ce_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/cmo
...
/obj/item/clothing/head/helmet/space/leanman/security/hos
...
/obj/item/clothing/head/helmet/space/leanman/rd
...
/obj/item/clothing/head/helmet/space/leanman/hop
...
//centcom envirohelms
/obj/item/clothing/head/helmet/space/leanman/commander
	name = "CentCom commander envirosuit helmet"
	desc = "A special containment helmet designed for the Higher Central Command Staff. Not many of these exist, as CentCom does not usually employ leanmen to higher staff positions due to their complications."
	icon_state = "commander_envirohelm"
	item_state = "commander_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/official
...
/obj/item/clothing/head/helmet/space/leanman/intern
...
/obj/item/clothing/head/helmet/space/leanman/replacement/equipped(mob/living/carbon/user, slot)
	..()
	if(slot == ITEM_SLOT_HEAD && !isleanman(user))
		user.dropItemToGround(src)
		to_chat(user, "<span class='danger'>[src] doesn't fit on your head and falls to the ground.</span>")

//replacements for vendors
/obj/item/clothing/head/helmet/space/leanman/replacement
	name = "replacement envirosuit helmet"
	desc = "An outdated helmet that allows lean-based lifeforms to exist safely in an oxygenated environment, still kept in use as replacement helmets."

/obj/item/clothing/head/helmet/space/leanman/replacement/security
...
/obj/item/clothing/head/helmet/space/leanman/replacement/medical
	name = "medical replacement envirosuit helmet"
	desc = "An outdated envirohelmet designed for leanman medical doctors, having two stripes down it's length to denote as much."
	icon_state = "doctor_envirohelm"
	item_state = "doctor_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/replacement/genetics
	name = "geneticist replacement envirosuit helmet"
	desc = "An outdated leanman envirohelmet designed for geneticists."
	icon_state = "geneticist_envirohelm"
	item_state = "geneticist_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/replacement/viro
...
/obj/item/clothing/head/helmet/space/leanman/replacement/chemist
	name = "chemistry replacement envirosuit helmet"
	desc = "A leanman envirosuit designed for chemists, two orange stripes going down it's face."
	icon_state = "chemist_envirohelm"
	item_state = "chemist_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/replacement/science
	name = "science replacement envirosuit helmet"
	desc = "A replacement leanman envirohelmet designed for scientists."
	icon_state = "scientist_envirohelm"
	item_state = "scientist_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/replacement/robotics
	name = "robotics replacement envirosuit helmet"
	desc = "A replacement leanman envirohelmet designed for roboticists."
	icon_state = "roboticist_envirohelm"
	item_state = "roboticist_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/replacement/engineering
	name = "engineering replacement envirosuit helmet"
	desc = "A replacement helmet designed for engineer leanmen, the usual purple stripes being replaced by engineering's orange."
	item_state = "engineer_envirohelm"
	icon_state = "engineer_envirohelm"
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 100, "rad" = 10, "fire" = 100, "acid" = 75, "stamina" = 0)

/obj/item/clothing/head/helmet/space/leanman/replacement/engineering/atmospherics
	name = "atmospherics replacement envirosuit helmet"
	desc = "A space-worthy helmet specially designed for atmos technician leanmen, the usual purple stripes being replaced by engineering's blue."
	icon_state = "atmos_envirohelm"
	item_state = "atmos_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/replacement/cargo
	name = "cargo replacement envirosuit helmet"
	desc = "An replacement envirohelmet designed for cargo techs and quartermasters."
	icon_state = "cargo_envirohelm"
	item_state = "cargo_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/replacement/mining
	name = "mining replacement envirosuit helmet"
	desc = "A khaki replacement helmet given to leanmen miners operating on lavaland."
	icon_state = "explorer_envirohelm"
	item_state = "explorer_envirohelm"
	visor_icon = "explorer_envisor"

/obj/item/clothing/head/helmet/space/leanman/replacement/chaplain
	name = "chaplain's replacement envirosuit helmet"
	desc = "An outdated envirohelmet specially designed for only the most pious of leanmen."
	icon_state = "chap_envirohelm"
	item_state = "chap_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/replacement/white
	name = "white replacement envirosuit helmet"
	desc = "A generic white envirohelm, slightly dated."
	icon_state = "white_envirohelm"
	item_state = "white_envirohelm"

/obj/item/clothing/head/helmet/space/leanman/replacement/curator
	name = "curator's replacement envirosuit helmet"
	desc = "A traditional voidsuit helmet, this helmet was Nano-Trasen's first solution to the *logistical problems* that come with employing leanmen. Despite their limitations, these helmets still see use by historian and old-styled leanmen alike."
	icon_state = "prototype_envirohelm"
	item_state = "prototype_envirohelm"
	actions_types = list()
	smile_state = "prototype_smile"

/obj/item/clothing/head/helmet/space/leanman/replacement/botany
...
/obj/item/clothing/head/helmet/space/leanman/replacement/janitor
...
/obj/item/clothing/head/helmet/space/leanman/mark2
	name = "Mk.II envirosuit helmet"
	desc = "A sleek new leanman containment helmet, painted in classic Hazardous Orange."
	icon_state = "assistant_openvirohelm"
	item_state = "assistant_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/security/mark2
	name = "security Mk.II envirosuit helmet"
	desc = "A stylish new iteration upon the original leanman containment helmet design for security officers, retaining all the old protections for a new era of fragile law enforcement."
	icon_state = "security_openvirohelm"
	item_state = "security_openvirohelm"
	visor_icon = "openvisor"
	armor = list("melee" = 10, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 100, "rad" = 0, "fire" = 100, "acid" = 75, "stamina" = 10)

/obj/item/clothing/head/helmet/space/leanman/security/warden/mark2
	name = "warden's Mk.II envirosuit helmet"
	desc = "A stylish new iteration upon the original leanman containment helmet design for the warden. All the chic of the standard look with the Warden's iconic reflective white stripe."
	icon_state = "warden_openvirohelm"
	item_state = "warden_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/medical/mark2
	name = "medical's Mk.II envirosuit helmet"
	desc = "A stylish new iteration upon the original leanman containment helmet design for medical doctors. Glue your fellow crewmen back together and make a fashion statement while you're at it."
	icon_state = "doctor_openvirohelm"
	item_state = "doctor_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/genetics/mark2
	name = "geneticist's Mk.II envirosuit helmet"
	desc = "A stylish new iteration upon the original leanman containment helmet design for geneticists. Pushing the boundaries of organic life never looked so good!"
	icon_state = "geneticist_openvirohelm"
	item_state = "geneticist_envirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/viro/mark2
...
/obj/item/clothing/head/helmet/space/leanman/chemist/mark2
	name = "chemistry Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for chemists."
	icon_state = "chemist_openvirohelm"
	item_state = "chemist_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/emt/mark2
	name = "paramedic Mk.II envirosuit helmet"
	desc = "A new and improved envirosuit helmet only for the bravest medical leanman."
	icon_state = "emt_openvirohelm"
	item_state = "emt_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/security/secmed/mark2
	name = "brig physician Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for brig physicians."
	icon_state = "secmed_openvirohelm"
	item_state = "secmed_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/science/mark2
	name = "science Mk.II envirosuit helmet"
	desc = "A stylish new iteration upon the original leanman containment helmet design for scientists."
	icon_state = "scientist_openvirohelm"
	item_state = "scientist_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/robotics/mark2
	name = "robotics Mk.II envirosuit helmet"
	desc = "A stylish new iteration upon the original leanman containment helmet design for roboticists."
	icon_state = "roboticist_openvirohelm"
	item_state = "roboticist_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/engineering/mark2
...
/obj/item/clothing/head/helmet/space/leanman/engineering/atmospherics/mark2
...
/obj/item/clothing/head/helmet/space/leanman/cargo/mark2
	name = "cargo Mk.II envirosuit helmet"
	desc = "A stylish new iteration upon the original leanman containment helmet design for cargo techs and quartermasters. Neo-liberal grifting has never been this groovy"
	icon_state = "cargo_openvirohelm"
	item_state = "cargo_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/mining/mark2
	name = "mining Mk.II envirosuit helmet"
	desc = "A new styling of the classi khaki helmet given to leanmen miners."
	icon_state = "explorer_openvirohelm"
	item_state = "explorer_openvirohelm"
	visor_icon = "explorer_openvisor"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/chaplain/mark2
	name = "chaplain's Mk.II envirosuit helmet"
	desc = "A stylish new iteration upon the original leanman containment helmet design for only the most pious of leanmen. Old age traditions wrapped in a new age shell."
	icon_state = "chap_openvirohelm"
	item_state = "chap_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/white/mark2
...
/obj/item/clothing/head/helmet/space/leanman/botany/mark2
	name = "botany Mk.II envirosuit helmet"
	desc = "A stylish new iteration upon the original leanman containment helmet design for botanists. Now specially designed against minor planet-related injuries."
	icon_state = "botany_openvirohelm"
	item_state = "botany_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/janitor/mark2
...
/obj/item/clothing/head/helmet/space/leanman/exploration/mark2
	name = "mining envirosuit helmet"
	desc = "A new leanman envirohelmet designed for the exploration crew, decked out in their iconic garish turquiose."
	icon_state = "exploration_openvirohelm"
	item_state = "exploration_openvirohelm"
	visor_icon = "explorer_openvisor"

/obj/item/clothing/head/helmet/space/leanman/command/mark2
...
/obj/item/clothing/head/helmet/space/leanman/engineering/ce/mark2
	name = "chief engineer's Mk.II envirohelmet"
	desc = "A stylish new iteration upon the original leanman containment helmet design for the Chief Engineer. This one doesn't smell as strongly of bird poo."
	icon_state = "ce_openvirohelm"
	item_state = "ce_openvirohelm"
	visor_icon = "openvisor"

/obj/item/clothing/head/helmet/space/leanman/cmo/mark2
...
/obj/item/clothing/head/helmet/space/leanman/security/hos/mark2
...
/obj/item/clothing/head/helmet/space/leanman/rd/mark2
...
/obj/item/clothing/head/helmet/space/leanman/hop/mark2
...
/obj/item/clothing/head/helmet/space/leanman/command/protective
	name = "captain's Mk.II envirosuit helmet"
...
/obj/item/clothing/head/helmet/space/leanman/engineering/ce/protective
	name = "chief engineer's Mk.II envirohelmet"
	desc = "A braced leanman containment helmet design for the Chief Engineer."
	icon_state = "ce_armouredenvirohelm"
	item_state = "ce_armouredenvirohelm"
	visor_icon = "armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/cmo/protective
	name = "chief medical officer's Mk.II envirohelmet"
...
/obj/item/clothing/head/helmet/space/leanman/security/hos/protective
	name = "head of security's Mk.II envirosuit helmet"
...
/obj/item/clothing/head/helmet/space/leanman/rd/protective
	name = "research director's Mk.II envirosuit helmet"
...
/obj/item/clothing/head/helmet/space/leanman/hop/protective
	name = "head of personnel's Mk.II envirosuit helmet"
...
/obj/item/clothing/head/helmet/space/leanman/protective
	name = "protective envirosuit helmet"
	desc = "This helmet was originally designed for engineering crews on the more ramshackle lean mining colonies. Now, after several design improvements and class-action lawsuits, this helmet has been distributed once more as a fun cosmetic choice for NTs leanfolk."
	icon_state = "assistant_armouredenvirohelm"
	item_state = "assistant_armouredenvirohelm"
	visor_icon = "armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/security/protective
	name = "security protective envirosuit helmet"
	desc = "A braced leanman containment helmet design for security officers."
	icon_state = "security_armouredenvirohelm"
	item_state = "security_armouredenvirohelm"
	visor_icon = "armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/security/warden/protective
	name = "warden's Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for the warden."
	icon_state = "warden_armouredenvirohelm"
	item_state = "warden_armouredenvirohelm"
	visor_icon = "armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/medical/protective
	name = "medical's Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for medical doctors."
	icon_state = "doctor_armouredenvirohelm"
	item_state = "doctor_armouredenvirohelm"
	visor_icon = "armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/genetics/protective
	name = "geneticist's Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for geneticists."
	icon_state = "geneticist_armouredenvirohelm"
	item_state = "geneticist_armouredvirohelm"
	visor_icon = "armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/viro/protective
	name = "virology Mk.II envirosuit helmet"
	desc = "The helmet worn by the safest people on the station, those who are completely immune to the monstrosities they create."
...
/obj/item/clothing/head/helmet/space/leanman/chemist/protective
	name = "chemistry Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for chemists."
...
/obj/item/clothing/head/helmet/space/leanman/emt/protective
	name = "paramedic Mk.II envirosuit helmet"
	desc = "A new and improved envirosuit helmet only for the bravest medical leanman."
...
/obj/item/clothing/head/helmet/space/leanman/security/secmed/protective
	name = "brig physician Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for brig physicians."
...
/obj/item/clothing/head/helmet/space/leanman/science/protective
	name = "science Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for scientists."
	icon_state = "scientist_armouredenvirohelm"
	item_state = "scientist_armouredenvirohelm"
	visor_icon = "armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/robotics/protective
	name = "robotics Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for roboticists."
	icon_state = "roboticist_armouredenvirohelm"
	item_state = "roboticist_armouredenvirohelm"
	visor_icon = "armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/engineering/protective
	name = "engineering Mk.II envirosuit helmet"
...
/obj/item/clothing/head/helmet/space/leanman/engineering/atmospherics/protective
	name = "atmospherics Mk.II envirosuit helmet"
...
/obj/item/clothing/head/helmet/space/leanman/cargo/protective
	name = "cargo Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for cargo techs and quartermasters."
	icon_state = "cargo_armouredenvirohelm"
	item_state = "cargo_armouredenvirohelm"
	visor_icon = "armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/mining/protective
	name = "mining Mk.II envirosuit helmet"
	desc = "A new styling of the classic khaki helmet given to leanmen miners."
	icon_state = "explorer_armouredenvirohelm"
	item_state = "explorer_armouredenvirohelm"
	visor_icon = "explorer_armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/chaplain/protective
	name = "chaplain's Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for only the most pious of leanmen."
	icon_state = "chap_armouredenvirohelm"
	item_state = "chap_armouredenvirohelm"
	visor_icon = "armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/white/protective
	name = "white Mk.II envirosuit helmet"
...
/obj/item/clothing/head/helmet/space/leanman/botany/protective
	name = "botany Mk.II envirosuit helmet"
	desc = "A braced leanman containment helmet design for botanists."
	icon_state = "botany_armouredenvirohelm"
	item_state = "botany_armouredenvirohelm"
	visor_icon = "armouredenvisor"

/obj/item/clothing/head/helmet/space/leanman/janitor/protective
	name = "janitor's Mk.II envirosuit helmet"
...
/obj/item/clothing/head/helmet/space/leanman/exploration/protective
	name = "mining envirosuit helmet"
	desc = "A new leanman envirohelmet designed for the exploration crew, decked out in their iconic garish turquiose."
