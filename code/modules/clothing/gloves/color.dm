...
/obj/item/clothing/gloves/color/black/equipped(mob/living/user, slot)
	. = ..()
	if((slot == ITEM_SLOT_GLOVES) && (user.mind?.assigned_role in SSdepartment.get_jobs_by_dept_id(DEPT_NAME_SECURITY)))
		user.add_mood_event("sec_black_gloves", /datum/mood_event/sec_black_gloves)
...
/obj/item/clothing/gloves/color/black/dropped(mob/living/carbon/user)
	...
	if(user.mind?.assigned_role in SSdepartment.get_jobs_by_dept_id(DEPT_NAME_SECURITY))
		user.clear_mood_event("sec_black_gloves")

/obj/item/clothing/gloves/color/yellow/equipped(mob/living/user, slot)
	. = ..()
	if(slot == ITEM_SLOT_GLOVES)
		if(user.mind?.assigned_role == JOB_NAME_ASSISTANT)
			user.add_mood_event("assistant_insulated_gloves", /datum/mood_event/assistant_insulated_gloves)
		if(user.mind?.assigned_role in SSdepartment.get_jobs_by_dept_id(DEPT_NAME_SECURITY))
			user.add_mood_event("sec_insulated_gloves", /datum/mood_event/sec_insulated_gloves)
...
/obj/item/clothing/gloves/color/yellow/dropped(mob/living/carbon/user)
	...
	if(user.gloves != src)
		return
	if(user.mind?.assigned_role == JOB_NAME_ASSISTANT)
		user.clear_mood_event("assistant_insulated_gloves")
	if(user.mind?.assigned_role in SSdepartment.get_jobs_by_dept_id(DEPT_NAME_SECURITY))
		user.clear_mood_event("sec_insulated_gloves")
