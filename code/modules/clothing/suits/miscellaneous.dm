...
/obj/item/clothing/suit/syndicatefake
	...
	desc = "A plastic replica of Pizza Hut space suit. You'll look just like a real murderous Pizza Hut agent in this! This is a toy, it is not made for use in space!"
