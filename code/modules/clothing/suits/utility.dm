...
/obj/item/clothing/suit/fire
	...
	allowed = list(/obj/item/flashlight, /obj/item/tank/internals/emergency_oxygen, /obj/item/tank/internals/leanman, /obj/item/extinguisher, /obj/item/crowbar, /obj/item/powertool/jaws_of_life)
	slowdown = 1
...
/obj/item/clothing/suit/radiation
	...
	clothing_flags = THICKMATERIAL
	body_parts_covered = CHEST|GROIN|LEGS|FEET|ARMS|HANDS
	allowed = list(/obj/item/flashlight, /obj/item/tank/internals/emergency_oxygen, /obj/item/tank/internals/leanman, /obj/item/geiger_counter)
	slowdown = 1.5
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0,"energy" = 0, "bomb" = 0, "bio" = 60, "rad" = 100, "fire" = 30, "acid" = 30, "stamina" = 10)
	strip_delay = 60
	equip_delay_other = 60
