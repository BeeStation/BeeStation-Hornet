...
/obj/item/clothing/head/monkey_sentience_helmet/proc/poll(mob/living/carbon/human/species/monkey/user) //At this point, we can assume we're given a monkey, since this'll put them in the body anyways
