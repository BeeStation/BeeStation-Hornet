...
/obj/item/clothing/head/beret/cccaptain
	...
	armor = list(melee = 80, bullet = 80, laser = 80, energy = 80, bomb = 80, bio = 80, fire = 80, acid = 80, stamina = 80, BLEED = 80)
	strip_delay = 120
...
/obj/item/clothing/head/beret/ccguard
	...
	icon_state = "beret_centcom_officer"
	armor = list(melee = 40, bullet = 20, laser = 10, energy = 10, bomb = 10, bio = 5, fire = 5, acid = 30, stamina = 30, BLEED = 20)
	strip_delay = 60
...
/obj/item/clothing/head/beret/captain
	...
	armor = list(melee = 50, bullet = 30, laser = 20, energy = 30, bomb = 15, bio = 10, fire = 10, acid = 60, stamina = 40, BLEED = 20)
	strip_delay = 90
