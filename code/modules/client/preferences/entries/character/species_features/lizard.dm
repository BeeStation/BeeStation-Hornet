...
/datum/preference/choiced/species_feature/lizard_spines/icon_for(value)
	return generate_lizard_body_shot(get_accessory_for_value(value), "spines")
...
/datum/preference/choiced/species_feature/lizard_tail/icon_for(value)
	return generate_lizard_body_shot(get_accessory_for_value(value), "tail")
