	...
	switch(current_tab)
		...
		if(3) //OOC Preferences
			...
			if(user.client.holder)
				...
				dat += "<b>Ticket Sounds:</b> <a href='?_src_=prefs;preference=hear_adminhelps'>[(toggles & SOUND_ADMINHELP)?"Enabled":"Disabled"]</a><br>"
				...
				if(user.client.holder.check_for_rights(R_ADMIN))
					dat += "<br>"
				...
				if(CONFIG_GET(flag/auto_deadmin_players))
					...
					if(!(toggles & DEADMIN_ALWAYS))
						...
						if(!CONFIG_GET(flag/auto_deadmin_antagonists))
							...
							dat += "<b>As Antag:</b> <font color=red>REQUIRED</font><br>"
						...
						if(!CONFIG_GET(flag/auto_deadmin_heads))
							...
							dat += "<b>As Command:</b> <font color=red>REQUIRED</font><br>"
						...
						if(!CONFIG_GET(flag/auto_deadmin_security))
							...
							dat += "<b>As Security:</b> <font color=red>REQUIRED</font><br>"
						...
						if(!CONFIG_GET(flag/auto_deadmin_silicons))
							...
							dat += "<b>As Silicon:</b> <font color=red>REQUIRED</font><br>"
