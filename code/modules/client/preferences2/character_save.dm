...
/datum/character_save/proc/handle_query(datum/DBQuery/Q)
	...
	features["moth_wings"] = sanitize_inlist(features["moth_wings"], GLOB.moth_wings_sanitized_list, "Plain")
	features["moth_antennae"] = sanitize_inlist(features["moth_antennae"], GLOB.moth_antennae_sanitized_list, "Plain")
	features["moth_markings"] = sanitize_inlist(features["moth_markings"], GLOB.moth_markings_sanitized_list, "None")
