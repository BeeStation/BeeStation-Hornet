 ...
 */
/datum/action/spell/list_target
...
/datum/action/spell/list_target/pre_activate(mob/user, atom/target)
...
/datum/action/spell/list_target/proc/get_list_targets(atom/center, target_radius = 7)
