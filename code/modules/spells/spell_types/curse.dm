...
/proc/curse_of_madness(mob/user, message)
	...
	deadchat_broadcast(span_deadsay("A [span_name("Curse of Madness")] has stricken the station, shattering their minds with the awful secret: \"<span class='big hypnophrase'>[message]</span>\""))
