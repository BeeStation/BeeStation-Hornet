...
/datum/smite/apply_damage_old
	name = "Apply Damage"

/datum/smite/apply_damage_old/effect(client/user, mob/living/target)
	. = ..()
	...
	target.apply_damage_old_type(damage_amount, damage_punishment)
