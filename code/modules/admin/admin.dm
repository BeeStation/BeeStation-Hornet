...
/datum/admins/proc/show_player_panel(mob/M in GLOB.mob_list)
	...
	body += "<br>"
	body += "<a href='byond://?[HREF_TYPE(var_edit)][HREF_PARAM(var_edit::Vars, REF(M))][HrefToken()]'>VV</a> "
	if(M.mind)
	...
	body += "<a href='byond://?[HREF_TYPE(admin_pm)][HREF_PARAM(admin_pm::msg_target, M.ckey)]'>PM</a> "
