...
/client/proc/smite(mob/living/target as mob)
	...
	switch(punishment)
		...
		if(ADMIN_PUNISHMENT_TIMELINE)
			var/datum/antagonist/ta/tgA = target.mind?.has_antag_datum(/datum/antagonist/ta)
			if (!tgA)
				tgA = new
				target.mind.add_antag_datum(tgA)
