...
/client/proc/cmd_admin_areatest(on_station)
	...
	var/list/station_areas_blacklist = typecacheof(list(/area/holodeck, /area/shuttle, /area/engine/supermatter, /area/science/test_area, /area/space, /area/solar, /area/mine, /area/ruin, /area/asteroid))
