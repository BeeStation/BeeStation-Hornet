/proc/possess(obj/O in world)
	...
	O.AddElement(/datum/element/weather_listener, /datum/weather/snow_storm, ZTRAIT_SNOWSTORM, GLOB.ash_storm_sounds)
...
/proc/release()
	...
	usr.control_object.RemoveElement(/datum/element/weather_listener, /datum/weather/snow_storm, ZTRAIT_SNOWSTORM, GLOB.ash_storm_sounds)
