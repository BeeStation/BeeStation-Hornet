...
/proc/TgsPm(target,msg,sender)
	...
	to_chat(C, span_adminsay("Admin PM from-<b><a href='byond://?[HREF_GROUP(admin_pm)][HREF_PARAM(admin_pm::msg_target, stealthkey)]'>[adminname]</A></b>: [msg]"), allow_linkify = TRUE, type = MESSAGE_TYPE_ADMINPM)
