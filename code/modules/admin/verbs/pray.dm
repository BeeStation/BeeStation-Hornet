/mob/verb/pray(msg as text)
	...
	var/deity
	if(mind?.get_mind_role(JTYPE_JOB_PATH, as_basic_job=TRUE) == JOB_PATH_CHAPLAIN)
	...
	var/msg_tmp = msg
	GLOB.requests.pray(usr.client, msg, mind?.get_mind_role(JTYPE_JOB_PATH, as_basic_job=TRUE) == JOB_PATH_CHAPLAIN)
