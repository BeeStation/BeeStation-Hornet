...
/client/proc/cmd_admin_say(msg as text)
	...
	msg = "[span_adminsay("<span class='prefix'>ADMIN:")] <EM>[key_name(usr, 1)]</EM> [ADMIN_FLW(mob)]: [custom_asay_color][span_messagelinkify("[msg]")]</span>[custom_asay_color ? "</font>":null]"
