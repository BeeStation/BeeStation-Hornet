...
/datum/admins/proc/add_tagged_datum(datum/target_datum)
	...
	to_chat(owner, "<span class='warning'>[target_datum] has been tagged.</span>")
...
/datum/admins/proc/handle_tagged_del(datum/source)
	...
	if(owner)
		to_chat(owner, "<span class='boldnotice'>Tagged datum [source] ([source.type]) has been deleted.</span>")
