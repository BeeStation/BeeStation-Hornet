...
/proc/randomize_human(mob/living/carbon/human/H)
	...
	H.dna.features["grod_crown"] = pick(GLOB.grod_crowns_list)
	H.dna.features["grod_marks"] = pick(GLOB.grod_marks_list)
	H.dna.features["grod_tail"] = pick(GLOB.grod_tails_list)
