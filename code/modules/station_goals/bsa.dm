...
/obj/machinery/power/bsa/full/proc/charge_up(mob/user, turf/bullseye)
	...
	playsound(get_turf(src), charge_up, 15, 1, pressure_affected = FALSE)
...
/obj/machinery/power/bsa/full/proc/fire(mob/user, turf/bullseye)
	winding_up = FALSE
	playsound(get_turf(src), fire_sound, 25, 1, world.maxx, pressure_affected = FALSE, ignore_walls = TRUE)
