...
/datum/asset/simple/bee_antags
	assets = list(
		...
		"bloodsucker.caitiff.png"= 'html/img/bloodsucker.caitiff.png',
		"bloodsucker.malkavian.png"= 'html/img/bloodsucker.malkavian.png',
		"bloodsucker.nosferatu.png"= 'html/img/bloodsucker.nosferatu.png',
		"bloodsucker.tremere.png"= 'html/img/bloodsucker.tremere.png',
		"bloodsucker.power_bleed"= 'html/img/bloodsucker.power_bleed.png',
		"bloodsucker.power_auspex.png"= 'html/img/bloodsucker.power_auspex.png',
		"bloodsucker.power_cloak.png"= 'html/img/bloodsucker.power_cloak.png',
		"bloodsucker.power_distress.png"= 'html/img/bloodsucker.power_distress.png',
		"bloodsucker.power_dominate.png"= 'html/img/bloodsucker.power_dominate.png',
		"bloodsucker.power_feed.png"= 'html/img/bloodsucker.power_feed.png',
		"bloodsucker.power_gohome.png"= 'html/img/bloodsucker.power_gohome.png',
		"bloodsucker.power_fortitude.png"= 'html/img/bloodsucker.power_fortitude.png',
		"bloodsucker.power_human.png"= 'html/img/bloodsucker.power_human.png',
		"bloodsucker.power_lunge.png"= 'html/img/bloodsucker.power_lunge.png',
		"bloodsucker.power_mez.png"= 'html/img/bloodsucker.power_mez.png',
		"bloodsucker.power_recup.png"= 'html/img/bloodsucker.power_recup.png',
		"bloodsucker.power_speed.png"= 'html/img/bloodsucker.power_speed.png',
		"bloodsucker.power_strength.png"= 'html/img/bloodsucker.power_strength.png',
		"bloodsucker.power_thaumaturgy.png"= 'html/img/bloodsucker.power_thaumaturgy.png',
		"bloodsucker.power_torpor.png"= 'html/img/bloodsucker.power_torpor.png',
		"bloodsucker.power_tres.png"= 'html/img/bloodsucker.power_tres.png',
		"bloodsucker.power_veil.png"= 'html/img/bloodsucker.power_veil.png',
	)
