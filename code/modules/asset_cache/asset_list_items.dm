...
/datum/asset/spritesheet_batched/crafting/proc/add_atom_icon(atom, id)
	...
	if(!(icon_state in icon_states(icon_file)))
		...
		return
	#endif
	insert_icon("a[id]", icon(icon_file, icon_state, SOUTH))
...
/datum/asset/spritesheet_batched/crafting/proc/add_tool_icons()
	var/list/tool_icons = list(
		...
		TOOL_SCALPEL = uni_icon('icons/obj/surgery.dmi', "scalpel"),
		TOOL_SAW = uni_icon('icons/obj/surgery.dmi', "saw"),
		TOOL_BONESET = uni_icon('icons/obj/surgery.dmi', "bonesetter"),
