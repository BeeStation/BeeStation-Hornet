...
/datum/asset/simple/bee_antags
	assets = list(
		...
		"caitiff.png" = 'html/img/vampire/caitiff.png',
		...
		"power_distress.png" = 'html/img/vampire/power_distress.png',
		"power_dominate.png" = 'html/img/vampire/power_dominate.png',
		"power_feed.png" = 'html/img/vampire/power_feed.png',
		"power_gohome.png" = 'html/img/vampire/power_gohome.png',
		"power_fortitude.png" = 'html/img/vampire/power_fortitude.png',
		"power_human.png" = 'html/img/vampire/power_human.png',
		"power_lunge.png" = 'html/img/vampire/power_lunge.png',
		"power_mez.png" = 'html/img/vampire/power_mez.png',
		"power_recup.png" = 'html/img/vampire/power_recup.png',
		"power_speed.png" = 'html/img/vampire/power_speed.png',
		"power_strength.png" = 'html/img/vampire/power_strength.png',
		"power_thaumaturgy.png" = 'html/img/vampire/power_thaumaturgy.png',
		"power_torpor.png" = 'html/img/vampire/power_torpor.png',
		"power_tres.png" = 'html/img/vampire/power_tres.png',
		"power_veil.png" = 'html/img/vampire/power_veil.png',
		"vampire.png" = 'html/img/vampire/vampire.png',
	)
