...
/datum/asset/spritesheet/simple/paper
	name = "paper"
	assets = list(
		"stamp-clown" = 'icons/paper_icons/large_stamp-clown.png',
		"stamp-deny" = 'icons/paper_icons/large_stamp-deny.png',
		"stamp-ok" = 'icons/paper_icons/large_stamp-ok.png',
		"stamp-hop" = 'icons/paper_icons/large_stamp-hop.png',
		"stamp-cmo" = 'icons/paper_icons/large_stamp-cmo.png',
		"stamp-ce" = 'icons/paper_icons/large_stamp-ce.png',
		"stamp-hos" = 'icons/paper_icons/large_stamp-hos.png',
		"stamp-rd" = 'icons/paper_icons/large_stamp-rd.png',
		"stamp-cap" = 'icons/paper_icons/large_stamp-cap.png',
		"stamp-qm" = 'icons/paper_icons/large_stamp-qm.png',
		"stamp-law" = 'icons/paper_icons/large_stamp-law.png',
		"stamp-cent" = 'icons/paper_icons/large_stamp-cent.png',
		"stamp-syndicate" = 'icons/paper_icons/large_stamp-syndicate.png',
