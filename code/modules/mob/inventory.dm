...
/mob/proc/doUnEquip(obj/item/I, force, newloc, no_move, invdrop = TRUE, silent = FALSE, was_thrown = FALSE) //Force overrides TRAIT_NODROP for things like wizarditis and admin undress.
