...
/mob/proc/dropItemToGround(obj/item/I, force = FALSE, thrown = FALSE, silent = TRUE, bypass_delay)
	. = doUnEquip(I, force, drop_location(), FALSE, was_thrown = thrown, bypass_delay = bypass_delay)
...
/mob/proc/transferItemToLoc(obj/item/I, newloc = null, force = FALSE, silent = TRUE, bypass_delay)
	. = doUnEquip(I, force, newloc, FALSE, bypass_delay = bypass_delay)
	I.do_drop_animation(src)
...
/mob/proc/doUnEquip(obj/item/I, force, newloc, no_move, invdrop = TRUE, was_thrown = FALSE, silent = FALSE, bypass_delay = TRUE) //Force overrides TRAIT_NODROP for things like wizarditis and admin undress.
