...
/mob/log_message(message, message_type, color=null, log_globally = TRUE)
	...
	var/list/timestamped_message = list("\[[station_time_timestamp(format = "YYYY-MM-DD hh:mm:ss")]\] [key_name(src)] [loc_name(src)] (Event #[LAZYLEN(logging[smessage_type])])" = colored_message)
