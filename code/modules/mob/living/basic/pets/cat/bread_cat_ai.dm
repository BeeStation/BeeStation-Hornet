...
/datum/ai_planning_subtree/find_and_hunt_target/turn_off_stove
	...
	hunt_targets = list(/obj/machinery/oven)
	hunt_range = 9

/datum/ai_behavior/find_hunt_target/stove

/datum/ai_behavior/find_hunt_target/stove/valid_dinner(mob/living/source, obj/machinery/oven/stove, radius)
...
/datum/ai_behavior/hunt_target/interact_with_target/stove_target/target_caught(mob/living/hunter, obj/machinery/oven/stove)
	if(stove.open)
		return
	return ..()
