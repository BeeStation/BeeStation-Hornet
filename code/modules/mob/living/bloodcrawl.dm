...
/mob/living/proc/bloodpool_sink(obj/effect/decal/cleanable/B)
	...
	else if(mob_reagent_holder && mob_reagent_holder.has_reagent(/datum/reagent/consumable/ethanol/demonsblood, needs_metabolizing = TRUE))
...
/mob/living/proc/bloodcrawl_consume(mob/living/victim)
	...
	var/datum/reagents/mob_reagent_holder = victim.get_reagent_holder()
	if(mob_reagent_holder && mob_reagent_holder.has_reagent(/datum/reagent/consumable/ethanol/devilskiss, needs_metabolizing = TRUE))
