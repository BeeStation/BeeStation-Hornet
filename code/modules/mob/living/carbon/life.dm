...
/mob/living/carbon/handle_status_effects()
	...
	if(drunkenness)
		...
		if(mind && (mind.get_mind_role(JTYPE_JOB_PATH, as_basic_job=TRUE) == JOB_PATH_SCIENTIST || mind.get_mind_role(JTYPE_JOB_PATH, as_basic_job=TRUE) == JOB_PATH_RESEARCHDIRECTOR))
