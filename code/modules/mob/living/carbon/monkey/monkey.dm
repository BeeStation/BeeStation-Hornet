...
/mob/living/carbon/monkey/tumor
	...
	icon = 'icons/mob/monkey.dmi'
	icon_state = null
	butcher_results = list(/obj/item/reagent_containers/food/snacks/meat/slab/teratoma = 1, /obj/effect/spawner/lootdrop/teratoma/minor = 5, /obj/effect/spawner/lootdrop/teratoma/major = 1)
