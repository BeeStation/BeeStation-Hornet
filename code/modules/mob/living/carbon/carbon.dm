...
/mob/living/carbon/Initialize(mapload)
	...
	RegisterSignal(src, SIGNAL_ADDTRAIT(TRAIT_OVERRIDE_SKIN_COLOUR), PROC_REF(_signal_body_part_update))
	RegisterSignal(src, SIGNAL_REMOVETRAIT(TRAIT_OVERRIDE_SKIN_COLOUR), PROC_REF(_signal_body_part_update))
