...
/mob/living/carbon/human/proc/fireman_carry(mob/living/carbon/target)
	...
	if(can_be_firemanned(target) && !incapacitated(FALSE, TRUE))
		...
		"<span class='notice'>[HAS_TRAIT(src, TRAIT_QUICKER_CARRY) ? "Using your nanochips, you" : "You"][skills_space] start to lift [target] onto your back[HAS_TRAIT(src, TRAIT_QUICK_CARRY) ? ", while assisted by the nanochips in your gloves..." : "..."]</span>")
