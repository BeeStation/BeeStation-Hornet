...
/mob/living/carbon/human/MouseDrop_T(mob/living/target, mob/living/user)
	if(pulling != target || grab_state < GRAB_AGGRESSIVE || stat != (CONSCIOUS || SOFT_CRIT) || a_intent != INTENT_GRAB)
		return ..()
...
/mob/living/carbon/human/proc/can_piggyback(mob/living/carbon/target)
	return (istype(target) && target.stat == (CONSCIOUS || SOFT_CRIT) && (target.mobility_flags & MOBILITY_STAND))
