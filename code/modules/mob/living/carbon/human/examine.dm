...
//this is very slightly better than it was because you can use it more places. still can't do \his[src] though.
	...
	if(stat == DEAD || (HAS_TRAIT(src, TRAIT_FAKEDEATH)) || (  HAS_TRAIT(src, TRAIT_DEATH_SLEEP) && user.mind?.assigned_role != JOB_NAME_CHIEFMEDICALOFFICER ))  // cmo is knowledgable enough to do actual tests
		appears_dead = TRUE
