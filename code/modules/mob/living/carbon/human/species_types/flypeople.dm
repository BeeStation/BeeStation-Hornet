...
/datum/species/fly/get_species_organs()
	var/list/organs = ..()
	organs[ORGAN_SLOT_TONGUE] = /obj/item/organ/tongue/fly	
	organs[ORGAN_SLOT_STOMACH] = /obj/item/organ/stomach/fly
	organs[ORGAN_SLOT_LIVER] = /obj/item/organ/liver/fly
	return organs
