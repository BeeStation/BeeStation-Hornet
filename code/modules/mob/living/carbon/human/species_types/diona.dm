/datum/species/diona
	...
	inherent_traits = list(TRAIT_ALWAYS_CLEAN, TRAIT_BEEFRIEND, TRAIT_NONECRODISEASE, TRAIT_RESISTLOWPRESSURE, TRAIT_RESISTCOLD, TRAIT_HALT_RADIATION_EFFECTS, TRAIT_RADBOOSTER)
...
/datum/species/diona/handle_radiation(mob/living/carbon/human/H, time_since_irradiated, delta_time)
	. = FALSE
	//Dionae heal and eat radiation for a living.
	H.adjust_nutrition(clamp(time_since_irradiated, 0, 7))
