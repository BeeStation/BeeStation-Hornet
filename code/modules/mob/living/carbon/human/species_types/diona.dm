...
/datum/action/diona/split
	...
	icon_icon = 'icons/mob/actions/actions_spells.dmi' // TO DO: Add icons for evolving
...
/datum/action/diona/split/Trigger(special)
	...
	if(user.incapacitated())
		return FALSE
	if(alert("Are we sure we wish to kill ourself and split into nymphs?",,"Yes", "No") != "Yes")
		return
