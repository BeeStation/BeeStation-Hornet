/datum/species/ipc // im fucking lazy mk2 and cant get sprites to normally work
	...
	sexes = 0
	species_traits = list(NOTRANSSTING,NOEYESPRITES,NO_DNA_COPY,NOBLOOD,TRAIT_EASYDISMEMBER,ROBOTIC_LIMBS,NOZOMBIE,MUTCOLORS,REVIVESBYHEALING,NOHUSK,NOMOUTH,TRAIT_NOCRITDAMAGE) //all of these + whatever we inherit from the real species
