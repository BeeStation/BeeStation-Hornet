/datum/species/ipc // im fucking lazy mk2 and cant get sprites to normally work
	...
	sexes = 0
	species_traits = list(NOTRANSSTING,NO_CLONING,NO_REAGENTS,NOEYESPRITES,NO_DNA_COPY,NOBLOOD,TRAIT_EASYDISMEMBER,NOFLASH) //all of these + whatever we inherit from the real species
