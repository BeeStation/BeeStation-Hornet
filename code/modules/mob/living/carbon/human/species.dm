...
/datum/species/proc/spec_attacked_by(obj/item/I, mob/living/user, obj/item/bodypart/affecting, intent, mob/living/carbon/human/H)
	...
	if((HAS_TRAIT(H, TRAIT_EASYDISMEMBER) && limb_health) || weapon_sharpness == IS_SHARP_DISMEMBER_EASY && prob(I.force))
		dismember_limb = TRUE
	...
	else if(weapon_sharpness > IS_SHARP || (weapon_sharpness == IS_SHARP && H.stat == DEAD))
