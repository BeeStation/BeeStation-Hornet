/mob/living/carbon/human
	...
	var/static/list/can_ride_typecache = typecacheof(list(/mob/living/carbon/human, /mob/living/basic/slime, /mob/living/simple_animal/parrot, /mob/living/carbon/monkey))
	var/lastpuke = 0
