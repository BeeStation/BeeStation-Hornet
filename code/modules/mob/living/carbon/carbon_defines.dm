/mob/living/carbon
	...
	var/stam_heal = STAMINA_REGEN_PER_SECOND * 2	//Stamina healed per 2 seconds overall. When the mob has taken more than 60 stamina damage, the rate of stamina regeneration will be increased, up to 20 per second when the mob has taken 120 stamina damage.
