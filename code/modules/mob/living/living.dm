...
/mob/living/Bump(atom/A)
	...
	if(buckled || now_pushing)
		return
	if((confused || eye_blind) && stat == CONSCIOUS && (mobility_flags & MOBILITY_STAND) && m_intent == "run" && (!ismovable(A) || is_blocked_turf(A)) && !HAS_MOB_PROPERTY(src, PROP_CANTBUMPSLAM))  // ported from VORE, sue me
