...
/mob/living/vv_get_header()
	...
	. += {"
		...
		<br><font size='1'>
			...
			OXY:<font size='1'><a href='byond://?[HREF_TYPE(var_edit)][HREF_PARAM(var_edit::mobToDamage, refid)][HREF_PARAM(var_edit::adjustDamage, "oxygen")][HrefToken()]' id='oxygen'>[getOxyLoss()]</a>
