...
/mob/living/proc/do_jitter_animation(jitteriness)
	...
	var/final_pixel_x = base_pixel_x + get_standard_pixel_x_offset(!(mobility_flags & MOBILITY_STAND))
	var/final_pixel_y = base_pixel_y + get_standard_pixel_y_offset(!(mobility_flags & MOBILITY_STAND))
