...
/mob/living/verb/succumb(whispered as null)
	...
	investigate_log("has succumbed to death.")
	death()
...
/mob/living/get_contents()
	...
	for(var/atom/i as anything in ret.Copy()) //iterate storage objects
		SEND_SIGNAL(i, COMSIG_TRY_STORAGE_RETURN_INVENTORY, ret)
