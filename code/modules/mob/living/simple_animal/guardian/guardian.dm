...
/mob/living/proc/guardian_reset()
	...
	if(guardians.len)
		...
		if(G)
			...
			var/list/mob/dead/observer/candidates = pollGhostCandidates("Do you want to play as [src.real_name]'s [G.real_name]?", ROLE_KEY_PAI, null, FALSE, 100)
...
/obj/item/guardiancreator/attack_self(mob/living/user)
	...
	var/list/mob/dead/observer/candidates = pollGhostCandidates("Do you want to play as the [mob_name] of [user.real_name]?", ROLE_KEY_PAI, null, FALSE, 100, POLL_IGNORE_HOLOPARASITE)
