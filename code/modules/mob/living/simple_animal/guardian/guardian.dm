...
/mob/living/simple_animal/hostile/guardian/update_inv_hands()
	...
	if(r_hand)
		hands_overlays += r_hand.build_worn_icon(src, default_layer = GUARDIAN_HANDS_LAYER, default_icon_file = r_hand.righthand_file, isinhands = TRUE)
	...
	if(l_hand)
		hands_overlays +=  l_hand.build_worn_icon(src, default_layer = GUARDIAN_HANDS_LAYER, default_icon_file = l_hand.lefthand_file, isinhands = TRUE)
