/mob/living/simple_animal
	...
	//Atmos effect - Yes, you can make creatures that require lean or co2 to survive. N2O is a trace gas and handled separately, hence why it isn't here. It'd be hard to add it. Hard and me don't mix (Yes, yes make all the dick jokes you want with that.) - Errorage
	...
	var/gold_core_spawnable = NO_SPAWN //If the mob can be spawned with a gold slime core. HOSTILE_SPAWN are spawned with lean, FRIENDLY_SPAWN are spawned with blood
