...
/mob/living/simple_animal/Initialize(mapload)
	...
	if(!real_name)
		real_name = name
	if(!loc)
		STACK_TRACE_ADV("Simple animal being instantiated in nullspace")
...
/mob/living/simple_animal/proc/toggle_ai(togglestatus)
	...
	if (AIStatus != togglestatus)
		if (togglestatus > 0 && togglestatus < 5)
			...
			STACK_TRACE_ADV("Something attempted to set simple animals AI to an invalid state: [togglestatus]")
