...
/mob/living/simple_animal/drone/Initialize(mapload)
	...
	access_card.access = list(ACCESS_SECURITY, ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_TOX, ACCESS_TOX_STORAGE, ACCESS_GENETICS, ACCESS_ENGINE, ACCESS_ENGINE_EQUIP, ACCESS_MAINT_TUNNELS,
							ACCESS_EXTERNAL_AIRLOCKS, ACCESS_TELEPORTER, ACCESS_EVA, ACCESS_CHAPEL_OFFICE, ACCESS_TECH_STORAGE, ACCESS_ATMOSPHERICS, ACCESS_BAR, ACCESS_JANITOR, ACCESS_KITCHEN,
							ACCESS_CARGO, ACCESS_CONSTRUCTION, ACCESS_CHEMISTRY, ACCESS_BRIGPHYS, ACCESS_HYDROPONICS, ACCESS_LIBRARY, ACCESS_LAWYER, ACCESS_VIROLOGY,
							ACCESS_COURT, ACCESS_SURGERY, ACCESS_THEATRE, ACCESS_RESEARCH, ACCESS_MINING, ACCESS_EXPLORATION, ACCESS_MAILSORTING, ACCESS_MINING_STATION, ACCESS_XENOBIOLOGY,
							ACCESS_TCOMSAT, ACCESS_GATEWAY, ACCESS_SEC_DOORS, ACCESS_MINERAL_STOREROOM, ACCESS_MINISAT, ACCESS_NETWORK, ACCESS_AUX_BASE)
