/mob/living/simple_animal/hostile/megafauna/harbinger
	...
	health = 1000
	maxHealth = 1000
	response_harm_continuous = "eviscerates"
...
/mob/living/simple_animal/hostile/megafauna/harbinger/proc/devour(mob/living/L)
	if(!L)
		return
	visible_message("<span class='danger'>[src] consumes [L]!</span>",)
