...
/mob/living/simple_animal/hostile/megafauna/hierophant
	...
	loot = list(/obj/item/hierophant_club, /obj/item/crusher_trophy/vortex_talisman)
	crusher_loot = list(/obj/item/hierophant_club, /obj/item/crusher_trophy/vortex_talisman, /obj/item/crusher_trophy/vortex_talisman)
	wander = FALSE
