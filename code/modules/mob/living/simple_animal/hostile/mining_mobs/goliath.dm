...
/mob/living/simple_animal/hostile/asteroid/goliath/beast
	...
	robust_searching = 1
	food_type = list(/obj/item/reagent_containers/food/snacks/meat/slab/grub)//gold grubs are cool and cant be butchered but not anymore! featuring taming goliaths!
	tame_chance = 10
	bonus_tame_chance = 5
	var/saddled = FALSE
