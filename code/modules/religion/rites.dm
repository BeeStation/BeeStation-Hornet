...
/datum/religion_rites/raise_undead/invoke_effect(mob/living/user, atom/movable/religious_tool)
	...
	var/list/jobbans = list(BANCHECK_ROLE_MAJOR_GHOSTSPAWN, ROLE_KEY_POSIBRAIN)
...
/datum/religion_rites/summon_carp/invoke_effect(mob/living/user, atom/movable/religious_tool)
	...
	var/list/jobbans = list(ROLE_KEY_ERT, ROLE_KEY_DRONE, BANCHECK_BEHAVIOR_MIND_TRANSFER, ROLE_KEY_POSIBRAIN, ROLE_KEY_SENTIENT)
