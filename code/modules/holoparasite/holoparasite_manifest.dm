...
/mob/living/simple_animal/hostile/holoparasite/proc/manifest(forced = FALSE)
	...
	if(!is_manifested())
		...
		playsound(loc, 'sound/creatures/holopara_summon.ogg', vol = 45, extrarange = -5, frequency = 1)
...
/mob/living/simple_animal/hostile/holoparasite/proc/recall(forced = FALSE)
	...
	playsound(loc, 'sound/creatures/holopara_summon.ogg', vol = 45, extrarange = -2, frequency = -1)
