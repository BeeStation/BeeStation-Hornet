/datum/holoparasite_theme/magic
	...
	mob_info = list(
		HOLOPARA_THEME_ICON_STATE = "magic_base",
...
/datum/holoparasite_theme/magic/create_overlays(mob/living/simple_animal/hostile/holoparasite/holoparasite)
	. = list()
	var/mutable_appearance/glow_accent_overlay = mutable_appearance(initial(holoparasite.icon), "magic_accent_glow")
	...
	var/mutable_appearance/noglow_accent_overlay = mutable_appearance(initial(holoparasite.icon), "magic_accent_noglow")
	...
	. += emissive_appearance(initial(holoparasite.icon), "magic_accent_glow_e")
