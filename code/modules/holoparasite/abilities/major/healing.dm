...
/datum/holoparasite_ability/major/healing/register_signals()
	...
	RegisterSignal(owner, COMSIG_HOSTILE_POST_ATTACKINGTARGET, PROC_REF(on_attack))

/datum/holoparasite_ability/major/healing/unregister_signals()
	..()
	UnregisterSignal(owner, list(COMSIG_HOLOPARA_SETUP_HUD, COMSIG_HOSTILE_POST_ATTACKINGTARGET))
