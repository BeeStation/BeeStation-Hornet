/datum/holoparasite_ability/major/dextrous
	name = "Dextrous"
	...
	forced_weapon = /datum/holoparasite_ability/weapon/dextrous
...
/datum/holoparasite_ability/major/dextrous/New(datum/holoparasite_stats/master_stats)
	. = ..()
	if(!forbidden_guns)
...
/datum/holoparasite_ability/major/dextrous/apply()
...
/datum/holoparasite_ability/major/dextrous/register_signals()
	..()
...
/datum/holoparasite_ability/major/dextrous/unregister_signals()
	..()
...
/datum/holoparasite_ability/major/dextrous/proc/on_hud_setup(datum/_source, datum/hud/holoparasite/hud, list/huds_to_add)
	SIGNAL_HANDLER
	create_storage_hud(hud)
	create_misc_hud(hud, huds_to_add)

/datum/holoparasite_ability/major/dextrous/proc/create_storage_hud(datum/hud/holoparasite/hud)
...
/datum/holoparasite_ability/major/dextrous/proc/create_misc_hud(datum/hud/holoparasite/hud, list/huds_to_add)
 ...
 */
/datum/holoparasite_ability/major/dextrous/proc/drop_items()
	SIGNAL_HANDLER
 ...
 */
/datum/holoparasite_ability/major/dextrous/proc/on_death()
	SIGNAL_HANDLER
	owner.unequip_everything()
 ...
 */
/datum/holoparasite_ability/major/dextrous/proc/on_wield(datum/_source, mob/living/user)
	SIGNAL_HANDLER
	if(!can_wield)
		to_chat(user, "<span class='warning'>You are not strong enough to wield two-handed weapons!</span>")
		return COMPONENT_TWOHANDED_BLOCK_WIELD

/datum/holoparasite_ability/major/dextrous/proc/can_fire_gun(datum/_source, obj/item/gun/gun)
	SIGNAL_HANDLER
 ...
 */
/datum/holoparasite_ability/major/dextrous/proc/on_examine(datum/source, mob/user, text)
	SIGNAL_HANDLER
