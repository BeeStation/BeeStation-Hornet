...
/datum/holoparasite_holder/proc/death_of_the_author(mob/living/body, already_dead = FALSE)
	...
	if(!already_dead)
		...
		body.visible_message(span_danger("<span class='name'>[body]</span> lets out a pained, agonizing wail, [body.p_their()] expression consumed with fear, as [body.p_their()] body rapidly crumbles to dust!"), blind_message = "<i>You hear a pained, agonizing wail...</i>")
		var/traumatized = 0
