...
/mob/living/simple_animal/hostile/holoparasite/proc/unregister_body_signals(mob/living/target)
	UnregisterSignal(target, list(COMSIG_MOVABLE_MOVED, COMSIG_ATOM_DIR_CHANGE, COMSIG_LIVING_UPDATE_HEALTH, COMSIG_LIVING_ON_WABBAJACKED, COMSIG_LIVING_SHAPESHIFTED, COMSIG_LIVING_UNSHAPESHIFTED))
