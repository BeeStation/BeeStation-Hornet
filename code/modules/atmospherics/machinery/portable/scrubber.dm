/obj/machinery/portable_atmospherics/scrubber
	...
	desc = "It's a small portable scrubber, capable of sucking glasses from its surroundings. It has an internal tank, and a slot for inserting an external tank. It can be wrenched to connection ports to pump and withdraw gasses from the internal tank. "
