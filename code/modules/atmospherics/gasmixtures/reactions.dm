...
/datum/gas_reaction/fusion/react(datum/gas_mixture/air, datum/holder)
	...
	var/toroidal_size = min(TOROID_CALCULATED_THRESHOLD + min((temperature_scale-6)/10,0) + 4 ** max(temperature_scale-6,0) / 1250, 1000)//The size of the phase space hypertorus
	var/gas_power = 0
