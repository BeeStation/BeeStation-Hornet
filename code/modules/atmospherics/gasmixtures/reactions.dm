...
/datum/gas_reaction/h2fire/react(datum/gas_mixture/air, datum/holder)
	...
	if(burned_fuel)
		...
		air.adjust_moles(/datum/gas/water_vapor, burned_fuel / HYDROGEN_BURN_OXY_FACTOR) //oxygen+more-or-less hydrogen=H2O
		cached_results["fire"] += burned_fuel
...
/datum/gas_reaction/fusion/react(datum/gas_mixture/air, datum/holder)
	...
	if(delta_plasma > 0)
		air.adjust_moles(/datum/gas/water_vapor, standard_waste_gas_output * 0.25)
		air.adjust_moles(/datum/gas/carbon_dioxide, standard_waste_gas_output)
	else
