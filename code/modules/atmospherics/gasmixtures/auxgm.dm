...
GLOBAL_LIST_INIT(nonreactive_gases, typecacheof(list(GAS_O2, GAS_NITROUS, GAS_CO2, GAS_PLUOXIUM, GAS_STIMULUM, GAS_NITRYL))) //unable to react amongst themselves
