/*
	substrate sticky, where is the substrate
*/
...
*/
/obj/item/sticker/sticky_note/tutorial/refraction
	custom_text = "Refraction Matrix - PN #JDP44456S01 \n\
	\n\
	Matrix interface will calibrate reagent cloud probabilities, logged against a basic coordinate matrix.\n\
	Within each reagent cloud, a grid coordinate will correlate to a stable refraction index.\n\
	\n\
	Insert a disk and compile a grid coordinate to the disk. Inserting the gene into a plant is required\n\
	to observe the stability of the refraction. Unstable refractions may damage plant DNA.\n\
	\n\
