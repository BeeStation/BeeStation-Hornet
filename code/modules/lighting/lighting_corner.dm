...
/datum/lighting_corner/Destroy(var/force)
	...
	stack_trace("Ok, Look, Beestation, I need you to find whatever fucker decided to call qdel on a fucking lighting corner, then tell him very nicely and politely to fix it. Thanks. Send them my regards by the way.")
