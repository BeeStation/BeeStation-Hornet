...
/datum/light_source
	...
	var/atom/movable/lighting_mask_alpha/our_mask
...
/datum/light_source/New(var/atom/owner, var/atom/movable/top)
	if(!ismovableatom(top))
		message_admins("error, [top] not movable")
