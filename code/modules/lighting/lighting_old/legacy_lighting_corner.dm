...
/datum/legacy_lighting_corner/New(var/turf/new_turf, var/diagonal)
	. = ..()
	masters = list()
...
/datum/legacy_lighting_corner/proc/update_active()
	active = FALSE
	var/turf/T
	var/thing
...
/datum/legacy_lighting_corner/proc/update_objects()
...
/datum/legacy_lighting_corner/Destroy(var/force)
	if (!force)
