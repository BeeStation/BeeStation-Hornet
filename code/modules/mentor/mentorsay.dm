...
/client/proc/cmd_mentor_say(msg as text)
	...
	if(check_rights_for(src, R_ADMIN,0))
		msg = "<b>[span_mentorsay("<font color ='#8A2BE2'><span class='prefix'>MENTOR:")] <EM>[key_name(src, 0, 0)]</EM>: [span_message("[msg]")]</font></b>"
	else
		msg = "<b>[span_mentorsay("<span class='prefix'>MENTOR:")] <EM>[key_name(src, 0, 0)]</EM>: [span_message("[msg]")]</font></b>"
