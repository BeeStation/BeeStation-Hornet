...
/datum/heretic_knowledge/limited_amount/flesh_ghoul/on_finished_recipe(mob/living/user, list/selected_atoms, turf/loc)
	...
	if(!soon_to_be_ghoul.mind || !soon_to_be_ghoul.client)
		...
		var/list/mob/dead/observer/candidates = pollCandidatesForMob("Do you want to play as a [soon_to_be_ghoul.real_name], a voiceless dead?", BAN_ROLE_HERETIC, null, null, 5 SECONDS, soon_to_be_ghoul)
