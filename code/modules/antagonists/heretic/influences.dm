...
/datum/reality_smash_tracker/Destroy(force, ...)
	if(GLOB.reality_smash_track == src)
		STACK_TRACE_ADV("[type] was deleted. Heretics may no longer access any influences. Fix it, or call coder support.")
...
/datum/reality_smash_tracker/proc/rework_network()
	...
	for(var/mind in tracked_heretics)
		if(isnull(mind))
			STACK_TRACE_ADV("A null somehow landed in the [type] list of minds. How?")
