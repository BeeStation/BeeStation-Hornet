...
/datum/action/innate/ai/break_air_alarms/Activate()
	...
	owner.log_message("activated malf module [name]", LOG_GAME)
	to_chat(owner, "<span class='notice'>All air alarm safeties on the station have been overridden. Air alarms may now use extremely dangerous environmental modes.</span>")
	owner.playsound_local(owner, 'sound/machines/terminal_off.ogg', 50, 0)
