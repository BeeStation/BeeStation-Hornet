...
/datum/traitor_backstory/gambler
	...
	forced = TRUE
	valid_bosses = list(TRAITOR_BOSS_MARKET)
...
/datum/traitor_backstory/climber
	...
	In my many years of observing the dynamics in this universe, it is clear to me that the Syndicate is the surest way to achieve the domination of myself. \
