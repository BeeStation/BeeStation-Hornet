...
/datum/antagonist/wishgranter/proc/give_powers()
	...
	if(!C.has_dna())
		return
	C.dna.add_mutation(/datum/mutation/human/hulk)
	C.dna.add_mutation(/datum/mutation/human/thermal/x_ray)
	C.dna.add_mutation(/datum/mutation/human/space_adaptation)
