...
/datum/special_role
	...
	var/list/protected_jobs = list("Security Officer", "Corporate Affairs Agent", "Warden", "Detective", "Head of Security", "Head of Personnel", "Chief Medical Officer", "Chief Engineer", "Research Director", "Captain")
