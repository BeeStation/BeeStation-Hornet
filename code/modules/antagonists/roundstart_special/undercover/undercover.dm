...
/datum/special_role/undercover
	...
	protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Brig Physician", "Head of Personnel", "Chief Medical Officer", "Chief Engineer", "Research Director", "Clown")
