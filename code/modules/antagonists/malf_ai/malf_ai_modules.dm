...
/datum/ai_module/malf/upgrade/upgrade_turrets/upgrade(mob/living/silicon/ai/AI)
	for(var/obj/machinery/porta_turret/ai/turret in GLOB.machines)
		...
		turret.stun_projectile = /obj/projectile/laser/disabler/pass_glass //// AI defenses are often built with glass, so this is big.
		turret.stun_projectile_sound = 'sound/weapons/lasercannonfire.ogg'
		turret.lethal_projectile = /obj/projectile/laser/heavy //Once you see it, you will know what it means to FEAR.
