...
/obj/item/organ/heart/gland/proc/mind_control(command, mob/living/user)
	...
	deadchat_broadcast(span_deadsay("<span class='name'>[user]</span> sent an abductor mind control message to <span class='name'>[owner]</span>: <span class='bold message'>[command]</span>"), follow_target = owner, turf_target = get_turf(owner), message_type = DEADCHAT_REGULAR)
	update_gland_hud()
