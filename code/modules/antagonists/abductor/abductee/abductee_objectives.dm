...
/datum/objective/abductee/violent/New()
	...
	var/list/your_poison = list("I am [target], <b>they</b> have changed my face and tried to replace me by sending a clone!! I must kill them first and resume my life as my original identity.","THEY'RE ALL INSANE!!! THEY ALL WANT ME DEAD!!! I MUST KILL THEM ALL I MUST SHOW THEM THAT I WON'T GO DOWN SO EASY!!! TRY ME!!!")
