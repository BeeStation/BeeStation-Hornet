...
/obj/structure/destructible/cult/item_dispenser/altar/setup_options()
	var/static/list/altar_items = list(
		...
		UNHOLY_WATER = list(
			...
			OUTPUT_ITEMS = list(/obj/item/reagent_containers/cup/glass/bottle/unholywater),
			RADIAL_DESC = "Provides \a [/obj/item/reagent_containers/cup/glass/bottle/unholywater::name], \
