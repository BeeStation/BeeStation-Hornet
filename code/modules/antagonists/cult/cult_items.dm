...
/obj/item/clothing/head/helmet/space/hardsuit/cult
	...
	brightness_on = 0
	actions_types = list()
	high_pressure_decrease = 0.5

/obj/item/clothing/head/helmet/space/hardsuit/cult/get_armor_rating(d_type, mob/wearer)
	. = ..(d_type, wearer)
...
/obj/item/clothing/suit/space/hardsuit/cult
	...
	desc = "A heavily-armored exosuit worn by warriors of the Nar'Sien cult. It is reinforced by hard vacuum."
	w_class = WEIGHT_CLASS_BULKY
