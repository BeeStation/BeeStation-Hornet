...
/mob/camera/blob/verb/create_blobbernaut()
	...
	var/list/mob/dead/observer/candidates = pollGhostCandidates("Do you want to play as a [blobstrain.name] blobbernaut?", BAN_ROLE_BLOB, null, /datum/role_preference/midround_ghost/blob, 50) //players must answer rapidly
