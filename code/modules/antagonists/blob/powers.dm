...
/mob/camera/blob/verb/create_blobbernaut()
	...
	var/list/mob/dead/observer/candidates = pollGhostCandidates("Do you want to play as a [blobstrain.name] blobbernaut?", ROLE_KEY_BLOB, null, ROLE_KEY_BLOB, 50) //players must answer rapidly
