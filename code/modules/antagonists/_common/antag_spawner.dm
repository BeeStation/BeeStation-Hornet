...
/obj/item/antag_spawner/nuke_ops/borg_tele/spawn_antag(client/C, turf/T, kind, datum/mind/user)
	var/mob/living/silicon/cyborg/R
	var/datum/antagonist/nukeop/creator_op = user.has_antag_datum(/datum/antagonist/nukeop,TRUE)
	if(!creator_op)
		return
	...
	switch(borg_to_spawn)
		if("Medical")
			R = new /mob/living/silicon/cyborg/modules/syndicate/medical(T)
		if("Saboteur")
			R = new /mob/living/silicon/cyborg/modules/syndicate/saboteur(T)
		else
			R = new /mob/living/silicon/cyborg/modules/syndicate(T) //Assault borg by default
