...
/datum/antagonist/proc/on_gain()
	...
	if(antag_role_type)
		...
		var/current_role = owner.get_display_special_role()
		if(current_role)
			owner.set_display_special_role("[current_role], [name]")
		else
			owner.set_display_special_role(name)
...
/datum/antagonist/proc/on_removal()
	...
	if(owner)
		...
		if(!silent && owner.current)
			farewell()
		owner.remove_special_role(antag_role_type)
