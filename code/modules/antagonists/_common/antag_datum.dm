...
/datum/antagonist
	...
	/// The BAN_ROLE_X key used for this antagonist.
	var/banning_key
...
/datum/antagonist/proc/replace_banned_player()
	...
	var/list/mob/dead/observer/candidates = pollCandidatesForMob("Do you want to play as a [name]?", banning_key, null, null, 50, owner.current)
