 ...
 *	Level 4 - Raise sightrange by 4, project sight 8 tiles ahead.
 *	Level 5 - Raise sightrange by 5, project sight 10 tiles ahead. Xray Vision || For Malkavians: Gain ability to astral project like a wizard.
 */
