/proc/try_warp_servant(mob/living/servant, turf/target_location, bring_dragging = FALSE)
	...
	if(is_centcom_level(T.z))
		return FALSE
	playsound(servant, 'sound/magic/magic_missile.ogg', 40, TRUE, is_reebe(servant.z) ? 4 : -4)
	playsound(target_location, 'sound/magic/magic_missile.ogg', 40, TRUE, is_reebe(target_location.z) ? 4 : -4)
