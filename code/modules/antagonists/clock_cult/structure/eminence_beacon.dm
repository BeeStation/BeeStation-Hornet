...
/obj/structure/destructible/clockwork/eminence_beacon/proc/vote_succeed(mob/eminence)
	...
	used = TRUE
	if(!eminence)
		var/list/mob/dead/observer/candidates = pollGhostCandidates("Do you want to play as the eminence?", BAN_ROLE_SERVANT_OF_RATVAR, /datum/role_preference/antagonist/clock_cultist, 10 SECONDS)
