/obj/item/clothing/suit/clockwork
	...
	armor = list("melee" = 30, "bullet" = 40, "laser" = 10, "energy" = 80, "bomb" = 40, "bio" = 70, "rad" = 100, "fire" = 100, "acid" = 100, "stamina" = 60)
	slowdown = 0.6
...
/obj/item/clothing/suit/clockwork/speed
	...
	slowdown = -0.3
	resistance_flags = FIRE_PROOF | ACID_PROOF
	armor = list("melee" = 10, "bullet" = 20, "laser" = 0, "energy" = -20, "bomb" = 0, "bio" = 70, "rad" = 100, "fire" = 100, "acid" = 100, "stamina" = 30)
...
/obj/item/clothing/suit/clockwork/cloak
	...
	armor = list("melee" = 20, "bullet" = 30, "laser" = 0, "energy" = 10, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 100, "stamina" = 20)
	slowdown = 0.4
	resistance_flags = FIRE_PROOF | ACID_PROOF
...
/obj/item/clothing/head/helmet/clockcult
	...
	armor = list("melee" = 40, "bullet" = 50, "laser" = 20, "energy" = 40, "bomb" = 40, "bio" = 70, "rad" = 100, "fire" = 100, "acid" = 100, "stamina" = 60)
	resistance_flags = FIRE_PROOF | ACID_PROOF
	w_class = WEIGHT_CLASS_BULKY
	flash_protect = 1
	bang_protect = 3
