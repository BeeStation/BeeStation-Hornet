/datum/antagonist/gang
	...
	var/antag_hud_type = ANTAG_HUD_GANGSTER // pls dont b broken from having 2 define this here bcuz of heretic port
	var/antag_hud_name = "hud_gangster"
...
/datum/antagonist/gang/dutch/check_gang_objective()
	...
	if(mat_container.materials[getmaterialref(/datum/material/gold)] >= 2000) // if theres at least 1 bar of gold left in the silo, they've failed to heist all of it COMMENT 2 ANOTHER DANGER POINT PLS CHECK
		return FALSE
	return TRUE
