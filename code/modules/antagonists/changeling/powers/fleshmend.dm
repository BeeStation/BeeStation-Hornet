/datum/action/changeling/fleshmend
	name = "Fleshmend"
	desc = "Our flesh rapidly regenerates, rapidly healing brute wounds, shortness of breath, burns, genetic damage, and also hiding all of our scars. Costs 25 chemicals."
