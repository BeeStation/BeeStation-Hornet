...
/datum/action/changeling/sting/hallucinate
...
/datum/action/changeling/sting/hallucinate/sting_action(mob/user, mob/living/carbon/target)
	log_combat(user, target, "stung", "Hallucination sting")
	addtimer(CALLBACK(src, .proc/hallucination_time, target), rand(300,600))
	return TRUE

/datum/action/changeling/sting/hallucinate/proc/hallucination_time(mob/living/carbon/target)
	if(target)
