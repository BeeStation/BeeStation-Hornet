...
/datum/action/changeling/teratoma/proc/create_teratoma(mob/user)
	...
	var/list/mob/dead/observer/candidates = pollGhostCandidates("Do you want to play as a living teratoma?", BAN_ROLE_TERATOMA, null, null, 5 SECONDS, POLL_IGNORE_TERATOMA) //players must answer rapidly
