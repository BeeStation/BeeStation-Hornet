...
/datum/action/changeling/teratoma/proc/create_teratoma(mob/user)
	...
	var/list/mob/dead/observer/candidates = pollGhostCandidates("Do you want to play as a living teratoma?", BAN_ROLE_TERATOMA, null, 7.5 SECONDS) //players must answer rapidly
