 ...
 * Returns nothing.
 */
/proc/create_separatist_nation(datum/department_group/department, announcement = FALSE, dangerous = FALSE, message_admins = TRUE)
	...
	if(!department)
		...
		department = pick(list(/datum/department_group/medical, /datum/department_group/engineering, /datum/department_group/science, /datum/department_group/cargo, /datum/department_group/service, /datum/department_group/security) - independent_departments)
		if(!department)
			if(message_admins)
