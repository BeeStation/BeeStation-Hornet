...
/obj/structure/constructshell/examine(mob/user)
	...
	if(iscultist(user) || iswizard(user) || user.stat == DEAD)
		...
		. += span_cult("An <b>Artificer</b>, which can produce <b>more shells and soulstones</b>, as well as fortifications.")
		. += span_cult("A <b>Wraith</b>, which does high damage and can jaunt through walls, though it is quite fragile.")
		. += span_cult("A <b>Juggernaut</b>, which is very hard to kill and can produce temporary walls, but is slow.")
