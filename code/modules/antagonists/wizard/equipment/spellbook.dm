...
/datum/spellbook_entry/proc/Buy(mob/living/carbon/human/user,obj/item/spellbook/book) //return EF_TRUE on success
	if(!S || QDELETED(S))
		S = new spell_type()
...
/datum/spellbook_entry/lightningbolt/Buy(mob/living/carbon/human/user,obj/item/spellbook/book) //return EF_TRUE on success
	. = ..()
