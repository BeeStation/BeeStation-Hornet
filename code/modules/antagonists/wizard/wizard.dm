...
/datum/antagonist/wizard/greet()
	owner.current.playsound_local(get_turf(owner.current), 'sound/ambience/antag/wizard.ogg', vol = 100, vary = FALSE, channel = CHANNEL_ANTAG_GREETING, pressure_affected = FALSE, use_reverb = FALSE)
