...
/mob/living/simple_animal/slaughter
	...
	var/playstyle_string = "<span class='big bold'>You are a slaughter demon,</span><B> a terrible creature from another realm. You have a single desire: To kill.  \
							...
							<span class='warning'>You cannot re-enter the living world until you've rested for half a minute in the sea of blood.</span> \ </B>"
...
/mob/living/simple_animal/slaughter/laughter
	...
	<span class='warning'>You cannot re-enter the living world until you've rested for half a minute in the sea of blood.</span> \
