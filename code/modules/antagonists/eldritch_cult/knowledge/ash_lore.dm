...
/datum/eldritch_knowledge/base_ash
	...
	desc = "Opens up the Path of Ash to you. Allows you to transmute a match with a kitchen knife, or its derivatives, into an Ashen Blade. Increases the amount of disciples you can have."
...
/datum/eldritch_knowledge/ash_mark
	...
	desc = "As a Priest of Ash, you can recruit more disciples, and your Mansus Grasp now applies the Mark of Ash on hit. Attack the afflicted with your Sickly Blade to detonate the mark. Upon detonation, the Mark of Ash causes stamina damage and burn damage, and spreads to an additional nearby opponent. The damage decreases with each spread."
	cost = 10
...
/datum/eldritch_knowledge/ash_blade_upgrade
	...
	desc = "As a Prophet of Ash, you can recruit more disciples. Enhances your blade to light your enemies ablaze."
	cost = 10
