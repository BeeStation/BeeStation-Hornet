...
/datum/team/revolution/antag_listing_entry()
	...
	for(var/datum/mind/N in SSjob.get_living_heads())
		...
		if(M)
			...
			heads_report += "<td><A href='byond://?[/hrefcmd/print::admin_pm];msg_target=[M.ckey]'>PM</A></td>"
			...
			heads_report += "<td><A href='byond://?[/hrefcmd/print::admin_pm];msg_target=[N.key]'>PM</A></td></tr>"
	heads_report += "</table>"
