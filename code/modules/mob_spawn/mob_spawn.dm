...
/obj/effect/mob_spawn/proc/special(mob/living/spawned_mob)
	...
	if(ishuman(spawned_mob))
		...
		if(hairstyle)
			spawned_human.hair_style = hairstyle
		else
			spawned_human.hair_style = random_hair_style(spawned_human.gender)
		if(facial_hairstyle)
			spawned_human.facial_hair_style = facial_hairstyle
		else
			spawned_human.facial_hair_style = random_facial_hair_style(spawned_human.gender)
		if(haircolor)
