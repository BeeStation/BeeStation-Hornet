...
/atom/movable/screen/escape_menu/text/clickable/admin_help/Initialize(
	...
	var/datum/help_ticket/current_ticket = escape_menu.client?.current_adminhelp_ticket
...
/atom/movable/screen/escape_menu/text/clickable/admin_help/Click(location, control, params)
	...
	if (has_open_adminhelp())
		GLOB.ahelp_tickets.BrowseTickets(client?.mob)
	else
		client?.adminhelp()
...
/atom/movable/screen/escape_menu/text/clickable/admin_help/proc/has_open_adminhelp()
	...
	var/datum/help_ticket/current_ticket = client?.current_adminhelp_ticket
...
/atom/movable/screen/escape_menu/text/clickable/admin_help/proc/connect_ticket(datum/help_ticket/admin_help)
