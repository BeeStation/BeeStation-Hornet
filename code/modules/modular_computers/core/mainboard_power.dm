...
/obj/item/mainboard/proc/use_power(amount = 0)
...
/obj/item/mainboard/proc/give_power(amount)
	var/obj/item/computer_hardware/battery/battery_module = all_components[MC_CELL]
	if(battery_module && battery_module.battery)
		return battery_module.battery.give(amount)
	return 0

/obj/item/mainboard/get_cell()
	var/obj/item/computer_hardware/battery/battery_module = all_components[MC_CELL]
	return battery_module?.get_cell()

// Used in following function to reduce copypaste
/obj/item/mainboard/proc/power_failure()
...
/obj/item/mainboard/proc/check_power_override()
	return FALSE
