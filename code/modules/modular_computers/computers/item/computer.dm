...
/obj/item/modular_computer
	...
	var/base_active_power_usage = 10 W	// Aurs per second, Power usage when the computer is on. Remember hardware can use power too.
	var/base_idle_power_usage = 5 W	// Aurs per second, Power usage when the computer is turned off
