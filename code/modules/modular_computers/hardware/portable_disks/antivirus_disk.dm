...
/obj/item/computer_hardware/hard_drive/role/antivirus/on_install(obj/item/modular_computer/install_into, mob/living/user)
	...
	if(drive.virus_defense >= virus_defense)
		...
		balloon_alert_to_viewers("<font color='#00f7ff'>NTOS Virus Buster Lvl-[drive.virus_defense]</font> sucessefuly installed. Your device is now <font color='#00ff2a'>SAFE!</font>")
