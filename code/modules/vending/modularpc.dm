/obj/machinery/vending/modularpc
	...
	products = list(/obj/item/modular_computer/laptop = 3,		// This needs to be converted to a tablet subtype
					...
					/obj/item/computer_hardware/hard_drive/portable = 8,		// No idea yet
					...
					/obj/item/computer_hardware/processor_unit/small = 4,		// TELEPORTs like fucking trough walls DONE (SHOULD ADD BATTERY COST)
	...
	premium = list(/obj/item/colorizer/tablet/gw = 2,
					...
					/obj/item/computer_hardware/recharger/APC = 2,				// Possible power sink oportunity here!!!!
					/obj/item/computer_hardware/radio_card = 1,					// The fuck is a radio card?
					/obj/item/paicard = 2)
	contraband = list(/obj/item/computer_hardware/card_slot/secondary = 1,		// No idea....
