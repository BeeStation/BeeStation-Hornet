...
/obj/item/paper/ui_status(mob/user,/datum/ui_state/state)
	...
	if(!user.can_read(src))
		return UI_CLOSE
	if(in_contents_of(/obj/machinery/door/airlock) || in_contents_of(/obj/structure/bigDelivery) || in_contents_of(/obj/item/smallDelivery || in_contents_of(/obj/item/clipboard)))
...
/obj/item/paper/can_interact(mob/user)
	if(in_contents_of(/obj/machinery/door/airlock) || in_contents_of(/obj/structure/bigDelivery) || in_contents_of(/obj/item/smallDelivery))
		return TRUE
	return ..()
