...
/obj/machinery/faxmachine/attack_hand(mob/living/user)
	...
	var/msg = capped_multiline_input(src, "Enter a message to be faxed to [associates]")
	...
	usr.log_talk(msg, LOG_SAY, tag = "message to [associates]")
	deadchat_broadcast("<span class='deadsay'><span class='name'>[usr.real_name]</span> has messaged [associates], \"[msg]\" at <span class='name'>[get_area_name(usr, TRUE)]</span>.</span>", usr)
