...
/obj/structure/chrono_field/process(delta_time)
	...
	if(timetokill > initial(timetokill))
		...
		to_chat(world, span_notice("As the last vestiges of their being are erased from time, all memories of [captured.real_name] that you might have had fade from your mind!"))
