...
/obj/item/seeds/cotton/durathread
	...
	desc = "A pack of seeds that'll grow into an extremely durable thread that could easily rival plasteel if woven properly. In its woven state, it is incredibly effectivev at resisting high-energy ballistic attacks making it sought after by organisations that specialise in personal defense."
