	...
	if(proximity_flag && ishuman(target))
		...
		if(inert)
			...
			if(HAS_TRAIT(H, TRAIT_NECROPOLIS_INFECTED))
				...
				to_chat(H, "<span class='userdanger'>You feel the grasping tendrils of taint within you strengthen their grip. You are powerless to resist the temptation to give in for long...</span>")
