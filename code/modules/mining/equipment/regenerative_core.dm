...
/obj/item/organ/internal/regenerative_core/mob_insert(mob/living/carbon/target_carbon, special, movement_flags)
	. = ..()
...
/obj/item/organ/internal/regenerative_core/mob_remove(mob/living/carbon/M, special)
	if(!inert && !special)
...
/obj/item/organ/internal/regenerative_core/update_overlays()
	. = ..()
	if(!inert && !preserved)
		. += "legion_soul_crackle"
