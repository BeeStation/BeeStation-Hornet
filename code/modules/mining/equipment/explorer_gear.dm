...
/obj/item/clothing/suit/hooded/explorer
	...
	armor = list(MELEE = 30,  BULLET = 20, LASER = 20, ENERGY = 20, BOMB = 50, BIO = 100, RAD = 50, FIRE = 50, ACID = 50, STAMINA = 20, BLEED = 30, WOUND = 10)
	allowed = list(
		/obj/item/flashlight,
...
/obj/item/clothing/head/hooded/explorer
	...
	armor = list(MELEE = 30,  BULLET = 20, LASER = 20, ENERGY = 20, BOMB = 50, BIO = 100, RAD = 50, FIRE = 50, ACID = 50, STAMINA = 20, BLEED = 30, WOUND = 5)
	resistance_flags = FIRE_PROOF
	high_pressure_multiplier = 0.4
...
/obj/item/clothing/suit/space/hostile_environment
	...
	slowdown = 0
	armor = list(MELEE = 70,  BULLET = 40, LASER = 20, ENERGY = 20, BOMB = 50, BIO = 100, RAD = 100, FIRE = 100, ACID = 100, STAMINA = 40, BLEED = 50, WOUND = 10)
