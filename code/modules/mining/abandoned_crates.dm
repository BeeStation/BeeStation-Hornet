...
/obj/structure/closet/crate/secure/loot/Initialize()
	...
	switch(loot)
		...
		if(113)//Lite, mid and heavy are Snowndin lootdrops. Putting a spawner into the chest result things spawn on top of it instead of inside.
			switch(pickweight(list("heavystuff1" = 1, "heavystuff2" = 1, "heavystuff3" = 1, "heavystuff4" = 1, "heavystuff5" = 1, "heavystuff6" = 1, "heavystuff7" = 1, "heavystuff8" = 1)))
				if("heavystuff1")
		...
		if(123)
			new /obj/item/storage/box/syndie_kit/plasmachameleon(src)
		if(124)
			new /obj/item/radio/headset/chameleon/bowman(src)
			new /obj/item/clothing/shoes/chameleon/noslip(src)
			new /obj/item/reagent_containers/spray/waterflower(src)
		if(125)
		...
		if(127)
			...
			new /obj/item/storage/box/monkeycubes(src)
		if(128)
			switch(pickweight(list("midstuff1" = 1, "midstuff2" = 1, "midstuff3" = 1, "midstuff4" = 1, "midstuff5" = 2, "midstuff6" = 1, "midstuff7" = 2, "midstuff8" = 1, "midstuff9" = 1)))
				if("midstuff1")
				...
				if("midstuff3")
					new /obj/item/dnainjector/lasereyesmut(src)
				if("midstuff4")
