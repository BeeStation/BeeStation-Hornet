...
/obj/structure/closet/crate/secure/loot/Initialize()
	...
	switch(loot)
		...
		if(107)
			...
			new /obj/item/reagent_containers/glass/bottle/tuberculosis(src)
			new /obj/item/reagent_containers/glass/bottle/tuberculosiscure(src)
			new /obj/item/reagent_containers/glass/bottle/wizarditis(src)
		...
		if(113)//Lite, mid and heavy are Snowndin lootdrops. Putting a spawner into the chest result things spawn on top of it instead of inside.
			switch(pickweight(list("heavystuff1", "heavystuff2", "heavystuff3", "heavystuff4", "heavystuff5", "heavystuff6", "heavystuff7", "heavystuff8")))
				...
				if("heavystuff5")
					new /obj/item/grenade/clusterbuster/spawner_manhacks(src)
				if("heavystuff6")
