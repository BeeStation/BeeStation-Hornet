...
/obj/machinery/vendor/mining
	...
	prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/vendor_equipment("P-KA Upgrade: Hybrid Radius",	/obj/item/borg/upgrade/modkit/aoe/turfs/andmobs,					3000),
		new /datum/data/vendor_equipment("P-KA Upgrade: Repeater",		/obj/item/borg/upgrade/modkit/cooldown/repeater,					3000),
		new /datum/data/vendor_equipment("P-KA Upgrade: Resonator",		/obj/item/borg/upgrade/modkit/resonator_blasts,						4000),
		new /datum/data/vendor_equipment("P-KA Upgrade: Death Syphon",	/obj/item/borg/upgrade/modkit/bounty,								4000),
		new /datum/data/vendor_equipment("P-KA Upgrade: Lifesteal",		/obj/item/borg/upgrade/modkit/lifesteal,							5000),
