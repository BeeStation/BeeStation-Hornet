...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Upgraded Mask",				/obj/item/clothing/mask/gas/welding/up,								500),
		new /datum/data/mining_equipment("Combat Gloves",				/obj/item/clothing/gloves/combat,									4000),
		...
		new /datum/data/mining_equipment("Upgraded Resonator",			/obj/item/resonator/upgraded,										1000),
		...
		new /datum/data/mining_equipment("Suit Jetpack Upgrade",		/obj/item/tank/jetpack/suit,										2000),
		new /datum/data/mining_equipment("Suit Speed Upgrade",			/obj/item/slimepotion/speed,										4000),
		new /datum/data/mining_equipment("Suit Stormproofing Upgrade",	/obj/item/slimepotion/fireproof,									4000),
		new /datum/data/mining_equipment("Suit Spaceproofing Upgrade",	/obj/item/slimepotion/spaceproof,									6000),
		new /datum/data/mining_equipment("Suit Lavaproofing Upgrade",	/obj/item/slimepotion/lavaproof,									8000),
		new /datum/data/mining_equipment("Expanded E. Oxygen Tank",		/obj/item/tank/internals/emergency_oxygen/engi,						1000),
		new /datum/data/mining_equipment("Double Ex. E. Oxygen Tank",	/obj/item/tank/internals/emergency_oxygen/double,					2000),
		new /datum/data/mining_equipment("Ultimate Oxygen Tank",		/obj/item/tank/internals/emergency_oxygen/magic_oxygen,				20000),
		...
		new /datum/data/mining_equipment("Bible",						/obj/item/storage/book/bible,										200),
