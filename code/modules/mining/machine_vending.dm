...
/obj/machinery/vendor/mining/proc/RedeemVoucher(obj/item/mining_voucher/voucher, mob/redeemer)
	var/items = list("Asteroid Miner Kit", "Crusher Kit", "Survival Capsule and Explorer's Webbing", "Minebot Kit", "Mining Conscription Kit")
	...
	switch(selection)
		if("Survivalist Kit")
			new /obj/item/survivalcapsule/encampment(drop_location)
