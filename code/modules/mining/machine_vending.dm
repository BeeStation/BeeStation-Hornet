...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/mining_equipment("Plasma Cutter",				/obj/item/gun/energy/plasmacutter,									1500),
		...
		new /datum/data/mining_equipment("Hardsuit Jetpack Upgrade",	/obj/item/tank/jetpack/suit,										1000),
		...
		new /datum/data/mining_equipment("Margherita Pizza",			/obj/item/pizzabox/margherita,										200),
		new /datum/data/mining_equipment("Mushroom Pizza",				/obj/item/pizzabox/mushroom,										200),
		new /datum/data/mining_equipment("Meat Pizza",					/obj/item/pizzabox/meat,											200),
		new /datum/data/mining_equipment("Vegetable Pizza",				/obj/item/pizzabox/vegetable,										200),
