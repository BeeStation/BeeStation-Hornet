...
/obj/machinery/vendor/mining
	...
	prize_list = list( //if you add something to this, please, for the love of god, sort it by price/type. use tabs and not spaces.
		...
		new /datum/data/vendor_equipment("Minebot Upgrade: Ore Scoop",	/obj/item/mine_bot_upgrade/ore_pickup,								400),
		new /datum/data/vendor_equipment("Minebot Upgrade: Medical",	/obj/item/mine_bot_upgrade/medical,									400),
