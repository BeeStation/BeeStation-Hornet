...
/*		new /datum/data/vendor_equipment("Resonator",					/obj/item/resonator,												750),
		new /datum/data/vendor_equipment("Upgraded Resonator",			/obj/item/resonator/upgraded,										1500),	These items are just a waste of space overall, but kept them here in case someone wants to re-add them. 
		new /datum/data/vendor_equipment("Silver Pickaxe",				/obj/item/pickaxe/silver,											500),	Completely deleted the stacks of 1 and 10 mining lights however. When 30 only costs 150 points, there was no reason to waste screen space on two other options. 
...
/obj/machinery/vendor/mining/proc/RedeemVoucher(obj/item/mining_voucher/voucher, mob/redeemer)
	var/items = list("Survival Capsule and Explorer's Webbing", "Resonator Kit", "Minebot Kit", "Extraction and Rescue Kit", "Crusher Kit", "Mining Conscription Kit", "Asteroid Miner Kit")
