...
/obj/machinery/keycard_auth/proc/trigger_event(confirmer)
	...
	deadchat_broadcast("<span class='srt_deadchat deadsay'><span class='name'>[triggerer]</span> triggered [event] at <span class='name'>[A1.name]</span>.</span>", triggerer)

	var/area/A2 = get_area(confirmer)
	deadchat_broadcast("<span class='srt_deadchat deadsay'><span class='name'>[confirmer]</span> confirmed [event] at <span class='name'>[A2.name]</span>.</span>", confirmer)
	switch(event)
