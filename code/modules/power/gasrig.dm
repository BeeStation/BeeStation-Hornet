...
#undef GASRIG_RETRACTOR_SPEED
#undef GASRIG_MAX_DEPTH
#undef GASRIG_DEPTH_CHANGE_SPEED
#undef GASRIG_DEPTH_SHIELD_DAMAGE_MULTIPLIER
#undef GASRIG_SHIELD_MOL_LOG_MULTIPLER
#undef GASRIG_MODE_NORMAL
#undef GASRIG_MODE_REPAIR
#undef GASRIG_MODE_OVERPRESSURE
#undef GASRIG_DEPTH_TEMP_MULTIPLER
#undef GASRIG_FRACKING_PRESSURE_MULTIPLER
#undef GASRIG_DEFAULT_OUTPUT_PRESSURE
#undef GASRIG_MAX_HEALTH
#undef GASRIG_O2
#undef GASRIG_N2
#undef GASRIG_PLAS
#undef GASRIG_CO2
