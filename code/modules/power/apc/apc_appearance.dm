...
/obj/machinery/power/apc/proc/flicker_hacked_icon()
	...
	animate(hacker_image, 1 SECONDS)
	animate(0.1 SECONDS, alpha = 0, easing = JUMP_EASING)
	animate(0.3 SECONDS, alpha = 255, easing = JUMP_EASING)
	animate(0.1 SECONDS, alpha = 0, easing = JUMP_EASING)
	animate(0.1 SECONDS, alpha = 255, easing = JUMP_EASING)
	animate(0.1 SECONDS, alpha = 0, easing = JUMP_EASING)
	animate(0.2 SECONDS, alpha = 255, easing = JUMP_EASING)
	animate(0.1 SECONDS, alpha = 0, easing = JUMP_EASING)
