...
/datum/sm_delam/cascade/on_select(obj/machinery/power/supermatter_crystal/sm)
	...
	sm.investigate_log("is heading towards a cascade.", INVESTIGATE_ENGINES)
...
/datum/sm_delam/cascade/on_deselect(obj/machinery/power/supermatter_crystal/sm)
	...
	sm.investigate_log("will no longer cascade.", INVESTIGATE_ENGINES)
...
/datum/sm_delam/cascade/delaminate(obj/machinery/power/supermatter_crystal/sm)
	...
	sm.investigate_log("triggered a cascade delam.", INVESTIGATE_ENGINES)
...
/datum/sm_delam/cascade/proc/announce_cascade(obj/machinery/power/supermatter_crystal/sm)
	...
	priority_announce(
		"Attention: Long range anomaly scans indicate abnormal quantities of harmonic flux originating from a subject within [station_name()], a resonance collapse may occur.",
