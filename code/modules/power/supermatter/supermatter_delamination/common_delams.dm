...
/datum/sm_delam/singularity/can_select(obj/machinery/power/supermatter_crystal/sm)
	return (sm.absorbed_gasmix.total_moles() >= MOLE_PENALTY_THRESHOLD / max(((world.time - sm.activation_time) / SUPERMATTER_CRITICAL_TIME), 1))
...
/datum/sm_delam/singularity/delaminate(obj/machinery/power/supermatter_crystal/sm)
	...
	sm.investigate_log("triggered a singularity delam.", INVESTIGATE_ENGINES)
...
/datum/sm_delam/tesla/can_select(obj/machinery/power/supermatter_crystal/sm)
	return (sm.internal_energy > POWER_PENALTY_THRESHOLD / max(((world.time - sm.activation_time) / SUPERMATTER_CRITICAL_TIME), 1))
...
/datum/sm_delam/tesla/delaminate(obj/machinery/power/supermatter_crystal/sm)
	...
	sm.investigate_log("triggered a tesla delam.", INVESTIGATE_ENGINES)
...
/datum/sm_delam/explosive/delaminate(obj/machinery/power/supermatter_crystal/sm)
	...
	sm.investigate_log("triggered a normal delam.", INVESTIGATE_ENGINES)
