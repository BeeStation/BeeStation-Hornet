...
/obj/machinery/power/supermatter_crystal/process_atmos()
	...
	if(power > POWER_PENALTY_THRESHOLD || damage > damage_penalty_point)
		...
		if(prob(5))
			supermatter_anomaly_gen(src, ANOMALY_TRAP, rand(5, 10))
		if(prob(5))
			supermatter_anomaly_gen(src, ANOMALY_CLOWN, rand(5, 10))
		if(prob(5))
			supermatter_anomaly_gen(src, ANOMALY_MIME, rand(5, 10))
		if(prob(5))
			supermatter_anomaly_gen(src, ANOMALY_BABEL, rand(5, 10))
		if(prob(5))
			supermatter_anomaly_gen(src, ANOMALY_MONKEY, rand(5, 10))
		if(prob(5))
			supermatter_anomaly_gen(src, ANOMALY_CARP, rand(5, 10))
		if(prob(5))
			supermatter_anomaly_gen(src, ANOMALY_NUCLEAR, rand(5, 10))
		if(prob(5))
			supermatter_anomaly_gen(src, ANOMALY_GLITCH, rand(5, 10))
		...
		if(power > SEVERE_POWER_PENALTY_THRESHOLD && prob(2) || prob(0.3) && power > POWER_PENALTY_THRESHOLD)
			supermatter_anomaly_gen(src, ANOMALY_EXO, rand(5, 10))
		if(power > SEVERE_POWER_PENALTY_THRESHOLD && prob(2) || prob(0.3) && power > POWER_PENALTY_THRESHOLD)
			supermatter_anomaly_gen(src, ANOMALY_ENDO, rand(5, 10))
...
/proc/supermatter_anomaly_gen(turf/anomalycenter, type = ANOMALY_FLUX, anomalyrange = 5, has_weak_lifespan = TRUE)
	...
	switch(type)
		...
		if(ANOMALY_EXO)
			new /obj/effect/anomaly/exo(local_turf, has_weak_lifespan ? rand(150, 250) : null, faked_reality_spawn)
		if(ANOMALY_VORTEX)
			new /obj/effect/anomaly/bhole(local_turf, 20, faked_reality_spawn)
		if(ANOMALY_ENDO)
			new /obj/effect/anomaly/endo(local_turf, has_weak_lifespan ? rand(150, 250) : null, faked_reality_spawn)
		if(ANOMALY_CLOWN)
			new /obj/effect/anomaly/clown(local_turf, has_weak_lifespan ? rand(250, 300) : null, faked_reality_spawn)
		if(ANOMALY_MIME)
			new /obj/effect/anomaly/mime(local_turf, has_weak_lifespan ? rand(250, 300) : null, faked_reality_spawn)
		if(ANOMALY_BABEL)
			new /obj/effect/anomaly/babel(local_turf, has_weak_lifespan ? rand(250, 300) : null, faked_reality_spawn)
		if(ANOMALY_TRAP)
			new /obj/effect/anomaly/trap(local_turf, has_weak_lifespan ? rand(250, 300) : null, faked_reality_spawn)
		if(ANOMALY_MONKEY)
			new /obj/effect/anomaly/monkey(local_turf, has_weak_lifespan ? rand(250, 300) : null, faked_reality_spawn)
		if(ANOMALY_CARP)
			new /obj/effect/anomaly/carp(local_turf, has_weak_lifespan ? rand(250, 300) : null, faked_reality_spawn)
		if(ANOMALY_NUCLEAR)
			new /obj/effect/anomaly/nuclear(local_turf, has_weak_lifespan ? rand(150, 250) : null, faked_reality_spawn)
		if(ANOMALY_GLITCH)
			new /obj/effect/anomaly/glitch(local_turf, has_weak_lifespan, 20, faked_reality_spawn)
