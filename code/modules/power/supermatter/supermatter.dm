...
/proc/supermatter_anomaly_gen(turf/anomalycenter, type = ANOMALY_FLUX, anomalyrange = 5, has_weak_lifespan = TRUE)
	...
	switch(type)
		...
		if(ANOMALY_MIME)
			new /obj/effect/anomaly/mime(local_turf, 10, faked_reality_spawn)
		if(ANOMALY_NUCLEAR)
			new /obj/effect/anomaly/nuclear(local_turf, has_weak_lifespan ? rand(50, 200) : null, faked_reality_spawn)
		if(ANOMALY_GLITCH)
			new /obj/effect/anomaly/glitch(local_turf, 20, faked_reality_spawn)
