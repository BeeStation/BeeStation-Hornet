...
#define RADIATION_INTENSITY_AT_FULL_INTEGRITY 0.03
#define RADIATION_INTENSITY_AT_ZERO_INTEGRITY 0.4
...
/proc/supermatter_anomaly_gen(turf/anomalycenter, type = FLUX_ANOMALY, anomalyrange = 5, has_changed_lifespan = TRUE)
	...
	switch(type)
		if(ANOMALY_FLUX)
			var/explosive = has_changed_lifespan ? ANOMALY_FLUX_NO_EXPLOSION : ANOMALY_FLUX_LOW_EXPLOSIVE
