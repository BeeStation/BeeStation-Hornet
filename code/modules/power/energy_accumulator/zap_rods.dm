...
/obj/machinery/power/energy_accumulator/tesla_coil/examine(mob/user)
	...
	if(in_range(user, src) || isobserver(user))
		. += "<span class='notice'>The status display reads:<br>" + \
			...
			"Processing <b>[display_power(get_power_output())]</b>.</span>"
...
/obj/machinery/power/energy_accumulator/grounding_rod/examine(mob/user)
	...
	if(in_range(user, src) || isobserver(user))
		. += "<span class='notice'>The status display reads:<br>" + \
			...
			"This energy would sustainably release <b>[display_power(get_power_output())]</b>.</span>"
