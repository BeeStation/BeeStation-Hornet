...
/obj/machinery/gravity_generator/main/proc/setup_parts()
	...
	var/list/spawn_turfs = block(locate(our_turf.x - 1, our_turf.y + 2, our_turf.get_z_level()), locate(our_turf.x + 1, our_turf.y, our_turf.get_z_level()))
	var/count = 10
...
/obj/machinery/gravity_generator/main/proc/shake_everyone()
	...
	for(var/i in GLOB.mob_list)
		var/mob/M = i
		if(M.get_z_level() != z && !(ztrait && SSmapping.level_trait(z, ztrait) && SSmapping.level_trait(M.z, ztrait)))
			continue
...
/obj/machinery/gravity_generator/main/proc/gravity_in_level()
	...
	if(GLOB.gravity_generators["[T.get_z_level()]"])
		return length(GLOB.gravity_generators["[T.get_z_level()]"])
	return 0
