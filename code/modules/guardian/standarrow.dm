...
/obj/item/stand_arrow/proc/get_stand(mob/living/carbon/H, datum/guardian_stats/stats)
	var/list/mob/dead/observer/candidates = pollGhostCandidates("Do you want to play as the Guardian Spirit of [H.real_name]?", ROLE_KEY_HOLOPARASITE, null, FALSE, 100, POLL_IGNORE_HOLOPARASITE)
