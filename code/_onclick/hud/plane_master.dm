...
/atom/movable/screen/plane_master/game_world/backdrop(mob/mymob)
	clear_filters()
	if(istype(mymob) && mymob.client && mymob.client.prefs && mymob.client.prefs.toggles_2 & TOGGLE_2_AMBIENT_OCCLUSION)
...
/atom/movable/screen/plane_master/runechat/backdrop(mob/mymob)
	filters = list()
	if(istype(mymob) && mymob.client?.prefs?.toggles_2 & TOGGLE_2_AMBIENT_OCCLUSION)
		add_filter("AO", 1, drop_shadow_filter(x = 0, y = -2, size = 4, color = "#04080FAA"))
