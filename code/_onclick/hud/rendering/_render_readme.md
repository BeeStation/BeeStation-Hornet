...
1. Transforms are very slow on clientside. This is not usually noticeable, but if you start using large amounts of them it will grind you to a halt quickly, regardless of whether its on overlays or objs
