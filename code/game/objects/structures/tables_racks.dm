...
/obj/structure/table/Bumped(mob/living/carbon/human/H)
	...
	if(!HAS_TRAIT(H, TRAIT_ALWAYS_STUBS) && (H.shoes || feetCover || !(H.mobility_flags & MOBILITY_STAND) || HAS_TRAIT(H, TRAIT_PIERCEIMMUNE) || H.m_intent == MOVE_INTENT_WALK) || HAS_TRAIT(H, TRAIT_NEVER_STUBS))
		return
