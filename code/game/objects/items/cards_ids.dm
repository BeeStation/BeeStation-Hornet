...
/obj/item/card/id/temp/science
	...
	access = list(ACCESS_TOX, ACCESS_EXPLORATION, ACCESS_TOX_STORAGE, ACCESS_MECH_SCIENCE, ACCESS_MECH_MINING,
						ACCESS_MECH_MEDICAL, ACCESS_MECH_ENGINE, ACCESS_RESEARCH, ACCESS_ROBOTICS, ACCESS_XENOBIOLOGY,
						ACCESS_NETWORK, ACCESS_RD_SERVER)

/obj/item/card/id/temp/medbay
	icon_state = "rawmedical"
	assignment = JOB_NAME_CHIEFMEDICALOFFICER
	access = list(ACCESS_MEDICAL, ACCESS_MORGUE, ACCESS_GENETICS, ACCESS_CLONING, ACCESS_CHEMISTRY, ACCESS_VIROLOGY,
						ACCESS_SURGERY, ACCESS_MECH_MEDICAL)

/obj/item/card/id/temp/cargo
	icon_state = "rawcargo"
	assignment = JOB_NAME_QUARTERMASTER
	access = list(ACCESS_MAILSORTING, ACCESS_CARGO, ACCESS_MINING, ACCESS_MECH_MINING, ACCESS_MINING_STATION,
						ACCESS_MINERAL_STOREROOM, ACCESS_VAULT, ACCESS_AUX_BASE, ACCESS_EXPLORATION)


/obj/item/card/id/temp/security
	icon_state = "rawsecurity"
	assignment = JOB_NAME_HEADOFSECURITY
	access = list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_SEC_RECORDS, ACCESS_BRIG, ACCESS_BRIGPHYS, ACCESS_ARMORY,
						ACCESS_COURT, ACCESS_WEAPONS, ACCESS_MECH_SECURITY, ACCESS_FORENSICS_LOCKERS)
...
/obj/item/card/id/temp/engineering
	...
	access = list(ACCESS_ENGINE, ACCESS_ENGINE_EQUIP, ACCESS_TECH_STORAGE,
			            ACCESS_EXTERNAL_AIRLOCKS, ACCESS_ATMOSPHERICS, ACCESS_CONSTRUCTION, ACCESS_MECH_ENGINE,
						ACCESS_TCOMSAT)

/obj/item/card/id/temp/service
	icon_state = "rawservice"
	assignment = JOB_NAME_HEADOFPERSONNEL
	access = list(ACCESS_EVA, ACCESS_HEADS, ACCESS_BAR, ACCESS_JANITOR, ACCESS_CREMATORIUM, ACCESS_KITCHEN,
						ACCESS_CARGO, ACCESS_MAILSORTING, ACCESS_QM, ACCESS_HYDROPONICS, ACCESS_LAWYER, ACCESS_THEATRE,
						ACCESS_CHAPEL_OFFICE, ACCESS_LIBRARY, ACCESS_MINING, ACCESS_VAULT, ACCESS_MINING_STATION,
						ACCESS_HOP, ACCESS_GATEWAY, ACCESS_MINERAL_STOREROOM, ACCESS_AUX_BASE)
