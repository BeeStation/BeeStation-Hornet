...
/obj/item/storage/box/syndicate/bundle_A/PopulateContents()
	switch (pickweight(list("recon" = 2, "bloodyspai" = 2, "stealth" = 2, "screwed" = 2, "guns" = 2, "murder" = 2, "implant" = 1, "hacker" = 2, "sniper" = 1, "metaops" = 1)))
		if("recon")
			...
			new /obj/item/grenade/syndieminibomb(src) // ~2 tc each?
		...
		if("murder")
			...
			new /obj/item/clothing/glasses/thermal/syndi(src)
			new /obj/item/card/emag(src)
			new /obj/item/storage/pill_bottle/maniac(src)
		...
		if("lordsingulo")
			new /obj/item/grenade/plastic/c4(src) // if emag and toolbox fail
		...
		if("sniper") //This shit is unique so can't really balance it around tc, also no silencer because getting killed without ANY indicator on what killed you sucks
			...
			new /obj/item/ammo_box/magazine/sniper_rounds/penetrator(src) // 2 shots to kill, and you cant print this ammo at all you cant even kill 3 people with 1 magazine
			new /obj/item/ammo_box/magazine/sniper_rounds/penetrator(src)
			new /obj/item/ammo_box/magazine/sniper_rounds/penetrator(src)
			new /obj/item/clothing/glasses/thermal/syndi(src)
			new /obj/item/clothing/gloves/color/latex/nitrile(src)
			new /obj/item/clothing/mask/gas/clown_hat(src)
			new /obj/item/pen/fountain/captain/agent(src)
			new /obj/item/clothing/under/suit_jacket/really_black(src)
...
/obj/item/storage/box/syndicate/bundle_B/PopulateContents()
	switch (pickweight(list( "bond" = 2, "ninja" = 1, "darklord" = 1, "white_whale_holy_grail" = 2, "mad_scientist" = 2, "bee" = 2, "mr_freeze" = 2)))
		...
		if("darklord")
			...
			new /obj/item/clothing/suit/hooded/chaplain_hoodie/darklord(src) // only so people don't ditch the hoodie because it isn't armoured
			new /obj/item/card/id/syndicate(src)
		...
		if("white_whale_holy_grail") //Unique items that don't appear anywhere else
			...
			new /obj/item/grenade/spawnergrenade/spesscarp(src) // carps galore
		...
		if("mad_scientist")
			...
			new /obj/item/grenade/clusterbuster/random(src) // many of these can be useless or only mildly good so the comment saying they are worth 10 tc gave me a laugh
			new /obj/item/grenade/clusterbuster/random(src)
			new /obj/item/grenade/clusterbuster/random(src)
			new /obj/item/grenade/clusterbuster/random(src)
		...
		if("bee")
			...
			new /obj/item/reagent_containers/glass/bottle/beesease(src) // not very strong but fits the theme
			new /obj/item/melee/beesword(src) // still priceless
		...
		if("mr_freeze")
			...
			new /obj/item/gun/energy/temperature/mrfreeze(src)
			new /obj/item/melee/transforming/energy/sword/freeze(src) //I changed very little here but should be a bit more thematic
