...
/obj/item/implant/bloodbrother/activate()
	...
	if(linked_implants.len)
		...
		var/my_message = "<font color=\"[implant_colour]\"><b><i>[imp_in.real_name]:</i></b></font> [input]" //add sender, color source with syndie color
		var/ghost_message = "<font color=\"[implant_colour]\"><b><i>[imp_in.real_name] -> Blood Brothers:</i></b></font> [input]"
