...
/obj/item/pinpointer/crew/proc/trackable(mob/living/carbon/human/H)
	var/turf/here = get_turf(src)
	if((H.get_z_level() == 0 || H.get_z_level() == here.get_z_level() || (is_station_level(here.get_z_level()) && is_station_level(H.get_z_level()))) && istype(H.w_uniform, /obj/item/clothing/under))
		...
		return (H.get_z_level() != 0 || (there && ((there.get_z_level() == here.get_z_level()) || (is_station_level(there.get_z_level()) && is_station_level(here.get_z_level())))))
