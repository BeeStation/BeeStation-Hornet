...
/obj/item/tank/internals/anesthetic/populate_gas()
	...
	air_contents.set_moles(GAS_NO2, (3*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C) * N2STANDARD)
...
/obj/item/tank/internals/emergency_oxygen/clown/populate_gas()
	...
	air_contents.set_moles(GAS_NO2, (0.01*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C))
