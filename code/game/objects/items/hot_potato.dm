...
/obj/item/hot_potato
	name = "hot potato"
	desc = "A label on the side of this potato reads \"Product of DonkCo Service Wing. Activate far away from populated areas. Device will only attach to sapient creatures.\"" +  span_boldnotice("You can attack anyone with it to force it on them instead of yourself!")
...
/obj/item/hot_potato/harmless/toy
	desc = "A label on the side of this potato reads \"Product of DonkCo Toys and Recreation department.\" " + span_boldnotice("You can attack anyone with it to put it on them instead, if they have a free hand to take it!")
	sticky = FALSE
	reusable = TRUE
