/obj/item/ai_module/zeroth/transmit_laws(datum/ai_laws/law_datum, mob/sender, overflow)
	if(law_datum.owner)
...
/obj/item/ai_module/zeroth/onehuman/transmit_laws(datum/ai_laws/law_datum, mob/sender, overflow)
	if(..())
