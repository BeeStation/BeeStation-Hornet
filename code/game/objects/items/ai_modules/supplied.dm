...
/obj/item/ai_module/supplied/transmit_laws(datum/ai_laws/law_datum, mob/sender)
...
/obj/item/ai_module/supplied/safeguard/transmit_laws(datum/ai_laws/law_datum, mob/sender, overflow)
	..()
	return targetName
