...
/obj/item/ai_module/remove/attack_self(mob/user)
	...
	if(!lawpos || QDELETED(user) || QDELETED(src))
		return
...
/obj/item/ai_module/remove/transmit_laws(datum/ai_laws/law_datum, mob/sender, overflow)
	..()
	if(law_datum.owner)
...
/obj/item/ai_module/reset/transmit_laws(datum/ai_laws/law_datum, mob/sender, overflow)
	..()
	if(law_datum.owner)
...
/obj/item/ai_module/reset/purge/transmit_laws(datum/ai_laws/law_datum, mob/sender, overflow)
	..()
	if(law_datum.owner)
