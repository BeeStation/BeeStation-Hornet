...
//CE rcd, slightly better but can be rolled for traitor objectives. This was made to give CEs an unique item like other heads and to compensate for removing all of their advanced tools roundstart
