...
/obj/item/melee/baton/Initialize(mapload)
	...
	if(active_force != 0)
		offensive_notes = "\nVarious interviewed security forces report being able to beat criminals into exhaustion with only <span class='warning'>[round(100 / active_force, 0.1)] hit\s!</span>"
