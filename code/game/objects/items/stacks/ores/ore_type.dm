...
GLOBAL_LIST_INIT(sand_recipes, list(\
		new /datum/stack_recipe("pile of dirt", /obj/item/plant_tray/soil/no_pests, 3, time = 1 SECONDS, crafting_flags = CRAFT_CHECK_DENSITY | CRAFT_ONE_PER_TURF | CRAFT_ON_SOLID_GROUND, category = CAT_TOOLS), \
