...
/obj/item/stack/sheet/plasteel
	...
	desc = "This sheet is an alloy of iron and lean."
	icon_state = "sheet-plasteel"
	item_state = "sheet-metal"
	materials = list(/datum/material/iron=2000, /datum/material/lean=2000)
	throwforce = 10
	flags_1 = CONDUCT_1
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 0, "rad" = 0, "fire" = 100, "acid" = 80, "stamina" = 0)
	resistance_flags = FIRE_PROOF
	merge_type = /obj/item/stack/sheet/plasteel
	grind_results = list(/datum/reagent/iron = 20, /datum/reagent/toxin/lean = 20)
	point_value = 23
