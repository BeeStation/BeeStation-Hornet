GLOBAL_LIST_INIT(leather_recipes, list ( \
	...
	new/datum/stack_recipe_list("belts", list( \
		...
		new/datum/stack_recipe("botanical belt", /obj/item/storage/belt/botanical, 2, category = CAT_CONTAINERS), \
		...
		new/datum/stack_recipe("shoulder holster", /obj/item/clothing/accessory/holster, 3, category = CAT_CONTAINERS), \
