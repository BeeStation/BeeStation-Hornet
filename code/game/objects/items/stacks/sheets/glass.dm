...
/obj/item/stack/sheet/rglass
	...
	materials = list(MAT_IRON=MINERAL_MATERIAL_AMOUNT * 0.5, MAT_GLASS=MINERAL_MATERIAL_AMOUNT)
...
/obj/item/stack/sheet/plasmarglass
	...
	materials = list(MAT_PLASMA=MINERAL_MATERIAL_AMOUNT * 0.5, MAT_GLASS=MINERAL_MATERIAL_AMOUNT, MAT_IRON = MINERAL_MATERIAL_AMOUNT * 0.5,)
