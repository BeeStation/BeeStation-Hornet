...
GLOBAL_LIST_INIT(abductor_recipes, list ( \
	new/datum/stack_recipe("alien bed", /obj/structure/bed/abductor, 2, one_per_turf = TRUE, on_floor = TRUE, category = CAT_FURNITURE), \
	new/datum/stack_recipe("alien locker", /obj/structure/closet/abductor, 2, one_per_turf = TRUE, on_floor = TRUE, time = 1.5 SECONDS, category = CAT_FURNITURE), \
	new/datum/stack_recipe("alien table frame", /obj/structure/table_frame/abductor, 1, one_per_turf = TRUE, on_floor = TRUE, time = 1.5 SECONDS, category = CAT_FURNITURE), \
	new/datum/stack_recipe("alien airlock assembly", /obj/structure/door_assembly/door_assembly_abductor, 4, one_per_turf = TRUE, on_floor = TRUE, time = 2 SECONDS, category = CAT_DOORS), \
	null, \
