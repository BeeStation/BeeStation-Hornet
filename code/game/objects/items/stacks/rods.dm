GLOBAL_LIST_INIT(rod_recipes, list ( \
	...
	new/datum/stack_recipe("table frame", /obj/structure/table_frame, 2, one_per_turf = 1, on_floor = 1, time = 1 SECONDS), \
	new/datum/stack_recipe("scooter frame", /obj/item/scooter_frame, 10, one_per_turf = 0, time = 2.5 SECONDS), \
	new/datum/stack_recipe("linen bin", /obj/structure/bedsheetbin/empty, 2, one_per_turf = 0, time = 0.5 SECONDS), \
	new/datum/stack_recipe("railing", /obj/structure/railing, 3, window_checks = TRUE, time = 1.8 SECONDS), \ //Why exactly 1.8 seconds? not a clue.
	))
