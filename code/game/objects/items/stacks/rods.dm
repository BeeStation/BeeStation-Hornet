GLOBAL_LIST_INIT(rod_recipes, list ( \
	...
	new/datum/stack_recipe("ladder", /obj/structure/ladder, 10, time = 50, one_per_turf = TRUE, on_floor = TRUE), \
	...
	new/datum/stack_recipe("railing", /obj/structure/railing, 3, time = 20, window_checks = TRUE), \
	))
