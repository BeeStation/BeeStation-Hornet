GLOBAL_LIST_INIT(rod_recipes, list ( \
	...
	new/datum/stack_recipe("ladder", /obj/structure/ladder, 10, time = 30, one_per_turf = TRUE, on_floor = TRUE), \
	new/datum/stack_recipe("table frame", /obj/structure/table_frame, 2, time = 10, one_per_turf = 1, on_floor = 1), \
	new/datum/stack_recipe("scooter frame", /obj/item/scooter_frame, 10, time = 10, one_per_turf = 0), \
	new/datum/stack_recipe("linen bin", /obj/structure/bedsheetbin/empty, 2, time = 5, one_per_turf = 0), \
	new/datum/stack_recipe("railing", /obj/structure/railing, 3, time = 9, window_checks = TRUE), \
	))
