...
/obj/item/airlock_painter/decal/proc/paint_floor(turf/open/floor/target)
	target.AddElement(/datum/element/decal, 'icons/turf/decals.dmi', stored_decal_total, stored_dir, TRUE, color, null, null, alpha)
...
/obj/item/airlock_painter/decal/tile/paint_floor(turf/open/floor/target)
	...
	target.AddElement(/datum/element/decal, 'icons/turf/decals.dmi', source_decal, source_dir, TRUE, stored_color, null, null, stored_alpha)
