...
/obj/effect/decal/cleanable/blood/old/Initialize(mapload, list/datum/disease/diseases)
	...
	if(prob(75))
		var/datum/disease/advance/R = new /datum/disease/advance/random(rand(4, 9), rand(3, 6))
		disease += R
...
/obj/effect/decal/cleanable/blood/gibs/old/Initialize(mapload, list/datum/disease/diseases)
	...
	if(prob(80))
		var/datum/disease/advance/R = new /datum/disease/advance/random(rand(5, 9), rand(3, 6))
		disease += R
