...
/obj/structure/sign/poster/official/moth1
	...
	desc = "This informational poster uses Safety Moth(TM) to tell the viewer not to poison the station donuts. Its signed by 'AspEv'."
	icon_state = "poster36_legit"

/obj/structure/sign/poster/official/moth2
	name = "Safety Moth - BoH"
	desc = "This informational poster uses Safety Moth(TM) to inform the viewer of the dangers of Bags of Holding. Its signed by 'AspEv'."
	icon_state = "poster37_legit"

/obj/structure/sign/poster/official/moth3
	name = "Safety Moth - Hardhats"
	desc = "This informational poster uses Safety Moth(TM) to tell the viewer to wear hardhats in cautious areas. It's like a lamp for your head! Its signed by 'Aspev'."
	icon_state = "poster38_legit"

/obj/structure/sign/poster/official/moth4
	name = "Safety Moth - Smokey?"
	desc = "This informational poster uses Safety Moth(TM) to promote safe handling of plasma, or promoting crew to combat plasmafires. We can't tell. Its signed by 'AspEv'."
	icon_state = "poster39_legit"

/obj/structure/sign/poster/official/moth5
	name = "Safety Moth - Piping"
	desc = "This informational poster uses Safety Moth(TM) to tell atmospheric technicians correct types of piping to be used. Proper pipe placement prevents poor preformance! Its signed by 'AspEv'."
	icon_state = "poster40_legit"

/obj/structure/sign/poster/official/moth6
	name = "Safety Moth - Supermatter"
	desc = "This informational poster uses Safety Moth(TM) to promote proper safety equipment when working near a Supermatter Crystal. Its signed by 'AspEv'."
