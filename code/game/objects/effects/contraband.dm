...
/obj/structure/sign/poster/official/moth4
	...
	desc = "This informational poster uses Safety Moth(TM) to promote safe handling of lean, or promoting crew to combat leanfires. We can't tell. It's signed by 'AspEv'."
