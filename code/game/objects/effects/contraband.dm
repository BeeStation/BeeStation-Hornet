...
/obj/structure/sign/poster/official/moth8
	...
	desc = "This informational poster uses Safety Moth(TM) to inform the viewer to help injured/deceased crewmen with their epinephrine injectors. (Original Artist: AsphaltEvidence)"
	icon_state = "poster43_legit"

/obj/structure/sign/poster/official/moth9
	name = "Safety Moth - Delamination Safety Precautions"
	desc = "This informational poster uses Safety Moth(TM) to tell the viewer to hide in lockers when the Supermatter Crystal has delaminated. Running away might be a better strategy. (Original Artist: AsphaltEvidence)"
