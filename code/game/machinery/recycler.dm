...
/obj/machinery/recycler/Initialize()
	AddComponent(/datum/component/material_container, list(MAT_IRON, MAT_GLASS, MAT_PLASMA, MAT_COPPER, MAT_SILVER, MAT_GOLD, MAT_DIAMOND, MAT_URANIUM, MAT_BANANIUM, MAT_TITANIUM, MAT_BLUESPACE, MAT_PLASTIC), INFINITY, FALSE, null, null, null, TRUE)
