...
/obj/machinery/door/airlock
	...
	/* Note mask_file needed some changed due to the change from 513 to 514 thats the reason why the mask
	dmi file for normal airlocks is not 32x32 but 64x64 and for the large airlocks instead of 64x32 its now 96x64 due to the workaround needed to fix this problem.*/
