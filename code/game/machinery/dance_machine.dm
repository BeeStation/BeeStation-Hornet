...
/obj/machinery/jukebox/add_context_self(datum/screentip_context/context, mob/user)
	context.add_left_click_tool_action(anchored ? "Unsecure" : "Secure", TOOL_WRENCH)
	context.add_right_click_action("Toggle Playing")
...
/obj/machinery/jukebox/disco
	...
	req_access = null
	req_one_access = list(ACCESS_HEADS, ACCESS_THEATRE, ACCESS_BAR)
	anchored = FALSE
