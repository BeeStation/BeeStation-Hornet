...
/obj/machinery/drone_dispenser //Most customizable machine 2015
	...
	var/iron_cost = MINERAL_MATERIAL_AMOUNT / 2
	var/glass_cost = MINERAL_MATERIAL_AMOUNT / 2
	/// Energy to draw when processing a new drone shell fresh.
	var/energy_used = 1000
	...
	var/list/dispense_type = list(/obj/effect/mob_spawn/drone)
...
/obj/machinery/drone_dispenser/preloaded
	starting_amount = MINERAL_MATERIAL_AMOUNT * 2.5
...
/obj/machinery/drone_dispenser/syndrone //Please forgive me
	...
	dispense_type = list(/obj/effect/mob_spawn/drone/syndrone)
	...
	starting_amount = MINERAL_MATERIAL_AMOUNT * 12.5
...
/obj/machinery/drone_dispenser/syndrone/badass //Please forgive me
	...
	dispense_type = list(/obj/effect/mob_spawn/drone/syndrone/badass)
...
/obj/machinery/drone_dispenser/snowflake
	...
	dispense_type = list(/obj/effect/mob_spawn/drone/snowflake)
	...
	energy_used = 2000
	starting_amount = MINERAL_MATERIAL_AMOUNT * 5
...
/obj/machinery/drone_dispenser/derelict
	...
	dispense_type = list(/obj/effect/mob_spawn/drone/derelict)
	end_create_message = "dispenses a derelict drone shell."
	iron_cost = MINERAL_MATERIAL_AMOUNT * 5
	glass_cost = MINERAL_MATERIAL_AMOUNT * 2.5
	starting_amount = 0
...
/obj/machinery/drone_dispenser/hivebot
	...
	glass_cost = 0
	energy_used = 0
	cooldown_time = 1 SECONDS //Only 1 second - hivebots are extremely weak
	dispense_type = list(/mob/living/simple_animal/hostile/hivebot)
...
/obj/machinery/drone_dispenser/binoculars
	...
	starting_amount = MINERAL_MATERIAL_AMOUNT * 2.5 //Redudant
	maximum_idle = 1
...
/obj/machinery/drone_dispenser/examine(mob/user)
	...
	if (iron_cost > 0)
		material_requirement_string += "[iron_cost / MINERAL_MATERIAL_AMOUNT] iron sheets "
		if (glass_cost > 0)
			material_requirement_string += "and "
	if (glass_cost > 0)
		material_requirement_string += "[glass_cost / MINERAL_MATERIAL_AMOUNT] glass sheets "
