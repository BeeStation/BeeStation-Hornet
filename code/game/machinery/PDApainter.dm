...
/proc/get_card_style_list(emagged)
	var/static/valid_jobs = list(
		"----Command----", "Command (Custom)",JOB_KEY_CAPTAIN,"Acting Captain",
		"----Service----", "Service (Custom)", JOB_KEY_ASSISTANT, JOB_KEY_HEADOFPERSONNEL, JOB_KEY_BARTENDER, JOB_KEY_COOK,
			JOB_KEY_BOTANIST, JOB_KEY_JANITOR, JOB_KEY_CURATOR,JOB_KEY_CHAPLAIN, JOB_KEY_LAWYER,
			JOB_KEY_CLOWN, JOB_KEY_MIME, JOB_KEY_BARBER, JOB_KEY_STAGEMAGICIAN,
		"----Cargo----","Cargo (Custom)",JOB_KEY_QUARTERMASTER, JOB_KEY_CARGOTECHNICIAN,JOB_KEY_SHAFTMINER,
		"----Engineering----","Engineering (Custom)",JOB_KEY_CHIEFENGINEER, JOB_KEY_STATIONENGINEER, JOB_KEY_ATMOSPHERICTECHNICIAN,
		"----Science----","Science (Custom)",JOB_KEY_RESEARCHDIRECTOR, JOB_KEY_SCIENTIST, JOB_KEY_ROBOTICIST, JOB_KEY_EXPLORATIONCREW,
		"----Medical----","Medical (Custom)",JOB_KEY_CHIEFMEDICALOFFICER, JOB_KEY_MEDICALDOCTOR, JOB_KEY_CHEMIST, JOB_KEY_GENETICIST,
			JOB_KEY_VIROLOGIST, JOB_KEY_PARAMEDIC, JOB_KEY_PSYCHIATRIST,
		"----Security----","Security (Custom)",JOB_KEY_HEADOFSECURITY, JOB_KEY_WARDEN, JOB_KEY_DETECTIVE, JOB_KEY_SECURITYOFFICER,
			JOB_KEY_BRIGPHYSICIAN, JOB_KEY_DEPUTY,
		"----MISC----",JOB_UNASSIGNED,JOB_TITLE_PRISONER
	)
