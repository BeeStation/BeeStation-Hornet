...
/obj/machinery/electrolyzer
	...
	max_integrity = 250
	armor = list("melee" = 0, "bullet" = 0, "laser" = 0, "energy" = 0, "bomb" = 0, "bio" = 100, "rad" = 100, "fire" = 100, "acid" = 10)
...
/obj/machinery/electrolyzer/process()
	...
	removed.set_moles(/datum/gas/water_vapor, removed.get_moles(/datum/gas/water_vapor) - (proportion * 2 * workingPower))
