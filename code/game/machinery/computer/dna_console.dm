...
/obj/machinery/computer/scanconsole
	name = "\improper DNA scanner access console"
	desc = "Scan DNA."
	icon_screen = "dna"
	icon_keyboard = "med_key"
	density = TRUE
	circuit = /obj/item/circuitboard/computer/scanconsole
...
/obj/machinery/computer/scanconsole/process()
	. = ..()
...
/obj/machinery/computer/scanconsole/attackby(obj/item/I, mob/user, params)
...
/obj/machinery/computer/scanconsole/interact(mob/user, special_state)
	if(!connected_scanner?.ignore_id && !allowed(user))
		to_chat(user, "<span class='warning'>Missing required access!</span>")
		return
	..()

/obj/machinery/computer/scanconsole/AltClick(mob/user)
...
/obj/machinery/computer/scanconsole/proc/connect_to_scanner()
...
/obj/machinery/computer/scanconsole/proc/connect_scanner(obj/machinery/dna_scannernew/scanner)
...
/obj/machinery/computer/scanconsole/Initialize(mapload)
	. = ..()
...
/obj/machinery/computer/scanconsole/ui_interact(mob/user, datum/tgui/ui)
...
/obj/machinery/computer/scanconsole/examine(mob/user)
	. = ..()
...
/obj/machinery/computer/scanconsole/ui_assets()
	. = ..() || list()
	. += get_asset_datum(/datum/asset/simple/genetics)

/obj/machinery/computer/scanconsole/ui_data(mob/user)
	var/list/data = list()
...
/obj/machinery/computer/scanconsole/ui_act(action, list/params)
	if(..())
		return TRUE
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/apply_genetic_makeup(type, buffer_slot)
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/scanner_operational()
	if(!connected_scanner)
		return FALSE
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/can_modify_occupant()
...
/**
  ...
  *
	...
	* is queued.
  */
/obj/machinery/computer/scanconsole/proc/on_scanner_close()
	SIGNAL_HANDLER
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/on_scanner_open()
	SIGNAL_HANDLER
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/build_genetic_makeup_list()
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/build_mutation_list(can_modify_occ)
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/build_chrom_list(mutation)
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/check_discovery(alias)
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/get_mut_by_ref(ref, target_flags)
	var/mutation
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/randomize_radiation_accuracy(position, radduration, number_of_blocks)
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/scramble(input,rs)
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/rad_pulse()
	// GUARD CHECK - Can we genetically modify the occupant? Includes scanner
	//  operational guard checks.
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/set_default_state()
...
/**
  ...
  */
/obj/machinery/computer/scanconsole/proc/eject_disk(mob/user)
	// Check for diskette.
	if(!diskette)
		return
...
/obj/machinery/computer/scanconsole/emag_act(mob/user)
	obj_flags |= EMAGGED
	if(req_access)
		req_access = list()
