			...
			if (authenticated == 2)
				...
				if(t1 == "Custom")
					...
					if(R)
						...
						R.fields["active_dept"] &= ~DEPARTMENT_BITFLAG_COMMAND  // micromanagement2. the reason is the same. Command should be removed manually.
					...
					if(R && jobdatum) // 1-B: reseting crew manifest
						...
						R.fields["active_dept"] &= ~DEPARTMENT_BITFLAG_COMMAND  // micromanagement2
