...
/obj/machinery/computer/arcade/amputation
	...
	desc = "A picture of a blood-soaked medical cyborg flashes on the screen. The mediborg has a speech bubble that says, \"Put your hand in the machine if there aren't a <b>coward!</b>\""
	icon_state = "arcade"
...
/obj/machinery/computer/arcade/amputation/emag_act(mob/user)
	...
	desc = "A picture of a blood-soaked medical cyborg flashes on the screen. The mediborg has glowing red eyes, and a speech bubble that says, \"Put your hand in the machine if therearen't a <b>coward!</b>\""
	obj_flags |= EMAGGED
