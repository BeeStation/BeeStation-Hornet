...
/datum/game_mode/gang
	...
	restricted_jobs = list(JOB_PATH_SECURITYOFFICER, JOB_PATH_WARDEN, JOB_PATH_DETECTIVE, JOB_PATH_AI, JOB_PATH_CYBORG,JOB_PATH_CAPTAIN, JOB_PATH_HEADOFPERSONNEL, JOB_PATH_HEADOFSECURITY)
	required_players = 30
	required_enemies = 2
