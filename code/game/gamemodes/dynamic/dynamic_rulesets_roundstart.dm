...
/datum/dynamic_ruleset/roundstart/heretics
	...
	protected_roles = list("Security Officer", "Internal Affairs Agent", "Warden", "Detective", "Head of Security", "Captain")
	restricted_roles = list("AI", "Cyborg")
	required_candidates = 1
	weight = 3
	cost = 15
...
/datum/dynamic_ruleset/roundstart/bloodcult
	...
	minimum_required_age = 14
	restricted_roles = list("AI", "Cyborg", "Security Officer", "Internal Affairs Agent", "Warden", "Detective", "Head of Security", "Captain", "Chaplain", "Head of Personnel")
	required_candidates = 2
	weight = 3
	cost = 20
...
/datum/dynamic_ruleset/roundstart/revs
	...
	minimum_required_age = 14
	restricted_roles = list("AI", "Cyborg", "Security Officer", "Internal Affairs Agent", "Warden", "Detective", "Head of Security", "Captain", "Head of Personnel", "Chief Engineer", "Chief Medical Officer", "Research Director")
...
/datum/dynamic_ruleset/roundstart/devil
	...
	restricted_roles = list("Lawyer", "Internal Affairs Agent", "Curator", "Chaplain", "Head of Security", "Captain", "AI", "Cyborg", "Security Officer", "Warden", "Detective")
	required_candidates = 1
	weight = 3
	cost = 0
	flags = LONE_RULESET
