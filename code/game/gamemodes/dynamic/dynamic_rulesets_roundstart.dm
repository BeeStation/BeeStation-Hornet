...
/datum/dynamic_ruleset/roundstart/traitor
	...
	protected_roles = list(JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN)
...
/datum/dynamic_ruleset/roundstart/traitorbro
	...
	protected_roles = list(JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN)
	restricted_roles = list(JOB_CYBORG, JOB_AI)
...
/datum/dynamic_ruleset/roundstart/wizard
	...
	restricted_roles = list(JOB_HEAD_OF_SECURITY, JOB_CAPTAIN) // Just to be sure that a wizard getting picked won't ever imply a Captain or HoS not getting drafted
	required_candidates = 1
	weight = 2
	cost = 20
...
/datum/dynamic_ruleset/roundstart/bloodcult
	...
	minimum_required_age = 14
	restricted_roles = list(JOB_AI, JOB_CYBORG, JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_DETECTIVE, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN, JOB_CHAPLAIN, JOB_HEAD_OF_PERSONNEL)
	required_candidates = 2
	weight = 3
	cost = 20
...
/datum/dynamic_ruleset/roundstart/nuclear
	...
	minimum_required_age = 14
	restricted_roles = list(JOB_HEAD_OF_SECURITY, JOB_CAPTAIN) // Just to be sure that a nukie getting picked won't ever imply a Captain or HoS not getting drafted
...
/datum/dynamic_ruleset/roundstart/devil
	...
	restricted_roles = list(JOB_LAWYER, JOB_CURATOR, JOB_CHAPLAIN, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN, JOB_AI, JOB_CYBORG, JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_DETECTIVE)
	required_candidates = 1
	weight = 3
	cost = 0
	flags = LONE_RULESET
