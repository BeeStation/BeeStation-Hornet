...
/datum/game_mode/dynamic/admin_panel()
	var/list/dat = list()
	dat += "Dynamic Mode <a href='byond://?[HREF_TYPE(var_edit)][HREF_PARAM(var_edit::Vars, FAST_REF(src))][HrefToken()]'>VV</a> <a href='byond://?src=[FAST_REF(src)];[HrefToken()]'>Refresh</a><BR>"
