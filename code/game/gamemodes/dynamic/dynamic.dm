...
/datum/game_mode/dynamic/Topic(href, href_list)
	...
	if (href_list["forced_extended"])
		...
		message_admins("[key_name(usr)] toggled dynamic's Forced Extended setting.")
	else if (href_list["no_stacking"])
		GLOB.dynamic_no_stacking = !GLOB.dynamic_no_stacking
		message_admins("[key_name(usr)] toggled dynamic's No Stacking setting.")
		...
		message_admins("[key_name(usr)] adjusted dynamic's Stacking Limit setting.")
