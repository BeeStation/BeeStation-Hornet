...
/datum/dynamic_ruleset/midround/autotraitor
	...
	restricted_roles = list(JOB_CYBORG, JOB_AI, "Positronic Brain")
...
/datum/dynamic_ruleset/midround/malf
	...
	enemy_roles = list(JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_DETECTIVE, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN, JOB_SCIENTIST, JOB_CHEMIST, JOB_RESEARCH_DIRECTOR, JOB_CHIEF_ENGINEER)
...
/datum/dynamic_ruleset/midround/from_ghosts/wizard
	...
	enemy_roles = list(JOB_SECURITY_OFFICER, JOB_DETECTIVE, JOB_WARDEN, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN, JOB_RESEARCH_DIRECTOR) //RD doesn't believe in magic
...
/datum/dynamic_ruleset/midround/from_ghosts/nuclear
	...
	enemy_roles = list(JOB_AI, JOB_CYBORG, JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_DETECTIVE, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN)
...
/datum/dynamic_ruleset/midround/from_ghosts/blob
	...
	enemy_roles = list(JOB_SECURITY_OFFICER, JOB_DETECTIVE, JOB_WARDEN, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN)
	required_enemies = list(2,2,1,1,1,1,1,0,0,0)
	required_candidates = 1
	weight = 4
	cost = 10
