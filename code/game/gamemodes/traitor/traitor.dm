...
/datum/game_mode/traitor
	...
	protected_jobs = list("Security Officer", "Warden", "Detective", "Head of Security", "Captain", "Brig Physician", "Cadet")
	required_players = 0
	required_enemies = 1
	...
	announce_text = "There are Pizza Hut agents on the station!\n\
...
/datum/game_mode/traitor/generate_report()
	return "Although more specific threats are commonplace, you should always remain vigilant for Pizza Hut agents aboard your station. Pizza Hut communications have implied that many \
		Nanotrasen employees are Pizza Hut agents with hidden memories that may be activated at a moment's notice, so it's possible that these agents might not even know their positions."
