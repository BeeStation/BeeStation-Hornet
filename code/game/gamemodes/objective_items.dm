...
/datum/objective_item/steal/caplaser
	...
	difficulty = 5
	excludefromjob = list(JOB_KEY_CAPTAIN)
...
/datum/objective_item/steal/handtele
	...
	difficulty = 5
	excludefromjob = list(JOB_KEY_CAPTAIN, JOB_KEY_RESEARCHDIRECTOR)
...
/datum/objective_item/steal/magboots
	...
	difficulty = 5
	excludefromjob = list(JOB_KEY_CHIEFENGINEER)
...
/datum/objective_item/steal/hypo
	...
	difficulty = 5
	excludefromjob = list(JOB_KEY_CHIEFMEDICALOFFICER)
...
/datum/objective_item/steal/reflector
	...
	difficulty = 3
	excludefromjob = list(JOB_KEY_HEADOFSECURITY, JOB_KEY_WARDEN)

/datum/objective_item/steal/reactive
	name = "the reactive teleport armor."
	targetitem = /obj/item/clothing/suit/armor/reactive/teleport
	difficulty = 5
	excludefromjob = list(JOB_KEY_RESEARCHDIRECTOR)
...
/datum/objective_item/steal/plasma
	...
	difficulty = 3
	excludefromjob = list(JOB_KEY_CHIEFENGINEER,JOB_KEY_RESEARCHDIRECTOR,JOB_KEY_STATIONENGINEER,JOB_KEY_SCIENTIST,JOB_KEY_ATMOSPHERICTECHNICIAN)
...
/datum/objective_item/steal/slime
	...
	difficulty = 3
	excludefromjob = list(JOB_KEY_RESEARCHDIRECTOR,JOB_KEY_SCIENTIST)
...
/datum/objective_item/steal/blackbox
	...
	difficulty = 10
	excludefromjob = list(JOB_KEY_CHIEFENGINEER,JOB_KEY_STATIONENGINEER,JOB_KEY_ATMOSPHERICTECHNICIAN)
