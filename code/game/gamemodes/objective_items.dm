...
/datum/objective_item/steal/caplaser
	...
	difficulty = 5
	excludefromjob = list(JOB_PATH_CAPTAIN)
...
/datum/objective_item/steal/handtele
	...
	difficulty = 5
	excludefromjob = list(JOB_PATH_CAPTAIN, JOB_PATH_RESEARCHDIRECTOR)
...
/datum/objective_item/steal/magboots
	...
	difficulty = 5
	excludefromjob = list(JOB_PATH_CHIEFENGINEER)
...
/datum/objective_item/steal/hypo
	...
	difficulty = 5
	excludefromjob = list(JOB_PATH_CHIEFMEDICALOFFICER)
...
/datum/objective_item/steal/reflector
	...
	difficulty = 3
	excludefromjob = list(JOB_PATH_HEADOFSECURITY, JOB_PATH_WARDEN)

/datum/objective_item/steal/reactive
	name = "the reactive teleport armor."
	targetitem = /obj/item/clothing/suit/armor/reactive/teleport
	difficulty = 5
	excludefromjob = list(JOB_PATH_RESEARCHDIRECTOR)
...
/datum/objective_item/steal/plasma
	...
	difficulty = 3
	excludefromjob = list(JOB_PATH_CHIEFENGINEER,JOB_PATH_RESEARCHDIRECTOR,JOB_PATH_STATIONENGINEER,JOB_PATH_SCIENTIST,JOB_PATH_ATMOSPHERICTECHNICIAN)
...
/datum/objective_item/steal/slime
	...
	difficulty = 3
	excludefromjob = list(JOB_PATH_RESEARCHDIRECTOR,JOB_PATH_SCIENTIST)
...
/datum/objective_item/steal/blackbox
	...
	difficulty = 10
	excludefromjob = list(JOB_PATH_CHIEFENGINEER,JOB_PATH_STATIONENGINEER,JOB_PATH_ATMOSPHERICTECHNICIAN)
