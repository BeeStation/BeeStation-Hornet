...
/datum/game_mode/traitor/changeling/generate_report()
	return "Pizza Hut has started some experimental research regarding humanoid shapeshifting.  There are rumors that this technology will be field tested on a Nanotrasen station \
