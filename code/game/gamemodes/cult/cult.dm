...
/datum/game_mode/cult
	...
	restricted_jobs = list(JOB_CHAPLAIN,JOB_AI, JOB_CYBORG, JOB_SECURITY_OFFICER, JOB_WARDEN, JOB_DETECTIVE, JOB_HEAD_OF_SECURITY, JOB_CAPTAIN, JOB_HEAD_OF_PERSONNEL)
	protected_jobs = list()
	required_players = 29
	required_enemies = 4
