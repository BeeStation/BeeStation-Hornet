...
/datum/game_mode/cult
	...
	restricted_jobs = list(JOB_NAME_CHAPLAIN, JOB_NAME_AI, JOB_NAME_CYBORG, JOB_NAME_SECURITYOFFICER, JOB_NAME_WARDEN, JOB_NAME_DETECTIVE, JOB_NAME_BRIGPHYSICIAN, JOB_NAME_HEADOFSECURITY, JOB_NAME_CAPTAIN, JOB_NAME_HEADOFPERSONNEL)
	protected_jobs = list()
	required_players = 29
	required_enemies = 4
