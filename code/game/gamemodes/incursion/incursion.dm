...
/datum/game_mode/incursion
	...
	protected_jobs = list("Security Officer", "Corporate Affairs Agent", "Warden", "Detective","Captain", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer")
