...
/atom/vv_get_header()
	...
	. += "<br><font size='1'><a href='byond://?[HREF_COMMAND(var_edit)][HrefToken()];rotatedatum=[refid];rotatedir=left'><<</a> <a href='byond://?[HREF_COMMAND(var_edit)][HrefToken()];datumedit=[refid];varnameedit=dir' id='dir'>[dir2text(dir) || dir]</a> <a href='byond://?[HREF_COMMAND(var_edit)][HrefToken()];rotatedatum=[refid];rotatedir=right'>>></a></font>"
