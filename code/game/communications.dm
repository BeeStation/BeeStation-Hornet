...
GLOBAL_LIST_INIT(radionoise, list(
	"[FREQ_SCIENCE]" = RADIO_SFX_SCIENCE,
	"[FREQ_COMMAND]" = RADIO_SFX_COMMAND,
	"[FREQ_MEDICAL]" = RADIO_SFX_MEDICAL,
	"[FREQ_ENGINEERING]" = RADIO_SFX_ENGINEERING,
	"[FREQ_SECURITY]" = RADIO_SFX_SECURITY
	"[FREQ_CENTCOM]" = RADIO_SFX_CENTCOM,
	"[FREQ_SYNDICATE]" = RADIO_SFX_SYNDICATE,
	"[FREQ_SUPPLY]" = RADIO_SFX_SUPPLY,
	"[FREQ_SERVICE]" = RADIO_SFX_SERVICE,
	"[FREQ_EXPLORATION]" = RADIO_SFX_EXPLORATION,
	"[FREQ_AI_PRIVATE]" = RADIO_SFX_AI_PRIVATE
))
