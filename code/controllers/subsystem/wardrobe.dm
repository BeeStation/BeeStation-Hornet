...
/datum/controller/subsystem/wardrobe/proc/setup_callbacks()
	...
	play_with[WARDROBE_CALLBACK_INSERT] = CALLBACK(null, TYPE_PROC_REF(/obj/item/modular_computer/tablet/pda, display_pda))
	play_with[WARDROBE_CALLBACK_REMOVE] = CALLBACK(null, TYPE_PROC_REF(/obj/item/modular_computer/tablet/pda, cloak_pda))
	initial_callbacks[/obj/item/modular_computer/tablet/pda] = play_with
...
/datum/controller/subsystem/wardrobe/proc/load_pda_nicknacks()
	for(var/obj/item/modular_computer/tablet/pda/pager as anything in typesof(/obj/item/modular_computer/tablet/pda))
		var/obj/item/modular_computer/tablet/pda/flip_phone = new pager()
