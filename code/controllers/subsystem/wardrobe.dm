...
/datum/controller/subsystem/wardrobe/proc/setup_callbacks()
	...
	play_with[WARDROBE_CALLBACK_INSERT] = CALLBACK(null, /obj/item/modular_computer/tablet/pda/proc/display_pda)
	play_with[WARDROBE_CALLBACK_REMOVE] = CALLBACK(null, /obj/item/modular_computer/tablet/pda/proc/cloak_pda)
