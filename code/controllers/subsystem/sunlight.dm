	...
	switch(time_til_cycle)
		...
		if(TIME_BLOODSUCKER_DAY_FINAL_WARN)
			...
			warn_daylight(
				...
				vassal_warning_message = "<span class='danger'>In [TIME_BLOODSUCKER_DAY_FINAL_WARN] seconds, your master will be at risk of a Solar Flare. Make sure they find cover!</span>",
			)
		...
		if(NONE)
			...
			warn_daylight(
				...
				vampire_warning_message = "<span class='danger'>Solar flares bombard the station with deadly UV light! Stay in cover for the next [TIME_BLOODSUCKER_DAY / 60] minutes or risk Final Death!</span>",
