...
/datum/controller/subsystem/idlenpcpool/fire(resumed = FALSE)
	...
	while(currentrun.len)
		...
		if(!SA)
			stack_trace("idlenpcpool.dm", "Null entry found at GLOB.simple_animals\[AI_IDLE\]. Null entries will be purged. Yell at coderbus. Subsystem will try to continue.")
