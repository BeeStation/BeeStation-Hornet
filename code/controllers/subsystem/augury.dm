...
/datum/action/innate/augury/on_activate(at)
	SSaugury.watchers += owner
...
/datum/action/innate/augury/update_button(atom/movable/screen/movable/action_button/button, status_only = FALSE, force)
	..()
	if(active)
