...
/datum/dynamic_ruleset/midround/ghost/proc/send_applications()
	...
	if(amount_of_candidates >= drafted_players_amount)
		...
		message_admins("DYNAMIC: Not enough players volunteered for [src] - [amount_of_candidates]/[drafted_players_amount].")
		log_dynamic("MIDROUND: FAIL: Not enough players volunteered for [src] - [amount_of_candidates]/[drafted_players_amount].")
