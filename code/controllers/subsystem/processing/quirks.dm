...
PROCESSING_SUBSYSTEM_DEF(quirks)
	...
	var/list/quirk_species_blacklist = list() //A list of quirks that a given species is incompatible with (or already has)
...
/datum/controller/subsystem/processing/quirks/Initialize(timeofday)
	...
	quirk_species_blacklist = list(
									"Simian" = list("Kleptomaniac")
								)
	return ..()
