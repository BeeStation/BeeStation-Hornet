...
"amount"
	...
	json: {"data":10}
"tally"
	used to track the number of occurences of multiple related values i.e. how many times each type of gun is fired
...
"nested tally"
	used to track the number of occurences of structured semi-relational values i.e. the results of arcade machines
