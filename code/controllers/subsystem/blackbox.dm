...
/datum/controller/subsystem/blackbox/fire()
	...
	if(CONFIG_GET(flag/use_exp_tracking))
		if((triggertime < 0) || (IS_TIME_PASSED(triggertime +3000)))	//subsystem fires once at roundstart then once every 10 minutes. a 5 min check skips the first fire. The <0 is midnight rollover check
			update_exp(10,FALSE)
