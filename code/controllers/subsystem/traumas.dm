...
/datum/controller/subsystem/traumas/Initialize()
	...
	phobia_objs = list(
		...
		"conspiracies" = typecacheof(list(
			...
			/obj/item/clothing/head/helmet/abductor, /obj/item/clothing/suit/armor/abductor_vest, /obj/item/abductor/baton,
		...
		"aliens" = typecacheof(list(
			...
			/obj/item/clothing/suit/armor/abductor_vest, /obj/item/abductor, /obj/item/gun/energy/alien,
