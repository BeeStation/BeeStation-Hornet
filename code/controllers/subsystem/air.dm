...
/datum/controller/subsystem/air/proc/setup_allturfs()
	...
	if(active_turfs.len)
		...
		var/msg = "In [DisplayTimeText(world.timeofday - timer)], processed [starting_ats] turf(s) (connected to [ending_ats] other turfs) with atmos differences at round start."
