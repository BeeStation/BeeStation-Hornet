...
#define STATUS_EFFECT_CHANGELING_CAMO /datum/status_effect/changeling_camoflague //! Makes you slowly invisible over time, taking damage, being bumped, moving or burning removes the effect.
