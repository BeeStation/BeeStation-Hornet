...
#define IC_SPAWN_SYNDICATE			4 //! If the circuit design will be available in the IC printer after upgrading it with the syndicate disk. oasis edit nuclearmayhem
