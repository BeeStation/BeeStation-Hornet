...
#define DEPARTMENT_BITFLAG_COM (1<<0)
#define DEPARTMENT_BITFLAG_CIV (1<<1)
#define DEPARTMENT_BITFLAG_SRV (1<<2)
#define DEPARTMENT_BITFLAG_CAR (1<<3)
#define DEPARTMENT_BITFLAG_SCI (1<<4)
#define DEPARTMENT_BITFLAG_ENG (1<<5)
#define DEPARTMENT_BITFLAG_MED (1<<5)
#define DEPARTMENT_BITFLAG_SEC (1<<6)
#define DEPARTMENT_BITFLAG_VIP (1<<7)
