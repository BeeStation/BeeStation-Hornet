...
#define OUTFIT_CATEGORY_WIZARD "Wizard types..."
#define OUTFIT_CATEGORY_ANTAGONIST "Antagonists types..."
#define OUTFIT_CATEGORY_CENTCOM "CentCom (ERT, official, ETC)..."
#define OUTFIT_CATEGORY_SYNDICATE "Syndicate types..."
#define OUTFIT_CATEGORY_ETC "Misc types..."
#define OUTFIT_CATEGORY_EXPLOTARGET "Exploration Targets types..."
