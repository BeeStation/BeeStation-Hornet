...
//////////// Color defines
// Command
#define JOB_CHAT_COLOR_RAWCOMMAND    "#FFECCA" // custom command color
#define JOB_CHAT_COLOR_CAPTAIN       "#FFDC9B"
#define JOB_CHAT_COLOR_ACTINGCAPTAIN "#FFDC9B"

// Service
#define JOB_CHAT_COLOR_RAWSERVICE      "#BFE4B0" // custom service color
#define JOB_CHAT_COLOR_HEADOFPERSONNEL "#7979D3"
#define JOB_CHAT_COLOR_ASSISTANT "#BDBDBD"
#define JOB_CHAT_COLOR_BARTENDER "#B2CEB3"
#define JOB_CHAT_COLOR_COOK      "#A2FBB9"
#define JOB_CHAT_COLOR_BOTANIST  "#95DE85"
#define JOB_CHAT_COLOR_CURATOR   "#88C999"
#define JOB_CHAT_COLOR_CHAPLAIN  "#8AB48C"
#define JOB_CHAT_COLOR_JANITOR   "#97FBEA"
#define JOB_CHAT_COLOR_LAWYER    "#C07D7D"
#define JOB_CHAT_COLOR_MIME      "#BAD3BB"
#define JOB_CHAT_COLOR_CLOWN     "#FF83D7"
#define JOB_CHAT_COLOR_STAGEMAGICIAN  "#B898B3"
#define JOB_CHAT_COLOR_BARBER    "#BD9E86"

// Cargo
#define JOB_CHAT_COLOR_RAWCARGO        "#ECCE9A" // custom cargo color
#define JOB_CHAT_COLOR_QUARTERMASTER   "#C79C52"
#define JOB_CHAT_COLOR_CARGOTECHNICIAN "#D3A372"
#define JOB_CHAT_COLOR_SHAFTMINER      "#CE957E"

// R&D
#define JOB_CHAT_COLOR_RAWSCIENCE       "#F3BFF3" // custom R&D color
#define JOB_CHAT_COLOR_RESEARCHDIRECTOR "#974EA9"
#define JOB_CHAT_COLOR_SCIENTIST        "#C772C7"
#define JOB_CHAT_COLOR_ROBOTICIST       "#AC71BA"
#define JOB_CHAT_COLOR_EXPLORATIONCREW  "#85D8B8"

// Engineering
#define JOB_CHAT_COLOR_RAWENGINEERING        "#E9D1A8" // custom engineering color
#define JOB_CHAT_COLOR_CHIEFENGINEER         "#CFBB72"
#define JOB_CHAT_COLOR_STATIONENGINEER       "#D9BC89"
#define JOB_CHAT_COLOR_ATMOSPHERICTECHNICIAN "#D4A07D"

// Medical
#define JOB_CHAT_COLOR_RAWMEDICAL           "#B1E5EC" // custom medical color
#define JOB_CHAT_COLOR_CHEIFMEDICALOFFICIER "#7A97DA"
#define JOB_CHAT_COLOR_MEDICALDOCTOR "#6CB1C5"
#define JOB_CHAT_COLOR_PARAMEDIC     "#8FBEB4"
#define JOB_CHAT_COLOR_VIROLOGIST    "#75AEA3"
#define JOB_CHAT_COLOR_CHEMIST       "#82BDCE"
#define JOB_CHAT_COLOR_GENETICIST    "#83BBBF"
#define JOB_CHAT_COLOR_PSYCHIATRIST  "#A2DFDC"

// Security
#define JOB_CHAT_COLOR_RAWSECURITY     "#F3BDC0" // custom security color, has some color than deputy
#define JOB_CHAT_COLOR_HEADOFSECURITY  "#D33049"
#define JOB_CHAT_COLOR_WARDEN          "#EA545E"
#define JOB_CHAT_COLOR_SECURITYOFFICER "#E6A3A3"
#define JOB_CHAT_COLOR_DETECTIVE       "#C78B8B"
#define JOB_CHAT_COLOR_BRIGPHYSICIAN   "#B16789"
#define JOB_CHAT_COLOR_DEPUTY          "#FFEEEE"

// CentCom
#define JOB_CHAT_COLOR_RAWCENTCOM "#A7F08F" // custom CC Color
#define JOB_CHAT_COLOR_CENTCOM    "#90FD6D"

// ETC
#define JOB_CHAT_COLOR_VIP        "#EBC96B"
#define JOB_CHAT_COLOR_KING       "#DCEC49" // somehow golden?
#define JOB_CHAT_COLOR_SYNDICATE  "#997272" // I really didn't care the color
#define JOB_CHAT_COLOR_NOTCENTCOM "#6D6AEC" // i.e. space police
#define JOB_CHAT_COLOR_PRISONER   "#D38A5C"
#define JOB_CHAT_COLOR_UNKNOWN    "#DDA583" // grey hud icon gets this
...
/datum/chatmessage/proc/get_chatcolor_by_hud(jobname)
	if(jobname)
		var/static/hud_to_chatcolor = list(
			// Command
			JOB_HUD_RAWCOMMAND = JOB_CHAT_COLOR_RAWCOMMAND,
			JOB_HUD_CAPTAIN = JOB_CHAT_COLOR_CAPTAIN,
			JOB_HUD_ACTINGCAPTAIN  = JOB_CHAT_COLOR_ACTINGCAPTAIN,

			// Service
			JOB_HUD_RAWSERVICE = JOB_CHAT_COLOR_RAWSERVICE,
			JOB_HUD_HEADOFPERSONNEL = JOB_CHAT_COLOR_HEADOFPERSONNEL,
			JOB_HUD_ASSISTANT = JOB_CHAT_COLOR_ASSISTANT,
			JOB_HUD_BARTENDER = JOB_CHAT_COLOR_BARTENDER,
			JOB_HUD_COOK = JOB_CHAT_COLOR_COOK,
			JOB_HUD_BOTANIST = JOB_CHAT_COLOR_BOTANIST,
			JOB_HUD_CURATOR = JOB_CHAT_COLOR_CURATOR,
			JOB_HUD_CHAPLAIN = JOB_CHAT_COLOR_CHAPLAIN,
			JOB_HUD_JANITOR = JOB_CHAT_COLOR_JANITOR,
			JOB_HUD_LAWYER = JOB_CHAT_COLOR_LAWYER,
			JOB_HUD_MIME = JOB_CHAT_COLOR_MIME,
			JOB_HUD_CLOWN = JOB_CHAT_COLOR_CLOWN,
			JOB_HUD_STAGEMAGICIAN = JOB_CHAT_COLOR_STAGEMAGICIAN,
			JOB_HUD_BARBER = JOB_CHAT_COLOR_BARBER,

			// Cargo
			JOB_HUD_RAWCARGO = JOB_CHAT_COLOR_RAWCARGO,
			JOB_HUD_QUARTERMASTER = JOB_CHAT_COLOR_QUARTERMASTER,
			JOB_HUD_CARGOTECHNICIAN = JOB_CHAT_COLOR_CARGOTECHNICIAN,
			JOB_HUD_SHAFTMINER = JOB_CHAT_COLOR_SHAFTMINER,

			// R&D
			JOB_HUD_RAWSCIENCE = JOB_CHAT_COLOR_RAWSCIENCE,
			JOB_HUD_RESEARCHDIRECTOR = JOB_CHAT_COLOR_RESEARCHDIRECTOR,
			JOB_HUD_SCIENTIST = JOB_CHAT_COLOR_SCIENTIST,
			JOB_HUD_ROBOTICIST = JOB_CHAT_COLOR_ROBOTICIST,
			JOB_HUD_EXPLORATIONCREW = JOB_CHAT_COLOR_EXPLORATIONCREW,

			// Engineering
			JOB_HUD_RAWENGINEERING = JOB_CHAT_COLOR_RAWENGINEERING,
			JOB_HUD_CHIEFENGINEER = JOB_CHAT_COLOR_CHIEFENGINEER,
			JOB_HUD_STATIONENGINEER = JOB_CHAT_COLOR_STATIONENGINEER,
			JOB_HUD_ATMOSPHERICTECHNICIAN = JOB_CHAT_COLOR_ATMOSPHERICTECHNICIAN,

			// Medical
			JOB_HUD_RAWMEDICAL = JOB_CHAT_COLOR_RAWMEDICAL,
			JOB_HUD_CHEIFMEDICALOFFICIER = JOB_CHAT_COLOR_CHEIFMEDICALOFFICIER,
			JOB_HUD_MEDICALDOCTOR = JOB_CHAT_COLOR_MEDICALDOCTOR,
			JOB_HUD_PARAMEDIC = JOB_CHAT_COLOR_PARAMEDIC,
			JOB_HUD_VIROLOGIST = JOB_CHAT_COLOR_VIROLOGIST,
			JOB_HUD_CHEMIST = JOB_CHAT_COLOR_CHEMIST,
			JOB_HUD_GENETICIST = JOB_CHAT_COLOR_GENETICIST,
			JOB_HUD_PSYCHIATRIST = JOB_CHAT_COLOR_PSYCHIATRIST,

			// Security
			JOB_HUD_RAWSECURITY = JOB_CHAT_COLOR_RAWSECURITY,
			JOB_HUD_HEADOFSECURITY = JOB_CHAT_COLOR_HEADOFSECURITY,
			JOB_HUD_WARDEN = JOB_CHAT_COLOR_WARDEN,
			JOB_HUD_SECURITYOFFICER = JOB_CHAT_COLOR_SECURITYOFFICER,
			JOB_HUD_DETECTIVE = JOB_CHAT_COLOR_DETECTIVE,
			JOB_HUD_BRIGPHYSICIAN = JOB_CHAT_COLOR_BRIGPHYSICIAN,
			JOB_HUD_DEPUTY = JOB_CHAT_COLOR_DEPUTY,

			// CentCom
			JOB_HUD_RAWCENTCOM = JOB_CHAT_COLOR_RAWCENTCOM,
			JOB_HUD_CENTCOM = JOB_CHAT_COLOR_CENTCOM,

			// ETC
			JOB_HUD_VIP = JOB_CHAT_COLOR_VIP,
			JOB_HUD_KING = JOB_CHAT_COLOR_KING,
			JOB_HUD_SYNDICATE = JOB_CHAT_COLOR_SYNDICATE,
			JOB_HUD_NOTCENTCOM = JOB_CHAT_COLOR_NOTCENTCOM,
			JOB_HUD_PRISONER = JOB_CHAT_COLOR_PRISONER,
			JOB_HUD_UNKNOWN = JOB_CHAT_COLOR_UNKNOWN
		)
		if(jobname in hud_to_chatcolor)
			return hud_to_chatcolor[jobname]
	return JOB_CHAT_COLOR_UNKNOWN
