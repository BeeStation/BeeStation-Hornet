...
// these are medibot skins that are chosen by its original first aid kit. For example, a medibot that made with an oxygen first aid kit will use MEDBOT_SKIN_OXY
