...
#define ATMOS_TANK_O2 GAS_O2 + "=8314;TEMP=293.15"
#define ATMOS_TANK_N2 GAS_N2 + "=8314;TEMP=293.15"

// The rest may be best off removed.
#define ATMOS_TANK_AIRMIX GAS_O2 + "=1747;" + GAS_N2 + "=6567;TEMP=293.15"
...
#define ATMOS_TANK_NITRIUM GAS_ATMOS_TANK_NITRIUM + "=100000;TEMP=293.15"
