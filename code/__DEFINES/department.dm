...
#define DEPT_NAME_ALL_STATION_DEPT_LIST list(DEPT_NAME_COMMAND, \
			DEPT_NAME_SERVICE, DEPT_NAME_SUPPLY, DEPT_NAME_SCIENCE, \
			DEPT_NAME_ENGINEERING, DEPT_NAME_MEDICAL, DEPT_NAME_SECURITY)
