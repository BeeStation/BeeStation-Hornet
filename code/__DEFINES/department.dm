...
// Verbose aliases matching TG naming convention, used by ported code
#define DEPARTMENT_BITFLAG_COMMAND DEPT_BITFLAG_COM
#define DEPARTMENT_BITFLAG_CIVILIAN DEPT_BITFLAG_CIV
#define DEPARTMENT_BITFLAG_SERVICE DEPT_BITFLAG_SRV
#define DEPARTMENT_BITFLAG_CARGO DEPT_BITFLAG_CAR
#define DEPARTMENT_BITFLAG_SCIENCE DEPT_BITFLAG_SCI
#define DEPARTMENT_BITFLAG_ENGINEERING DEPT_BITFLAG_ENG
#define DEPARTMENT_BITFLAG_MEDICAL DEPT_BITFLAG_MED
#define DEPARTMENT_BITFLAG_SECURITY DEPT_BITFLAG_SEC
#define DEPARTMENT_BITFLAG_SILICON DEPT_BITFLAG_SILICON
