...
//The amount of a ship that has to be damaged before it is considered destroyed (12%) (This seems very low, but damaging a turf only does 20% damage for that turf, with each turf having up to 5 damage levels)
#define SHIP_INTEGRITY_FACTOR 0.34
