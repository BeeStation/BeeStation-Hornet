...
#define ANOMALY_WEIGHTS list(ANOMALY_GRAVITATIONAL = 55, ANOMALY_HALLUCINATION = 45, ANOMALY_CLOWN = 40, ANOMALY_MIME = 40, ANOMALY_BIOSCRAMBLER = 35, ANOMALY_NUCLEAR = 30, ANOMALY_FLUX = 25,  ANOMALY_EXO = 5, ANOMALY_ENDO = 5, ANOMALY_VORTEX = 1, ANOMALY_GLITCH = 1)
