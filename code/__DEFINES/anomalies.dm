...
#define ANOMALY_WEIGHTS list(ANOMALY_GRAVITATIONAL = 55, ANOMALY_HALLUCINATION = 45, ANOMALY_BIOSCRAMBLER = 35, ANOMALY_FLUX = 25, ANOMALY_NUCLEAR = 20, ANOMALY_TRAP = 10, ANOMALY_CLOWN = 10, ANOMALY_MIME = 10, ANOMALY_BABEL = 10, ANOMALY_MONKEY = 10, ANOMALY_CARP = 10,  ANOMALY_EXO = 5, ANOMALY_ENDO = 5, ANOMALY_VORTEX = 1, ANOMALY_GLITCH = 1)
