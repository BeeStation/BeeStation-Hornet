...
#define ORGAN_ABSTRACT			(1<<0)	//Currently only the veins - Veins work as a reagent holder
#define ORGAN_SYNTHETIC			(1<<1)	//Synthetic organs, or cybernetic organs. Reacts to EMPs and don't deteriorate or heal
#define ORGAN_FROZEN			(1<<2)	//Frozen organs, don't deteriorate
...
#define ORGAN_VITAL				(1<<5)	//Currently only the brain and the veins
#define ORGAN_EDIBLE			(1<<6)	//is a snack? :D
#define ORGAN_UNREMOVABLE 		(1<<7)	//Can't be removed from normal methods (like surgery)
