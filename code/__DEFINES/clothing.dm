...
#define RESTRICTION_GLOVES (1<<4)
#define RESTRICTION_HEAD (1<<5)
#define RESTRICTION_MASK (1<<6)
#define RESTRICTION_NECK (1<<7)
#define RESTRICTION_SUIT (1<<8)
#define RESTRICTION_UNDER (1<<9)
