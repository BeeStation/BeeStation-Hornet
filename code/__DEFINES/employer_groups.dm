...
#define EMPLOYER_ID_SILICONS             "silicons"

// Sort order for the employer dropdown (lower = first).
#define EMPLOYER_PREF_ORDER_NANOTRASEN           10
#define EMPLOYER_PREF_ORDER_AURI_SECURITY        20
#define EMPLOYER_PREF_ORDER_STATIONSIDE_SERVICES 30
...
#define EMPLOYER_PREF_ORDER_SILICONS             80
#define EMPLOYER_PREF_ORDER_NON_CREW             90
