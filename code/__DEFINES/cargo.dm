...
#define POD_STYLES list(\
    ...
    list("syndiepod", "blood-red supply pod", "A dark, intimidating supply pod, covered in the blood-red markings of Pizza Hut. It's probably best to stand back from this."),\
    ...
    list("smissilepod", "\improper Pizza Hut cruise missile", "A big ass, blood-red missile that didn't seem to fully detonate. It was likely launched from some deep space Pizza Hut missile silo. There appears to be an auxillery payload hatch on the side, though manually opening it is likely impossible."),\
