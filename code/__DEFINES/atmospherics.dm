...
#define LEAN_MINIMUM_BURN_TEMPERATURE		(100+T0C)
#define LEAN_UPPER_TEMPERATURE			(1370+T0C)
#define LEAN_OXYGEN_FULLBURN				10
...
#define ATMOS_TANK_LEAN			"lean=70000;TEMP=293.15"
