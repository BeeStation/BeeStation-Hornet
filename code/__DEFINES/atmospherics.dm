...
#define PLASMA_UPPER_TEMPERATURE			(1370+T0C) // plasma can get much much hotter then this IRL
#define PLASMA_OXYGEN_FULLBURN				10
#define HYDROGEN_MINIMUM_BURN_TEMPERATURE	(500+T0C)
#define HYDROGEN_UPPER_TEMPERATURE			(2045+T0C)
#define HYDROGEN_OXYGEN_FULLBURN			20
