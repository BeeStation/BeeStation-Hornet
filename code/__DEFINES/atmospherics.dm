...
#define BODYTEMP_DEFAULT_NORMAL				310.15	//! The natural temperature for a body
...
#define BODYTEMP_DEFAULT_HEAT_DAMAGE_LIMIT	(BODYTEMP_DEFAULT_NORMAL + 50) //! The limit the human body can take before it starts taking damage from heat.
#define BODYTEMP_DEFAULT_COLD_DAMAGE_LIMIT	(BODYTEMP_DEFAULT_NORMAL - 50) //! The limit the human body can take before it starts taking damage from coldness.
