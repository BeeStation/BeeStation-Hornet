...
GLOBAL_LIST_INIT(pipe_paint_colors, list(
	"amethyst" = COLOR_PIPE_AMETHYST,
	"blue" = COLOR_PIPE_BLUE,
	"brown" = COLOR_PIPE_BROWN,
	"cyan" = COLOR_PIPE_CYAN,
	"dark" = COLOR_PIPE_DARK,
	"green" = COLOR_PIPE_GREEN,
	"grey" = COLOR_PIPE_GREY,
	"orange" = COLOR_PIPE_ORANGE,
	"purple" = COLOR_PIPE_PURPLE,
	"red" = COLOR_PIPE_RED,
	"violet" = COLOR_PIPE_VIOLET,
	"yellow" = COLOR_PIPE_YELLOW
))
