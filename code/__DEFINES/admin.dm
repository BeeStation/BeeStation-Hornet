...
#define SPAM_TRIGGER_WARNING	10	//Number of identical messages required before the spam-prevention will warn you to stfu
#define SPAM_TRIGGER_AUTOMUTE	15	//Number of identical messages required before the spam-prevention will automute you
