...
#define TRAIT_SURGEON           "surgeon"	//! Allows the user to do any surgery, anywhere, regardless of research or operating surface, with a 100% success rate and at higher speeds than usual.
