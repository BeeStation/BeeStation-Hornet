...
#define SUPERMATTER_IGNORES_1       (1 << 19) //set this to 18 because tg has some other flags appearantly too if that gets ever ported fix this !!!!
#define SAVE_SAFE_1					(1<<20)		//! Marks an item as being safe to save. Anything ridiculous or will not work if spawned on a map should not be given this flag.
