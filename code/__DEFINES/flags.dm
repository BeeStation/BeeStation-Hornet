...
#define ZAP_LOW_POWER_GEN 			(1<<6) /// Zaps with this flag will generate less power through tesla coils

#define ZAP_DEFAULT_FLAGS ALL
#define ZAP_ENERGY_PRIMARY_BALL_FLAGS (ZAP_MACHINE_EXPLOSIVE | ZAP_OBJ_DAMAGE | ZAP_MOB_DAMAGE | ZAP_MOB_STUN)
#define ZAP_ENERGY_MINI_BALL_FLAGS (ZAP_OBJ_DAMAGE | ZAP_MOB_DAMAGE | ZAP_MOB_STUN)
