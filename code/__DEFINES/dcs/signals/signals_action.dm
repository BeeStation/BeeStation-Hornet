...
/// From base of /datum/action/cooldown/proc/pre_activate(), sent to the action owner: (datum/action/cooldown/activated)
...
/// From base of /datum/action/cooldown/proc/pre_activate(), sent to the action owner: (datum/action/cooldown/finished)
