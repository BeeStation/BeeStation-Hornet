...
///from base of obj/item/pre_ranged_attack(): (atom/target, mob/user, list/modifiers)
...
#define COMSIG_ITEM_PRE_ATTACK "item_pre_attack"
	//COMPONENT_CANCEL_ATTACK_CHAIN
	//COMPONENT_SKIP_ATTACK
/// From base of [/obj/item/proc/pre_ranged_attack_secondary()]: (atom/target, mob/user, list/modifiers)
...
///from base of obj/item/afterattack_secondary(): (atom/target, mob/user, proximity_flag, list/modifiers)
