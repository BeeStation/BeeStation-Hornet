...
/// Called when a MOD deploys a part. (uncomment when you want to use it in a module)
//#define COMSIG_MOD_PART_DEPLOYED "mod_part_deployed"
/// Called when a MOD retracts a part. (uncomment when you want to use it in a module)
