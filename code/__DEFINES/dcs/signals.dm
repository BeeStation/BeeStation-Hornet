...
#define COMSIG_CARBON_UNEQUIP_SHOECOVER "carbon_unequip_shoecover"	//from /mob/living/carbon/doUnEquip(obj/item/I, force, newloc, no_move, invdrop, silent)
#define COMSIG_CARBON_EQUIP_SHOECOVER "carbon_equip_shoecover"		//from /mob/living/carbon/doUnEquip(obj/item/I, force, newloc, no_move, invdrop, silent)
