...
#define span_centcomradio(str) ("<span class='centcomradio'>" + str + "</span>")	//Not Used
...
#define span_command_headset(str) ("<span class='command_headset'>" + str + "</span>")	//Not Used
#define span_comradio(str) ("<span class='comradio'>" + str + "</span>")	//Not Used
...
#define span_drone(str) ("<span class='drone'>" + str + "</span>")	//Not Used
#define span_engradio(str) ("<span class='engradio'>" + str + "</span>")	//Not Used
#define span_extremelybig(str) ("<span class='extremelybig'>" + str + "</span>")	//Not Used
#define span_ghostalert(str) ("<span class='ghostalert'>" + str + "</span>")
#define span_green(str) ("<span class='green'>" + str + "</span>")	//Not Used
#define span_greenannounce(str) ("<span class='greenannounce'>" + str + "</span>")
#define span_greenteamradio(str) ("<span class='greenteamradio'>" + str + "</span>")	//Not Used
#define span_greentext(str) ("<span class='greentext'>" + str + "</span>")
#define span_grey(str) ("<span class='grey'>" + str + "</span>")	//Not Used
#define span_gangradio(str) ("<span class='gangradio'>" + str + "</span>")	//Not Used
#define span_hear(str) ("<span class='hear'>" + str + "</span>")
#define span_hidden(str) ("<span class='hidden'>" + str + "</span>")	//Not Used
...
#define span_icon(str) ("<span class='icon'>" + str + "</span>")	//Not Used
#define span_info(str) ("<span class='info'>" + str + "</span>")
#define span_infoplain(str) ("<span class='infoplain'>" + str + "</span>")	//Not Used
#define span_interface(str) ("<span class='interface'>" + str + "</span>")
#define span_looc(str) ("<span class='looc'>" + str + "</span>")
#define span_medal(str) ("<span class='medal'>" + str + "</span>")	// Not Used
#define span_medradio(str) ("<span class='medradio'>" + str + "</span>")	//Not Used
...
#define span_minorannounce(str) ("<span class='minorannounce'>" + str + "</span>")	//Not Used
#define span_monkey(str) ("<span class='monkey'>" + str + "</span>")	//Not Used
#define span_monkeyhive(str) ("<span class='monkeyhive'>" + str + "</span>")	//Not Used
#define span_monkeylead(str) ("<span class='monkeylead'>" + str + "</span>")	//Not Used
#define span_name(str) ("<span class='name'>" + str + "</span>")	//Not Used
...
#define span_papyrus(str) ("<span class='papyrus'>" + str + "</span>")	//Not Used
...
#define span_radio(str) ("<span class='radio'>" + str + "</span>")	//Not Used
#define span_reallybig(str) ("<span class='reallybig'>" + str + "</span>")
#define span_red(str) ("<span class='red'>" + str + "</span>")
#define span_redteamradio(str) ("<span class='redteamradio'>" + str + "</span>")	//Not Used
...
#define span_secradio(str) ("<span class='secradio'>" + str + "</span>")	// Not Used
#define span_servradio(str) ("<span class='servradio'>" + str + "</span>")	// Not Used
#define span_singing(str) ("<span class='singing'>" + str + "</span>")	//Not Used
#define span_slime(str) ("<span class='slime'>" + str + "</span>")	//Not Used
#define span_small(str) ("<span class='small'>" + str + "</span>")	//Not Used
#define span_smallnotice(str) ("<span class='smallnotice'>" + str + "</span>")	//Not Used
#define span_smallnoticeital(str) ("<span class='smallnoticeital'>" + str + "</span>")	//Not Used
#define span_spider(str) ("<span class='spider'>" + str + "</span>")
#define span_suicide(str) ("<span class='suicide'>" + str + "</span>")
#define span_suppradio(str) ("<span class='suppradio'>" + str + "</span>")	//Not Used
#define span_syndradio(str) ("<span class='syndradio'>" + str + "</span>")	//Not Used
#define span_tape_recorder(str) ("<span class='tape_recorder'>" + str + "</span>")	//Not Used
#define span_tinynotice(str) ("<span class='tinynotice'>" + str + "</span>")	//Not Used
#define span_tinynoticeital(str) ("<span class='tinynoticeital'>" + str + "</span>")	//Not Used
#define span_unconscious(str) ("<span class='unconscious'>" + str + "</span>")
#define span_userdanger(str) ("<span class='userdanger'>" + str + "</span>")
#define span_warning(str) ("<span class='warning'>" + str + "</span>")
#define span_yell(str) ("<span class='yell'>" + str + "</span>")	//Not Used
#define span_yellowteamradio(str) ("<span class='yellowteamradio'>" + str + "</span>")	//Not Used

// Spans that use embedded tgui components:
// Sorted alphabetically
#define span_tooltip(tip, main_text) ("<span data-component=\"Tooltip\" data-content=\"" + tip + "\" class=\"tooltip\">" + main_text + "</span>")	//Not Used
