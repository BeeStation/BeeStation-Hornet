...
#define SPECIES_FROSTWING "frostwing"
...
// Used with species/proc/get_heat_protection() and species/proc/get_cold_protection()
...
#define THERMAL_PROTECTION_SUIT (THERMAL_PROTECTION_CHEST + THERMAL_PROTECTION_GROIN + THERMAL_PROTECTION_LEG_LEFT + THERMAL_PROTECTION_LEG_RIGHT + THERMAL_PROTECTION_FOOT_LEFT \
+ THERMAL_PROTECTION_FOOT_RIGHT + THERMAL_PROTECTION_ARM_LEFT + THERMAL_PROTECTION_ARM_RIGHT + THERMAL_PROTECTION_HAND_LEFT + THERMAL_PROTECTION_HAND_RIGHT)
