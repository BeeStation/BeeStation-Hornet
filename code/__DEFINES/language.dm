...
#define LANGUAGE_HIDE_ICON_IF_YOU_UNDERSTAND 4
#define LANGUAGE_HIDE_ICON_IF_YOU_SHOULD_NOT_RECOGNISE_WITH_LINGUIST_TRAIT 8 // even if you have linguist trait, you shouldn't see the icon
#define LANGUAGE_ALWAYS_SHOW_ICON_IF_YOU_DO_NOT_UNDERSTAND 16
#define LANGUAGE_ALWAYS_SHOW_ICON_TO_GHOSTS 32
