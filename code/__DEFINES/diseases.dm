...
// Disease Dangers
/// Symptoms that are very beneficial, whose benefits far outweigh downsides
#define DISEASE_BENEFICIAL "Beneficial"
/// Symptoms that buff or heal, but may have minor downsides, or minor effects
#define DISEASE_POSITIVE "Positive"
/// Symptoms that have no concrete mechanical effects that effect the host in any meaningful way (itching)
#define DISEASE_NONTHREAT "Harmless"
/// Symptoms that can annoy in concrete ways (dizziness)
...
/// Diseases that are lethal if untreated (flesh eating)
#define DISEASE_DANGEROUS "Dangerous"
/// Symptoms that can quickly kill an unprepared victim (fungal tb, gbs)
#define DISEASE_BIOHAZARD "BIOHAZARD"
/// Symptoms so deadly you will likely die before being cured (ARDS, autophageocytosis)
