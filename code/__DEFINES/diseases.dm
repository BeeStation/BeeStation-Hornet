...
var/disease_alcohol_stage_speed = rand(5,7)

var/disease_beesease_resistance = rand(10,14)
var/disease_beesease_transmission = rand(9,11)

var/disease_blobspores_resistance1 = rand(7,9)
var/disease_blobspores_resistance2 = rand(10,12)
var/disease_blobspores_resistance3 = rand(13,15)

var/disease_braindamage_transmission = rand(11,13)
var/disease_braindamage_stage_speed = rand(8,10)

var/disease_asphyxiation_stage_speed = rand(7,9)
var/disease_asphyxiation_transmission = rand(7,9)

var/disease_robotic_adaptation_stage_speed1 = rand(2,6)
var/disease_robotic_adaptation_stage_speed2 = rand(10,14)
var/disease_robotic_adaptation_resistance = rand(3,5)

var/disease_cockroach_stage_speed = rand(7,9)
var/disease_cockroach_transmission = rand(6,10)

var/disease_confusion_resistance = rand(5,7)
var/disease_confusion_transmission = rand(5,7)
var/disease_confusion_stealth = rand(3,5)

var/disease_cough_resistance1 = rand(2,4)
var/disease_cough_resistance2 = rand(9,11)
var/disease_cough_stage_speed = rand(4,8)
var/disease_cough_stealth = rand(3,5)
var/disease_cough_transmission = rand(10,12)

var/disease_deafness_resistance = rand(8,10)
var/disease_deafness_stealth = rand(3,5)

var/disease_fever_resistance1 = rand(3,7)
var/disease_fever_resistance2 = rand(9,11)

var/disease_fire_stage_speed1 = rand(3,5)
var/disease_fire_stage_speed2 = rand(7,10)
var/disease_fire_transmission = rand(7,9)
var/disease_fire_stealth = rand(3,5)

var/disease_alkali_stealth = rand(3,4)
var/disease_alkali_stage_speed = rand(7,9)
var/disease_alkali_resistance = rand(7,9)

var/disease_flesh_eating_resistance = rand(8,12)
var/disease_flesh_eating_transmission = rand(7,9)

var/disease_flesh_death_stage_speed = rand(6,8)
var/disease_flesh_death_stealth = rand(4,6)

var/disease_genetic_mutation_resistance = rand(7,9)
var/disease_genetic_mutation_stage_speed = rand(8,12)
var/disease_genetic_mutation_stealth = rand(4,6)

var/disease_hallucigen_stage_speed = rand(5,9)
var/disease_hallucigen_stealth = rand(0,4)

var/disease_headache_stage_speed1 = rand(5,7)
var/disease_headache_stage_speed2 = rand(8,10)
var/disease_headache_stealth = rand(3,5)
...
var/disease_heal_coma_resistance = rand(3,5)
var/disease_heal_coma_stage_speed = rand(6,8)
...
var/disease_sweat_stage_speed = rand(5,7)

var/disease_teleport_restistance = rand(5,7)
var/disease_teleport_transmission = rand(6,10)

var/disease_growth_stage_speed1 = rand(5,7)
var/disease_growth_stage_speed2 = rand(11,13)

var/disease_vampirism_transmission1 = rand(3,5)
var/disease_vampirism_stage_speed = rand(6,8)
var/disease_vampirism_transmission2 = rand(6,7)

var/disease_parasite_stealth = rand(0,4)
var/disease_parasite_stage_speed = rand(5,7)

var/disease_jitters_resistance = rand(7,9)
var/disease_jitters_stage_speed = rand(7,9)

var/disease_heartattack_transmission = rand(9,11)
var/disease_heartattack_stealth = rand(1,3)

var/disease_itching_transmission = rand(4,8)
var/disease_itching_stage_speed = rand(6,8)

var/disease_light_stealth = rand(2,4)

var/disease_lubefeet_transmission = rand(9,11)
...
var/disease_nano_destroy_resistance = rand(6,8)

var/disease_narcolepsy_transmission = rand(6,8)
var/disease_narcolepsy_resistance = rand(9,11)
...
var/disease_organ_restoration_stealth = rand(3,5)
...
var/disease_radconversion_stage_speed = rand(5,7)
var/disease_radconversion_resistance = rand(11,13)
...
var/disease_sneeze_stealth = rand(3,5)
var/disease_sneeze_transmission = rand(11,13)

var/disease_viralreverse_stealth = rand(3,5)

var/disease_visionloss_resistance = rand(11,13)
var/disease_visionloss_stealth = rand(3,5)

var/disease_voice_change_transmission = rand(9,11)
var/disease_voice_change_stage_speed = rand(6,8)
var/disease_voice_change_stealth = rand(2,4)

var/disease_vomit_stage_speed = rand(4,6)
var/disease_vomit_transmission = rand(5,7)
var/disease_vomit_stealth = rand(3,5)

var/disease_weight_loss_stealth = rand(0,4)

var/disease_wizarditis_transmission = rand(7,9)
