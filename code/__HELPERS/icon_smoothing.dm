...
/proc/find_type_in_direction(atom/source, direction)
	...
	if(source_area.canSmoothWithAreas && !source_area.canSmoothWithAreas[target_area.type])
		return null
	if(target_area.canSmoothWithAreas && !target_area.canSmoothWithAreas[source_area.type])
		return null
