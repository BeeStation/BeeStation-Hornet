 ...
 * * invis_flags is for if we want to include invisible mobs or even ghosts etc the default value 0 means only visible mobs are included SEE_INVISIBLE_GHOSTLY would also include ghosts.
 */
