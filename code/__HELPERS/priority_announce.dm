...
#define ANNOUNCEMENT_COLORS list("default", "green", "blue", "pink", "yellow", "orange", "red", "purple", "cyan", "darkred", "black")
...
/proc/print_command_report(text = "", title = null, announce = TRUE, contains_advanced_html = FALSE)
	...
	SScommunications.send_message(message, contains_advanced_html = contains_advanced_html)
