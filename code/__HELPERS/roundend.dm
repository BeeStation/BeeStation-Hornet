				...
				if (A.type != /datum/antagonist/custom)
					...
					switch(A.type)
						...
						if (/datum/antagonist/traitor/internal_affairs)
							SSmedals.UnlockMedal(MEDAL_GREEN_IAA,C)
						if (/datum/antagonist/wizard)
							SSmedals.UnlockMedal(MEDAL_GREEN_WIZARD,C)
						if (/datum/antagonist/changeling)
							SSmedals.UnlockMedal(MEDAL_GREEN_CHANGELING,C)
						if (/datum/antagonist/cult)
							SSmedals.UnlockMedal(MEDAL_GREEN_CULT,C)
						if (/datum/antagonist/servant_of_ratvar)
							SSmedals.UnlockMedal(MEDAL_GREEN_CLOCKCULT,C)
						if (/datum/antagonist/incursion)
							SSmedals.UnlockMedal(MEDAL_GREEN_INCURSION,C)
						if (/datum/antagonist/nukeop)
						...
						if (/datum/antagonist/revenant)
							SSmedals.UnlockMedal(MEDAL_GREEN_REVENANT,C)
						if (/datum/antagonist/rev/head)
							SSmedals.UnlockMedal(MEDAL_GREEN_REVHEAD,C)
						if (/datum/antagonist/heretic)
							SSmedals.UnlockMedal(MEDAL_GREEN_HERETIC,C)
						if (/datum/antagonist/blob)
							SSmedals.UnlockMedal(MEDAL_GREEN_BLOB,C)
						if (/datum/antagonist/abductor)
							SSmedals.UnlockMedal(MEDAL_GREEN_ABDUCTOR,C)
						if (/datum/antagonist/guardian)
							SSmedals.UnlockMedal(MEDAL_GREEN_GUARDIAN,C)
						if (/datum/antagonist/pirate)
							SSmedals.UnlockMedal(MEDAL_GREEN_PIRATE,C)
						if (/datum/antagonist/obsessed)
							SSmedals.UnlockMedal(MEDAL_GREEN_OBSESSED,C)
