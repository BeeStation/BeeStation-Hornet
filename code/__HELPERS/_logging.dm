...
/proc/log_manifest(ckey, datum/mind/mind,mob/body, latejoin = FALSE)
	if (CONFIG_GET(flag/log_manifest))
		WRITE_LOG(GLOB.world_manifest_log, "[ckey] \\ [body.real_name] \\ [mind.get_mind_role(JTYPE_JOB_PATH)] \\ [mind.get_mind_role(JTYPE_SPECIAL) || "NONE"] \\ [latejoin ? "LATEJOIN":"ROUNDSTART"]")
