...
/proc/random_features(gender)
	...
	if(!GLOB.human_xenotype_list.len)
		init_sprite_accessory_subtypes(/datum/sprite_accessory/xenotype, GLOB.human_xenotype_list)
	...
	return(
		...
		"xenotypes_human" = pick(GLOB.human_xenotype_list)
		)
	)
