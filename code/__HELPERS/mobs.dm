...
/proc/random_features()
	...
	if(!GLOB.moth_wings_sanitized_list.len)
		init_sprite_accessory_subtypes(/datum/sprite_accessory/moth_wings, GLOB.moth_wings_sanitized_list)
	if(!GLOB.moth_antennae_sanitized_list.len)
		init_sprite_accessory_subtypes(/datum/sprite_accessory/moth_antennae, GLOB.moth_antennae_sanitized_list)
	if(!GLOB.moth_markings_sanitized_list.len)
		init_sprite_accessory_subtypes(/datum/sprite_accessory/moth_markings, GLOB.moth_markings_sanitized_list)
	...
	return(
		...
		"moth_wings" = pick(GLOB.moth_wings_sanitized_list),
		"moth_antennae" = pick(GLOB.moth_antennae_sanitized_list),
		"moth_markings" = pick(GLOB.moth_markings_sanitized_list),
