...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_VALUE_SOUND_SCAPE" = TRAIT_VALUE_SOUND_SCAPE,
		"TRAIT_VALUE_STAT" = TRAIT_VALUE_STAT,
		"TRAIT_ACCENT" = TRAIT_ACCENT,
	),
	/mob/living = list(
		"TRAIT_NO_BUMP_SLAM" = TRAIT_NO_BUMP_SLAM,
		"TRAIT_NO_MOVE_PULL" = TRAIT_NO_MOVE_PULL,
		"TRAIT_NO_ORGAN_PENETRATION" = TRAIT_NO_ORGAN_PENETRATION,
	...
	/obj/item/bodypart = list(
		...
		"TRAIT_BODYPART_NO_STAMINA_REGENERATION" = TRAIT_BODYPART_NO_STAMINA_REGENERATION,
	),
	/obj/item = list(
	...
	/datum/blood_source = list(
		"TRAIT_VALUE_CIRCULATION" = TRAIT_VALUE_CIRCULATION,
	)
	))
