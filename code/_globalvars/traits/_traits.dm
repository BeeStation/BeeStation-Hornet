...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob/living = list(
		...
		"TRAIT_DIES_NO_NUTRITION" = TRAIT_DIES_NO_NUTRITION,
		...
		"TRAIT_REVIVESBYHEALING" = TRAIT_REVIVESBYHEALING,
	...
	/mob/living/carbon = list(
		...
		"TRAIT_NOREAGENTS" = TRAIT_NOREAGENTS,
		...
		"TRAIT_UPGRADE_COMPATIBLE" = TRAIT_UPGRADE_COMPATIBLE,
		"TRAIT_VIP" = TRAIT_VIP,
	),
	/mob/living/carbon/human = list(
		...
		"TRAIT_ENVIROSUIT" = TRAIT_ENVIROSUIT ,
