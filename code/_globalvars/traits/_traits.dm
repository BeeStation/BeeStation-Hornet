...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/mob = list(
		...
		"TRAIT_ACC_MEDIEVAL" = TRAIT_ACC_MEDIEVAL,
		"TRAIT_ACC_ITALIAN" = TRAIT_ACC_ITALIAN,
		"TRAIT_ACC_FRENCH" = TRAIT_ACC_FRENCH,
		"TRAIT_ACC_CANADIAN" = TRAIT_ACC_CANADIAN,
		"TRAIT_ACC_BRITISH" = TRAIT_ACC_BRITISH,
	),
	/mob/living = list(
