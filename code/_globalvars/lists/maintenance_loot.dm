...
GLOBAL_LIST_INIT(maintenance_loot, list(
	...
	/obj/item/reagent_containers/food/snacks/fakefruit = 1,
	/obj/item/reagent_containers/food/snacks/fakefruit/apple = 1,
	/obj/item/reagent_containers/food/snacks/fakefruit/grapes = 1,
