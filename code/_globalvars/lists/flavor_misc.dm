...
GLOBAL_LIST_EMPTY(moth_wings_sanitized_list)//this lacks the blacklisted wings such as burned, clockwork and angel
GLOBAL_LIST_EMPTY(moth_antennae_list)
GLOBAL_LIST_EMPTY(moth_antennae_sanitized_list)//this lacks the blacklisted antennae such as burned, clockwork and angel
GLOBAL_LIST_EMPTY(moth_markings_list)
GLOBAL_LIST_EMPTY(moth_markings_sanitized_list)//this lacks the blacklisted markings such as burned, clockwork and angel
