...
* Map editing – Two mapping tools are supported: [StrongDMM](https://github.com/SpaiR/StrongDMM), the most widely used and performant standalone executable; and [FastDMM2](https://fastdmm2.ss13.io/), a browser‑based tool offering more granular control.
