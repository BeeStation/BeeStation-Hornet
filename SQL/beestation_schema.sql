...
CREATE TABLE `SS13_characters` (
	...
	`skin_tone` VARCHAR(16) NOT NULL COLLATE 'utf8mb4_general_ci',
	`hair_style_name` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
	`gradient_style` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
	`facial_style_name` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
	`underwear` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
	`underwear_color` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
	`undershirt` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
	`socks` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
	`backbag` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
	`jumpsuit_style` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
	`uplink_loc` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
	`features` MEDIUMTEXT NOT NULL COLLATE 'utf8mb4_general_ci',
	`custom_names` MEDIUMTEXT NOT NULL COLLATE 'utf8mb4_general_ci',
	`helmet_style` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
	`preferred_ai_core_display` VARCHAR(32) NOT NULL COLLATE 'utf8mb4_general_ci',
